// Description: C++18 implementation of a TopDomain history buffer object.
...
namespace cfint {
	...
	const std::string CFIntTopDomainHBuff::CLASS_NAME( "CFIntTopDomainHBuff" );
	CFIntTopDomainHBuff::CFIntTopDomainHBuff()
	...
	CFIntTopDomainHBuff::CFIntTopDomainHBuff( const CFIntTopDomainHBuff& src )
	: CFIntHPKey(), cflib::ICFLibCloneableObj() {
		requiredTenantId = cfint::CFIntTopDomainBuff::TENANTID_INIT_VALUE;
		requiredId = cfint::CFIntTopDomainBuff::ID_INIT_VALUE;
		requiredTldId = cfint::CFIntTopDomainBuff::TLDID_INIT_VALUE;
	...
	cflib::ICFLibCloneableObj* CFIntTopDomainHBuff::clone() {
		CFIntTopDomainHBuff* copy = new CFIntTopDomainHBuff();
		*copy = *this;
		cflib::ICFLibCloneableObj* retval = dynamic_cast<cflib::ICFLibCloneableObj*>( copy );
		return( retval );
	}

	const int64_t CFIntTopDomainHBuff::getRequiredTenantId() const {
		return( requiredTenantId );
	}

	const int64_t* CFIntTopDomainHBuff::getRequiredTenantIdReference() const {
		return( &requiredTenantId );
	}

	void CFIntTopDomainHBuff::setRequiredTenantId( const int64_t value ) {
	...
	const int64_t CFIntTopDomainHBuff::getRequiredId() const {
		return( requiredId );
	}

	const int64_t* CFIntTopDomainHBuff::getRequiredIdReference() const {
		return( &requiredId );
	}

	void CFIntTopDomainHBuff::setRequiredId( const int64_t value ) {
	...
	const int64_t CFIntTopDomainHBuff::getRequiredTldId() const {
		return( requiredTldId );
	}

	const int64_t* CFIntTopDomainHBuff::getRequiredTldIdReference() const {
		return( &requiredTldId );
	}

	void CFIntTopDomainHBuff::setRequiredTldId( const int64_t value ) {
	...
	const std::string& CFIntTopDomainHBuff::getRequiredName() const {
		return( *requiredName );
	}

	const std::string* CFIntTopDomainHBuff::getRequiredNameReference() const {
		return( requiredName );
	}

	void CFIntTopDomainHBuff::setRequiredName( const std::string& value ) {
	...
	const std::string& CFIntTopDomainHBuff::getOptionalDescriptionValue() const {
	...
	const std::string* CFIntTopDomainHBuff::getOptionalDescriptionReference() const {
		return( optionalDescription );
	}

	const bool CFIntTopDomainHBuff::isOptionalDescriptionNull() const {
		return( optionalDescription == NULL );
	}

	void CFIntTopDomainHBuff::setOptionalDescriptionNull() {
		if( optionalDescription != NULL ) {
			delete optionalDescription;
			optionalDescription = NULL;
		}
	...
	void CFIntTopDomainHBuff::setOptionalDescriptionValue( const std::string& value ) {
	...
	size_t CFIntTopDomainHBuff::hashCode() const {
	...
	CFIntTopDomainHBuff CFIntTopDomainHBuff::operator =( cfint::CFIntTopDomainBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredTldId( src.getRequiredTldId() );
	...
	CFIntTopDomainHBuff CFIntTopDomainHBuff::operator =( cfint::CFIntTopDomainHBuff& src ) {
		setRequiredTenantId( src.getRequiredTenantId() );
		setRequiredId( src.getRequiredId() );
		setRequiredRevision( src.getRequiredRevision() );
		setRequiredTldId( src.getRequiredTldId() );
	...
	bool CFIntTopDomainHBuff::operator <( const CFIntTopDomainByTenantIdxKey& rhs ) {
	...
	bool CFIntTopDomainHBuff::operator <( const CFIntTopDomainByTldIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFIntTopDomainHBuff::operator <( const CFIntTopDomainByNameIdxKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFIntTopDomainHBuff::operator <( const CFIntTopDomainPKey& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	bool CFIntTopDomainHBuff::operator <( const CFIntTopDomainHPKey& rhs ) {
	...
	bool CFIntTopDomainHBuff::operator <( const CFIntTopDomainHBuff& rhs ) {
		if( getAuditClusterId() > rhs.getAuditClusterId() ) {
			return( false );
		}
		else if( getAuditClusterId() < rhs.getAuditClusterId() ) {
	...
	bool CFIntTopDomainHBuff::operator <( const CFIntTopDomainBuff& rhs ) {
		if( getRequiredTenantId() > rhs.getRequiredTenantId() ) {
			return( false );
		}
		else if( getRequiredTenantId() < rhs.getRequiredTenantId() ) {
	...
	std::string CFIntTopDomainHBuff::toString() {
		static const std::string S_Space( " " );
		static const std::string S_Preamble( "<CFIntTopDomainHBuff" );
