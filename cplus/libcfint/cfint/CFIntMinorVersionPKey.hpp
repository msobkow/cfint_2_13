...
// Description: C++18 specification of a MinorVersion primary key object.
...
namespace cfint {
	...
	public:
		...
		CFIntMinorVersionPKey();
		CFIntMinorVersionPKey( const CFIntMinorVersionPKey& src );
		virtual ~CFIntMinorVersionPKey();
		...
		cfint::CFIntMinorVersionPKey operator =( cfint::CFIntMinorVersionPKey& src );
		cfint::CFIntMinorVersionPKey operator =( cfint::CFIntMinorVersionHPKey& src );
		cfint::CFIntMinorVersionPKey operator =( cfint::CFIntMinorVersionBuff& src );
		cfint::CFIntMinorVersionPKey operator =( cfint::CFIntMinorVersionHBuff& src );
	};
}
...
namespace std {
	...
	template<> struct hash<cfint::CFIntMinorVersionPKey> {
		typedef cfint::CFIntMinorVersionPKey argument_type;
