...
// Description: C++18 specification for a TopProject by NameIdx index key object.
...
namespace cfint {
	...
	public:
		CFIntTopProjectByNameIdxKey();
		CFIntTopProjectByNameIdxKey( const CFIntTopProjectByNameIdxKey& src );
		virtual ~CFIntTopProjectByNameIdxKey();
		...
		bool operator >( const CFIntTopProjectHBuff& rhs );
		bool operator >( const CFIntTopProjectBuff& rhs );
		cfint::CFIntTopProjectByNameIdxKey operator =( cfint::CFIntTopProjectByNameIdxKey& src );
		cfint::CFIntTopProjectByNameIdxKey operator =( cfint::CFIntTopProjectBuff& src );
		cfint::CFIntTopProjectByNameIdxKey operator =( cfint::CFIntTopProjectHBuff& src );
};
}
...
namespace std {
	...
	template<> struct hash<cfint::CFIntTopProjectByNameIdxKey> {
		typedef cfint::CFIntTopProjectByNameIdxKey argument_type;
