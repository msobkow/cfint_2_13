...
// Description: C++18 edit object instance specification for CFInt Cluster.
...
namespace cfint {
	...
	class CFIntClusterEditObj
	: public virtual ICFIntClusterEditObj,
	...
	public:
		CFIntClusterEditObj( cfsec::ICFSecClusterObj* argOrig );
		virtual ~CFIntClusterEditObj();
