...
// Description: C++18 base object instance specification for CFInt Cluster.
...
namespace cfint {
	...
	class CFIntClusterObj
	: public virtual ICFIntClusterObj,
	...
	public:
		...
		CFIntClusterObj();
		CFIntClusterObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntClusterObj();
