...
// Description: C++18 edit object instance specification for CFInt HostNode.
...
namespace cfint {
	...
	class CFIntHostNodeEditObj
	: public virtual ICFIntHostNodeEditObj,
	  public virtual cfsec::ICFSecHostNodeEditObj
	{
	public:
	...
	public:
		CFIntHostNodeEditObj( cfsec::ICFSecHostNodeObj* argOrig );
		virtual ~CFIntHostNodeEditObj();
