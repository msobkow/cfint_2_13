...
// Description: C++18 edit object instance specification for CFInt ISOCcy.
...
namespace cfint {
	...
	class CFIntISOCcyEditObj
	: public virtual ICFIntISOCcyEditObj,
	  public virtual cfsec::ICFSecISOCcyEditObj
	{
	public:
	...
	public:
		CFIntISOCcyEditObj( cfsec::ICFSecISOCcyObj* argOrig );
		virtual ~CFIntISOCcyEditObj();
