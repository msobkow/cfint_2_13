...
// Description: C++18 base object instance specification for CFInt ISOCcy.
...
namespace cfint {
	...
	class CFIntISOCcyObj
	: public virtual ICFIntISOCcyObj,
	...
	public:
		...
		CFIntISOCcyObj();
		CFIntISOCcyObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntISOCcyObj();
