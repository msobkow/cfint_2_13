...
// Description: C++18 edit object instance specification for CFInt ISOCtryCcy.
...
namespace cfint {
	...
	class CFIntISOCtryCcyEditObj
	: public virtual ICFIntISOCtryCcyEditObj,
	  public virtual cfsec::ICFSecISOCtryCcyEditObj
	{
	public:
	...
	public:
		CFIntISOCtryCcyEditObj( cfsec::ICFSecISOCtryCcyObj* argOrig );
		virtual ~CFIntISOCtryCcyEditObj();
