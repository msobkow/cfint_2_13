...
// Description: C++18 base object instance specification for CFInt ISOCtryCcy.
...
namespace cfint {
	...
	class CFIntISOCtryCcyObj
	: public virtual ICFIntISOCtryCcyObj,
	...
	public:
		...
		CFIntISOCtryCcyObj();
		CFIntISOCtryCcyObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntISOCtryCcyObj();
