...
namespace cfint {
	...
	class CFIntISOCtryCcyTableObj
	: public virtual ICFIntISOCtryCcyTableObj,
	...
	public:
		...
		CFIntISOCtryCcyTableObj();
		CFIntISOCtryCcyTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFIntISOCtryCcyTableObj();
