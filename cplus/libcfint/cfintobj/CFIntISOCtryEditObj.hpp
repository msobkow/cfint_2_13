...
// Description: C++18 edit object instance specification for CFInt ISOCtry.
...
namespace cfint {
	...
	class CFIntISOCtryEditObj
	: public virtual ICFIntISOCtryEditObj,
	  public virtual cfsec::ICFSecISOCtryEditObj
	{
	public:
	...
	public:
		CFIntISOCtryEditObj( cfsec::ICFSecISOCtryObj* argOrig );
		virtual ~CFIntISOCtryEditObj();
