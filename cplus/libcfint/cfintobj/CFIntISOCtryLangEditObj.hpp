...
// Description: C++18 edit object instance specification for CFInt ISOCtryLang.
...
namespace cfint {
	...
	class CFIntISOCtryLangEditObj
	: public virtual ICFIntISOCtryLangEditObj,
	  public virtual cfsec::ICFSecISOCtryLangEditObj
	{
	public:
	...
	public:
		CFIntISOCtryLangEditObj( cfsec::ICFSecISOCtryLangObj* argOrig );
		virtual ~CFIntISOCtryLangEditObj();
