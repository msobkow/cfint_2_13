...
// Description: C++18 base object instance specification for CFInt ISOCtryLang.
...
namespace cfint {
	...
	class CFIntISOCtryLangObj
	: public virtual ICFIntISOCtryLangObj,
	...
	public:
		...
		CFIntISOCtryLangObj();
		CFIntISOCtryLangObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntISOCtryLangObj();
