...
// Description: C++18 base object instance specification for CFInt ISOCtry.
...
namespace cfint {
	...
	class CFIntISOCtryObj
	: public virtual ICFIntISOCtryObj,
	...
	public:
		...
		CFIntISOCtryObj();
		CFIntISOCtryObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntISOCtryObj();
