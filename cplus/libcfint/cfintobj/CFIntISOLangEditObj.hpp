...
// Description: C++18 edit object instance specification for CFInt ISOLang.
...
namespace cfint {
	...
	class CFIntISOLangEditObj
	: public virtual ICFIntISOLangEditObj,
	  public virtual cfsec::ICFSecISOLangEditObj
	{
	public:
	...
	public:
		CFIntISOLangEditObj( cfsec::ICFSecISOLangObj* argOrig );
		virtual ~CFIntISOLangEditObj();
