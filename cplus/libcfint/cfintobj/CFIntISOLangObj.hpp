...
// Description: C++18 base object instance specification for CFInt ISOLang.
...
namespace cfint {
	...
	class CFIntISOLangObj
	: public virtual ICFIntISOLangObj,
	...
	public:
		...
		CFIntISOLangObj();
		CFIntISOLangObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntISOLangObj();
