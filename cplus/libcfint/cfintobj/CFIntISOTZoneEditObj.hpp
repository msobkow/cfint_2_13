...
// Description: C++18 edit object instance specification for CFInt ISOTZone.
...
namespace cfint {
	...
	class CFIntISOTZoneEditObj
	: public virtual ICFIntISOTZoneEditObj,
	  public virtual cfsec::ICFSecISOTZoneEditObj
	{
	public:
	...
	public:
		CFIntISOTZoneEditObj( cfsec::ICFSecISOTZoneObj* argOrig );
		virtual ~CFIntISOTZoneEditObj();
