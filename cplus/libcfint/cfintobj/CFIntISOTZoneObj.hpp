...
// Description: C++18 base object instance specification for CFInt ISOTZone.
...
namespace cfint {
	...
	class CFIntISOTZoneObj
	: public virtual ICFIntISOTZoneObj,
	...
	public:
		...
		CFIntISOTZoneObj();
		CFIntISOTZoneObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntISOTZoneObj();
