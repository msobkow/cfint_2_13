...
namespace cfint {
	...
	class CFIntLicenseObj
	: public virtual ICFIntLicenseObj
	{
	protected:
		bool isNew;
		cfint::ICFIntLicenseEditObj* edit;
	...
	public:
		...
		CFIntLicenseObj();
		CFIntLicenseObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntLicenseObj();
		...
		virtual cfint::ICFIntLicenseObj* realize();
		...
		virtual cfint::ICFIntLicenseEditObj* beginEdit();
