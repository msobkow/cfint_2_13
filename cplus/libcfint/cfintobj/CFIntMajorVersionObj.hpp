...
// Description: C++18 base object instance specification for CFInt MajorVersion.
...
namespace cfint {
	...
	class CFIntMajorVersionObj
	: public virtual ICFIntMajorVersionObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntMajorVersionEditObj* edit;
	...
	public:
		...
		CFIntMajorVersionObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntMajorVersionObj();
		...
		virtual cfint::ICFIntMajorVersionObj* realize();
		...
		virtual cfint::ICFIntMajorVersionEditObj* beginEdit();
