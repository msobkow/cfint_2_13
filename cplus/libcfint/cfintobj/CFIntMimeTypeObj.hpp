...
// Description: C++18 base object instance specification for CFInt MimeType.
...
namespace cfint {
	...
	class CFIntMimeTypeObj
	: public virtual ICFIntMimeTypeObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntMimeTypeEditObj* edit;
	...
	public:
		...
		CFIntMimeTypeObj();
		CFIntMimeTypeObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntMimeTypeObj();
		...
		virtual cfint::ICFIntMimeTypeObj* realize();
		...
		virtual cfint::ICFIntMimeTypeEditObj* beginEdit();
