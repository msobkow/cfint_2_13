...
// Description: C++18 base object instance specification for CFInt MinorVersion.
...
namespace cfint {
	...
	class CFIntMinorVersionObj
	: public virtual ICFIntMinorVersionObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntMinorVersionEditObj* edit;
	...
	public:
		...
		CFIntMinorVersionObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntMinorVersionObj();
		...
		virtual cfint::ICFIntMinorVersionObj* realize();
		...
		virtual cfint::ICFIntMinorVersionEditObj* beginEdit();
