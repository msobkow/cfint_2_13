...
// Description: C++18 edit object instance specification for CFInt SecApp.
...
namespace cfint {
	...
	class CFIntSecAppEditObj
	: public virtual ICFIntSecAppEditObj,
	  public virtual cfsec::ICFSecSecAppEditObj
	{
	public:
	...
	public:
		CFIntSecAppEditObj( cfsec::ICFSecSecAppObj* argOrig );
		virtual ~CFIntSecAppEditObj();
