...
// Description: C++18 base object instance specification for CFInt SecApp.
...
namespace cfint {
	...
	class CFIntSecAppObj
	: public virtual ICFIntSecAppObj,
	...
	public:
		...
		CFIntSecAppObj();
		CFIntSecAppObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecAppObj();
