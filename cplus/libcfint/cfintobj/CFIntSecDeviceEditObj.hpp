...
// Description: C++18 edit object instance specification for CFInt SecDevice.
...
namespace cfint {
	...
	class CFIntSecDeviceEditObj
	: public virtual ICFIntSecDeviceEditObj,
	  public virtual cfsec::ICFSecSecDeviceEditObj
	{
	public:
	...
	public:
		CFIntSecDeviceEditObj( cfsec::ICFSecSecDeviceObj* argOrig );
		virtual ~CFIntSecDeviceEditObj();
