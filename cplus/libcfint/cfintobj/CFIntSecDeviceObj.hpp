...
// Description: C++18 base object instance specification for CFInt SecDevice.
...
namespace cfint {
	...
	class CFIntSecDeviceObj
	: public virtual ICFIntSecDeviceObj,
	...
	public:
		...
		CFIntSecDeviceObj();
		CFIntSecDeviceObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecDeviceObj();
