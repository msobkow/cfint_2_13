...
// Description: C++18 edit object instance specification for CFInt SecForm.
...
namespace cfint {
	...
	class CFIntSecFormEditObj
	: public virtual ICFIntSecFormEditObj,
	  public virtual cfsec::ICFSecSecFormEditObj
	{
	public:
	...
	public:
		CFIntSecFormEditObj( cfsec::ICFSecSecFormObj* argOrig );
		virtual ~CFIntSecFormEditObj();
