...
// Description: C++18 base object instance specification for CFInt SecForm.
...
namespace cfint {
	...
	class CFIntSecFormObj
	: public virtual ICFIntSecFormObj,
	...
	public:
		...
		CFIntSecFormObj();
		CFIntSecFormObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecFormObj();
