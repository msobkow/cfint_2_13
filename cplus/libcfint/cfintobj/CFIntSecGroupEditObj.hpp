...
// Description: C++18 edit object instance specification for CFInt SecGroup.
...
namespace cfint {
	...
	class CFIntSecGroupEditObj
	: public virtual ICFIntSecGroupEditObj,
	  public virtual cfsec::ICFSecSecGroupEditObj
	{
	public:
	...
	public:
		CFIntSecGroupEditObj( cfsec::ICFSecSecGroupObj* argOrig );
		virtual ~CFIntSecGroupEditObj();
