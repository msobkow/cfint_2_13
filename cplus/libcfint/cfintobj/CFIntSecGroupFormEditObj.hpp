...
// Description: C++18 edit object instance specification for CFInt SecGroupForm.
...
namespace cfint {
	...
	class CFIntSecGroupFormEditObj
	: public virtual ICFIntSecGroupFormEditObj,
	  public virtual cfsec::ICFSecSecGroupFormEditObj
	{
	public:
	...
	public:
		CFIntSecGroupFormEditObj( cfsec::ICFSecSecGroupFormObj* argOrig );
		virtual ~CFIntSecGroupFormEditObj();
