...
// Description: C++18 base object instance specification for CFInt SecGroupForm.
...
namespace cfint {
	...
	class CFIntSecGroupFormObj
	: public virtual ICFIntSecGroupFormObj,
	...
	public:
		...
		CFIntSecGroupFormObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecGroupFormObj();
