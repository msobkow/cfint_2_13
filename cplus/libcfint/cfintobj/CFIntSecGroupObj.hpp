...
// Description: C++18 base object instance specification for CFInt SecGroup.
...
namespace cfint {
	...
	class CFIntSecGroupObj
	: public virtual ICFIntSecGroupObj,
	...
	public:
		...
		CFIntSecGroupObj();
		CFIntSecGroupObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecGroupObj();
