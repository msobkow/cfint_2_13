...
// Description: C++18 edit object instance specification for CFInt SecGrpInc.
...
namespace cfint {
	...
	class CFIntSecGrpIncEditObj
	: public virtual ICFIntSecGrpIncEditObj,
	  public virtual cfsec::ICFSecSecGrpIncEditObj
	{
	public:
	...
	public:
		CFIntSecGrpIncEditObj( cfsec::ICFSecSecGrpIncObj* argOrig );
		virtual ~CFIntSecGrpIncEditObj();
