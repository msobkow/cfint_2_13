...
// Description: C++18 base object instance specification for CFInt SecGrpInc.
...
namespace cfint {
	...
	class CFIntSecGrpIncObj
	: public virtual ICFIntSecGrpIncObj,
	...
	public:
		...
		CFIntSecGrpIncObj();
		CFIntSecGrpIncObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecGrpIncObj();
