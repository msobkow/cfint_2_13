...
// Description: C++18 edit object instance specification for CFInt SecGrpMemb.
...
namespace cfint {
	...
	class CFIntSecGrpMembEditObj
	: public virtual ICFIntSecGrpMembEditObj,
	  public virtual cfsec::ICFSecSecGrpMembEditObj
	{
	public:
	...
	public:
		CFIntSecGrpMembEditObj( cfsec::ICFSecSecGrpMembObj* argOrig );
		virtual ~CFIntSecGrpMembEditObj();
