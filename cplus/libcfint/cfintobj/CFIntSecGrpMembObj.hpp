...
// Description: C++18 base object instance specification for CFInt SecGrpMemb.
...
namespace cfint {
	...
	class CFIntSecGrpMembObj
	: public virtual ICFIntSecGrpMembObj,
	...
	public:
		...
		CFIntSecGrpMembObj();
		CFIntSecGrpMembObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecGrpMembObj();
