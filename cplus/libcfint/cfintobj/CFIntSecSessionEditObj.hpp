...
// Description: C++18 edit object instance specification for CFInt SecSession.
...
namespace cfint {
	...
	class CFIntSecSessionEditObj
	: public virtual ICFIntSecSessionEditObj,
	  public virtual cfsec::ICFSecSecSessionEditObj
	{
	public:
	...
	public:
		CFIntSecSessionEditObj( cfsec::ICFSecSecSessionObj* argOrig );
		virtual ~CFIntSecSessionEditObj();
