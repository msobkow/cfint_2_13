...
// Description: C++18 base object instance specification for CFInt SecSession.
...
namespace cfint {
	...
	class CFIntSecSessionObj
	: public virtual ICFIntSecSessionObj,
	...
	public:
		...
		CFIntSecSessionObj();
		CFIntSecSessionObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecSessionObj();
