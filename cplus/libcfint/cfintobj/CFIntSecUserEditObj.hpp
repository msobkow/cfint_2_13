...
// Description: C++18 edit object instance specification for CFInt SecUser.
...
namespace cfint {
	...
	class CFIntSecUserEditObj
	: public virtual ICFIntSecUserEditObj,
	  public virtual cfsec::ICFSecSecUserEditObj
	{
	public:
	...
	public:
		CFIntSecUserEditObj( cfsec::ICFSecSecUserObj* argOrig );
		virtual ~CFIntSecUserEditObj();
