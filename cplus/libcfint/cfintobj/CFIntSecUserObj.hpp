...
// Description: C++18 base object instance specification for CFInt SecUser.
...
namespace cfint {
	...
	class CFIntSecUserObj
	: public virtual ICFIntSecUserObj,
	...
	public:
		...
		CFIntSecUserObj();
		CFIntSecUserObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSecUserObj();
