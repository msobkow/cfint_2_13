...
// Description: C++18 edit object instance specification for CFInt Service.
...
namespace cfint {
	...
	class CFIntServiceEditObj
	: public virtual ICFIntServiceEditObj,
	  public virtual cfsec::ICFSecServiceEditObj
	{
	public:
	...
	public:
		CFIntServiceEditObj( cfsec::ICFSecServiceObj* argOrig );
		virtual ~CFIntServiceEditObj();
