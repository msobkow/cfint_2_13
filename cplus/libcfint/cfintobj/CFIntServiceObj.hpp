...
// Description: C++18 base object instance specification for CFInt Service.
...
namespace cfint {
	...
	class CFIntServiceObj
	: public virtual ICFIntServiceObj,
	...
	public:
		...
		CFIntServiceObj();
		CFIntServiceObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntServiceObj();
