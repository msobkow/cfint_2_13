...
// Description: C++18 base object instance specification for CFInt ServiceType.
...
namespace cfint {
	...
	class CFIntServiceTypeObj
	: public virtual ICFIntServiceTypeObj,
	...
	public:
		...
		CFIntServiceTypeObj();
		CFIntServiceTypeObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntServiceTypeObj();
