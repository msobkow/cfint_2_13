...
namespace cfint {
	...
	class CFIntServiceTypeTableObj
	: public virtual ICFIntServiceTypeTableObj,
	...
	public:
		...
		CFIntServiceTypeTableObj();
		CFIntServiceTypeTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFIntServiceTypeTableObj();
