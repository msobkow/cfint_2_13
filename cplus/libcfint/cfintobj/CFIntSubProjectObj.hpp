...
// Description: C++18 base object instance specification for CFInt SubProject.
...
namespace cfint {
	...
	class CFIntSubProjectObj
	: public virtual ICFIntSubProjectObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntSubProjectEditObj* edit;
	...
	public:
		...
		CFIntSubProjectObj();
		CFIntSubProjectObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSubProjectObj();
		...
		virtual cfint::ICFIntSubProjectObj* realize();
		...
		virtual cfint::ICFIntSubProjectEditObj* beginEdit();
