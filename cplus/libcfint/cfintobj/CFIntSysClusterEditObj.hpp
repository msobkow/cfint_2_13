...
// Description: C++18 edit object instance specification for CFInt SysCluster.
...
namespace cfint {
	...
	class CFIntSysClusterEditObj
	: public virtual ICFIntSysClusterEditObj,
	  public virtual cfsec::ICFSecSysClusterEditObj
	{
	public:
	...
	public:
		CFIntSysClusterEditObj( cfsec::ICFSecSysClusterObj* argOrig );
		virtual ~CFIntSysClusterEditObj();
