...
// Description: C++18 base object instance specification for CFInt SysCluster.
...
namespace cfint {
	...
	class CFIntSysClusterObj
	: public virtual ICFIntSysClusterObj,
	...
	public:
		...
		CFIntSysClusterObj();
		CFIntSysClusterObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntSysClusterObj();
