...
namespace cfint {
	...
	class CFIntSysClusterTableObj
	: public virtual ICFIntSysClusterTableObj,
	...
	public:
		...
		CFIntSysClusterTableObj();
		CFIntSysClusterTableObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual ~CFIntSysClusterTableObj();
