...
// Description: C++18 edit object instance specification for CFInt TSecGroup.
...
namespace cfint {
	...
	class CFIntTSecGroupEditObj
	: public virtual ICFIntTSecGroupEditObj,
	  public virtual cfsec::ICFSecTSecGroupEditObj
	{
	public:
	...
	public:
		CFIntTSecGroupEditObj( cfsec::ICFSecTSecGroupObj* argOrig );
		virtual ~CFIntTSecGroupEditObj();
