...
// Description: C++18 base object instance specification for CFInt TSecGroup.
...
namespace cfint {
	...
	class CFIntTSecGroupObj
	: public virtual ICFIntTSecGroupObj,
	...
	public:
		...
		CFIntTSecGroupObj();
		CFIntTSecGroupObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntTSecGroupObj();
