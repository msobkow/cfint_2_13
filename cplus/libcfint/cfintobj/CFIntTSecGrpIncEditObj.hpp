...
// Description: C++18 edit object instance specification for CFInt TSecGrpInc.
...
namespace cfint {
	...
	class CFIntTSecGrpIncEditObj
	: public virtual ICFIntTSecGrpIncEditObj,
	  public virtual cfsec::ICFSecTSecGrpIncEditObj
	{
	public:
	...
	public:
		CFIntTSecGrpIncEditObj( cfsec::ICFSecTSecGrpIncObj* argOrig );
		virtual ~CFIntTSecGrpIncEditObj();
