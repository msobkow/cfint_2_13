...
// Description: C++18 base object instance specification for CFInt TSecGrpInc.
...
namespace cfint {
	...
	class CFIntTSecGrpIncObj
	: public virtual ICFIntTSecGrpIncObj,
	...
	public:
		...
		CFIntTSecGrpIncObj();
		CFIntTSecGrpIncObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntTSecGrpIncObj();
