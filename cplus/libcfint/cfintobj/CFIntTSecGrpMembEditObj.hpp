...
// Description: C++18 edit object instance specification for CFInt TSecGrpMemb.
...
namespace cfint {
	...
	class CFIntTSecGrpMembEditObj
	: public virtual ICFIntTSecGrpMembEditObj,
	  public virtual cfsec::ICFSecTSecGrpMembEditObj
	{
	public:
	...
	public:
		CFIntTSecGrpMembEditObj( cfsec::ICFSecTSecGrpMembObj* argOrig );
		virtual ~CFIntTSecGrpMembEditObj();
