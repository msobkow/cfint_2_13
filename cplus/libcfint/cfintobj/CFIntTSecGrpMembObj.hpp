...
// Description: C++18 base object instance specification for CFInt TSecGrpMemb.
...
namespace cfint {
	...
	class CFIntTSecGrpMembObj
	: public virtual ICFIntTSecGrpMembObj,
	...
	public:
		...
		CFIntTSecGrpMembObj();
		CFIntTSecGrpMembObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntTSecGrpMembObj();
