...
// Description: C++18 edit object instance specification for CFInt Tenant.
...
namespace cfint {
	...
	class CFIntTenantEditObj
	: public virtual ICFIntTenantEditObj,
	  public virtual cfsec::ICFSecTenantEditObj
	{
	public:
	...
	public:
		CFIntTenantEditObj( cfsec::ICFSecTenantObj* argOrig );
		virtual ~CFIntTenantEditObj();
		...
		virtual std::vector<cfint::ICFIntTldObj*> getOptionalComponentsTld( bool forceRead = false );
