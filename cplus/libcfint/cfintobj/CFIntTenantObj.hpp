...
// Description: C++18 base object instance specification for CFInt Tenant.
...
namespace cfint {
	...
	class CFIntTenantObj
	: public virtual ICFIntTenantObj,
	...
	public:
		...
		CFIntTenantObj();
		CFIntTenantObj( cfsec::ICFSecSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntTenantObj();
