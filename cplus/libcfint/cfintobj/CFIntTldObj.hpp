...
// Description: C++18 base object instance specification for CFInt Tld.
...
namespace cfint {
	...
	class CFIntTldObj
	: public virtual ICFIntTldObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntTldEditObj* edit;
	...
	public:
		...
		CFIntTldObj();
		CFIntTldObj( cfint::ICFIntSchemaObj* argSchema );
		...
		virtual cfint::ICFIntTldObj* realize();
		...
		virtual cfint::ICFIntTldEditObj* beginEdit();
