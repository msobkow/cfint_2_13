...
// Description: C++18 base object instance specification for CFInt TopDomain.
...
namespace cfint {
	...
	class CFIntTopDomainObj
	: public virtual ICFIntTopDomainObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntTopDomainEditObj* edit;
	...
	public:
		...
		CFIntTopDomainObj();
		CFIntTopDomainObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntTopDomainObj();
		...
		virtual cfint::ICFIntTopDomainObj* realize();
		...
		virtual cfint::ICFIntTopDomainEditObj* beginEdit();
