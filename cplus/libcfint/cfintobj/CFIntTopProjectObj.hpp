...
// Description: C++18 base object instance specification for CFInt TopProject.
...
namespace cfint {
	...
	class CFIntTopProjectObj
	: public virtual ICFIntTopProjectObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntTopProjectEditObj* edit;
	...
	public:
		...
		CFIntTopProjectObj();
		CFIntTopProjectObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntTopProjectObj();
		...
		virtual cfint::ICFIntTopProjectObj* realize();
		...
		virtual cfint::ICFIntTopProjectEditObj* beginEdit();
