...
// Description: C++18 base object instance specification for CFInt URLProtocol.
...
namespace cfint {
	...
	class CFIntURLProtocolObj
	: public virtual ICFIntURLProtocolObj
	{
	protected:
		cfsec::ICFSecSecUserObj* createdBy = NULL;
		cfsec::ICFSecSecUserObj* updatedBy = NULL;
		bool isNew;
		cfint::ICFIntURLProtocolEditObj* edit;
	...
	public:
		...
		CFIntURLProtocolObj();
		CFIntURLProtocolObj( cfint::ICFIntSchemaObj* argSchema );
		virtual const std::string& getClassName() const;
		virtual ~CFIntURLProtocolObj();
		...
		virtual cfint::ICFIntURLProtocolObj* realize();
		...
		virtual cfint::ICFIntURLProtocolEditObj* beginEdit();
