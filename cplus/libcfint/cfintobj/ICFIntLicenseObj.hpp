...
// Description: C++18 Object interface for CFInt License.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntLicenseObj* realize() = 0;

		virtual cfint::ICFIntLicenseObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntLicenseEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntLicenseEditObj* getEdit() = 0;

		virtual cfint::ICFIntLicenseEditObj* getLicenseEdit() = 0;

		virtual cfint::ICFIntLicenseTableObj* getLicenseTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntLicenseBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntLicenseBuff* value ) = 0;
		...
		virtual cfint::CFIntLicensePKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntLicensePKey* value ) = 0;
		...
		virtual const int64_t getRequiredTopDomainId() = 0;
		virtual const int64_t* getRequiredTopDomainIdReference() = 0;
