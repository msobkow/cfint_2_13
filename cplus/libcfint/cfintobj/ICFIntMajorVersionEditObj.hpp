...
// Description: C++18 Instance Edit Object interface for CFInt MajorVersion.
...
namespace cfint {
	...
	class ICFIntMajorVersionEditObj
	: public virtual cfint::ICFIntMajorVersionObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFIntMajorVersionEditObj();
		virtual ~ICFIntMajorVersionEditObj();
		...
		virtual cfint::ICFIntMajorVersionObj* getOrig() = 0;

		virtual cfint::ICFIntMajorVersionObj* getOrigAsMajorVersion() = 0;
		...
		virtual cfint::ICFIntMajorVersionObj* create() = 0;

		virtual cfint::ICFIntMajorVersionEditObj* update() = 0;

		virtual cfint::ICFIntMajorVersionEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerParentSPrj( cfint::ICFIntSubProjectObj* value ) = 0;
