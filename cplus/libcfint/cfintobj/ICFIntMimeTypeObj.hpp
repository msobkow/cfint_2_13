...
// Description: C++18 Object interface for CFInt MimeType.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntMimeTypeObj* realize() = 0;

		virtual cfint::ICFIntMimeTypeObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntMimeTypeEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntMimeTypeEditObj* getEdit() = 0;

		virtual cfint::ICFIntMimeTypeEditObj* getMimeTypeEdit() = 0;

		virtual cfint::ICFIntMimeTypeTableObj* getMimeTypeTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntMimeTypeBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntMimeTypeBuff* value ) = 0;

		inline cfint::CFIntMimeTypeBuff* getMimeTypeBuff() {
			return( static_cast<cfint::CFIntMimeTypeBuff*>( getBuff() ) );
		};

		inline cfint::CFIntMimeTypeBuff* getMimeTypeEditBuff() {
			return( dynamic_cast<cfint::CFIntMimeTypeBuff*>( getBuff() ) );
		};

		virtual cfint::CFIntMimeTypePKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntMimeTypePKey* value ) = 0;

		virtual bool getIsNew() = 0;
		virtual void setIsNew( bool value ) = 0;

		virtual const int32_t getRequiredMimeTypeId() = 0;
		virtual const int32_t* getRequiredMimeTypeIdReference() = 0;

		virtual const std::string& getRequiredName() = 0;
		virtual const std::string* getRequiredNameReference() = 0;

		virtual bool isOptionalFileTypesNull() = 0;
		virtual const std::string& getOptionalFileTypesValue() = 0;
		virtual const std::string* getOptionalFileTypesReference() = 0;
