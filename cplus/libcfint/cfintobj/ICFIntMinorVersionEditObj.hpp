...
// Description: C++18 Instance Edit Object interface for CFInt MinorVersion.
...
namespace cfint {
	...
	class ICFIntMinorVersionEditObj
	: public virtual cfint::ICFIntMinorVersionObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFIntMinorVersionEditObj();
		virtual ~ICFIntMinorVersionEditObj();
		...
		virtual cfint::ICFIntMinorVersionObj* getOrig() = 0;

		virtual cfint::ICFIntMinorVersionObj* getOrigAsMinorVersion() = 0;
		...
		virtual cfint::ICFIntMinorVersionObj* create() = 0;

		virtual cfint::ICFIntMinorVersionEditObj* update() = 0;

		virtual cfint::ICFIntMinorVersionEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerParentMajVer( cfint::ICFIntMajorVersionObj* value ) = 0;
