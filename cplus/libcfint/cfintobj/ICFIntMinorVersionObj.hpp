...
// Description: C++18 Object interface for CFInt MinorVersion.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntMinorVersionObj* realize() = 0;

		virtual cfint::ICFIntMinorVersionObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntMinorVersionEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntMinorVersionEditObj* getEdit() = 0;

		virtual cfint::ICFIntMinorVersionEditObj* getMinorVersionEdit() = 0;

		virtual cfint::ICFIntMinorVersionTableObj* getMinorVersionTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntMinorVersionBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntMinorVersionBuff* value ) = 0;

		inline cfint::CFIntMinorVersionBuff* getMinorVersionBuff() {
			return( static_cast<cfint::CFIntMinorVersionBuff*>( getBuff() ) );
		};

		inline cfint::CFIntMinorVersionBuff* getMinorVersionEditBuff() {
			return( dynamic_cast<cfint::CFIntMinorVersionBuff*>( getBuff() ) );
		};

		virtual cfint::CFIntMinorVersionPKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntMinorVersionPKey* value ) = 0;
		...
		virtual const int64_t getRequiredMajorVersionId() = 0;
		virtual const int64_t* getRequiredMajorVersionIdReference() = 0;
		...
		virtual cfint::ICFIntMajorVersionObj* getRequiredContainerParentMajVer( bool forceRead = false ) = 0;
