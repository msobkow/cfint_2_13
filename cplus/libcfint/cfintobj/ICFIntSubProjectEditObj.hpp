...
// Description: C++18 Instance Edit Object interface for CFInt SubProject.
...
namespace cfint {
	...
	class ICFIntSubProjectEditObj
	: public virtual cfint::ICFIntSubProjectObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFIntSubProjectEditObj();
		virtual ~ICFIntSubProjectEditObj();
		...
		virtual cfint::ICFIntSubProjectObj* getOrig() = 0;

		virtual cfint::ICFIntSubProjectObj* getOrigAsSubProject() = 0;
		...
		virtual cfint::ICFIntSubProjectObj* create() = 0;

		virtual cfint::ICFIntSubProjectEditObj* update() = 0;

		virtual cfint::ICFIntSubProjectEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerParentTPrj( cfint::ICFIntTopProjectObj* value ) = 0;
