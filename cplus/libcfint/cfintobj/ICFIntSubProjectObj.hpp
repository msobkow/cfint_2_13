...
// Description: C++18 Object interface for CFInt SubProject.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntSubProjectObj* realize() = 0;

		virtual cfint::ICFIntSubProjectObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntSubProjectEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntSubProjectEditObj* getEdit() = 0;

		virtual cfint::ICFIntSubProjectEditObj* getSubProjectEdit() = 0;

		virtual cfint::ICFIntSubProjectTableObj* getSubProjectTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntSubProjectBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntSubProjectBuff* value ) = 0;

		inline cfint::CFIntSubProjectBuff* getSubProjectBuff() {
			return( static_cast<cfint::CFIntSubProjectBuff*>( getBuff() ) );
		};

		inline cfint::CFIntSubProjectBuff* getSubProjectEditBuff() {
			return( dynamic_cast<cfint::CFIntSubProjectBuff*>( getBuff() ) );
		};

		virtual cfint::CFIntSubProjectPKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntSubProjectPKey* value ) = 0;
		...
		virtual const int64_t getRequiredTopProjectId() = 0;
		virtual const int64_t* getRequiredTopProjectIdReference() = 0;
		...
		virtual cfint::ICFIntTopProjectObj* getRequiredContainerParentTPrj( bool forceRead = false ) = 0;

		virtual std::vector<cfint::ICFIntMajorVersionObj*> getOptionalComponentsMajorVer( bool forceRead = false ) = 0;
