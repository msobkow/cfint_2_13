...
// Description: C++18 Object interface for CFInt Tenant.
...
namespace cfint {
	...
	public:
		...
		virtual std::vector<cfint::ICFIntTldObj*> getOptionalComponentsTld( bool forceRead = false ) = 0;
