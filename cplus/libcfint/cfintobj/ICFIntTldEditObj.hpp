...
// Description: C++18 Instance Edit Object interface for CFInt Tld.
...
namespace cfint {
	...
	class ICFIntTldEditObj
	: public virtual cfint::ICFIntTldObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFIntTldEditObj();
		virtual ~ICFIntTldEditObj();
		...
		virtual cfint::ICFIntTldObj* getOrig() = 0;

		virtual cfint::ICFIntTldObj* getOrigAsTld() = 0;
		...
		virtual cfint::ICFIntTldObj* create() = 0;

		virtual cfint::ICFIntTldEditObj* update() = 0;

		virtual cfint::ICFIntTldEditObj* deleteInstance() = 0;
