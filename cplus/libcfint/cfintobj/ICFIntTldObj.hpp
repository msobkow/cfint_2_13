...
// Description: C++18 Object interface for CFInt Tld.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntTldObj* realize() = 0;

		virtual cfint::ICFIntTldObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntTldEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntTldEditObj* getEdit() = 0;

		virtual cfint::ICFIntTldEditObj* getTldEdit() = 0;

		virtual cfint::ICFIntTldTableObj* getTldTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntTldBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntTldBuff* value ) = 0;

		inline cfint::CFIntTldBuff* getTldBuff() {
			return( static_cast<cfint::CFIntTldBuff*>( getBuff() ) );
		};

		inline cfint::CFIntTldBuff* getTldEditBuff() {
			return( dynamic_cast<cfint::CFIntTldBuff*>( getBuff() ) );
		};

		virtual cfint::CFIntTldPKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntTldPKey* value ) = 0;
		...
		virtual std::vector<cfint::ICFIntTopDomainObj*> getOptionalComponentsTopDomain( bool forceRead = false ) = 0;
