...
// Description: C++18 Instance Edit Object interface for CFInt TopDomain.
...
namespace cfint {
	...
	class ICFIntTopDomainEditObj
	: public virtual cfint::ICFIntTopDomainObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFIntTopDomainEditObj();
		virtual ~ICFIntTopDomainEditObj();
		...
		virtual cfint::ICFIntTopDomainObj* getOrig() = 0;

		virtual cfint::ICFIntTopDomainObj* getOrigAsTopDomain() = 0;
		...
		virtual cfint::ICFIntTopDomainObj* create() = 0;

		virtual cfint::ICFIntTopDomainEditObj* update() = 0;

		virtual cfint::ICFIntTopDomainEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerParentTld( cfint::ICFIntTldObj* value ) = 0;
