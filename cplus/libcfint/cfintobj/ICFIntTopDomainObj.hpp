...
// Description: C++18 Object interface for CFInt TopDomain.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntTopDomainObj* realize() = 0;

		virtual cfint::ICFIntTopDomainObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntTopDomainEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntTopDomainEditObj* getEdit() = 0;

		virtual cfint::ICFIntTopDomainEditObj* getTopDomainEdit() = 0;

		virtual cfint::ICFIntTopDomainTableObj* getTopDomainTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntTopDomainBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntTopDomainBuff* value ) = 0;

		inline cfint::CFIntTopDomainBuff* getTopDomainBuff() {
			return( static_cast<cfint::CFIntTopDomainBuff*>( getBuff() ) );
		};

		inline cfint::CFIntTopDomainBuff* getTopDomainEditBuff() {
			return( dynamic_cast<cfint::CFIntTopDomainBuff*>( getBuff() ) );
		};

		virtual cfint::CFIntTopDomainPKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntTopDomainPKey* value ) = 0;
		...
		virtual const int64_t getRequiredTldId() = 0;
		virtual const int64_t* getRequiredTldIdReference() = 0;
		...
		virtual cfint::ICFIntTldObj* getRequiredContainerParentTld( bool forceRead = false ) = 0;

		virtual std::vector<cfint::ICFIntLicenseObj*> getOptionalComponentsLicense( bool forceRead = false ) = 0;

		virtual std::vector<cfint::ICFIntTopProjectObj*> getOptionalComponentsTopProject( bool forceRead = false ) = 0;
