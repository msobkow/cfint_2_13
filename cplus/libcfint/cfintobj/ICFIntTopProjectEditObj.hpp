...
// Description: C++18 Instance Edit Object interface for CFInt TopProject.
...
namespace cfint {
	...
	class ICFIntTopProjectEditObj
	: public virtual cfint::ICFIntTopProjectObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFIntTopProjectEditObj();
		virtual ~ICFIntTopProjectEditObj();
		...
		virtual cfint::ICFIntTopProjectObj* getOrig() = 0;

		virtual cfint::ICFIntTopProjectObj* getOrigAsTopProject() = 0;
		...
		virtual cfint::ICFIntTopProjectObj* create() = 0;

		virtual cfint::ICFIntTopProjectEditObj* update() = 0;

		virtual cfint::ICFIntTopProjectEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredContainerParentSDom( cfint::ICFIntTopDomainObj* value ) = 0;
