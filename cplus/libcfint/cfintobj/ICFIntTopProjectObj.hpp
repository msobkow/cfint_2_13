...
// Description: C++18 Object interface for CFInt TopProject.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntTopProjectObj* realize() = 0;

		virtual cfint::ICFIntTopProjectObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntTopProjectEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntTopProjectEditObj* getEdit() = 0;

		virtual cfint::ICFIntTopProjectEditObj* getTopProjectEdit() = 0;

		virtual cfint::ICFIntTopProjectTableObj* getTopProjectTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntTopProjectBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntTopProjectBuff* value ) = 0;

		inline cfint::CFIntTopProjectBuff* getTopProjectBuff() {
			return( static_cast<cfint::CFIntTopProjectBuff*>( getBuff() ) );
		};

		inline cfint::CFIntTopProjectBuff* getTopProjectEditBuff() {
			return( dynamic_cast<cfint::CFIntTopProjectBuff*>( getBuff() ) );
		};

		virtual cfint::CFIntTopProjectPKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntTopProjectPKey* value ) = 0;
		...
		virtual cfint::ICFIntTopDomainObj* getRequiredContainerParentSDom( bool forceRead = false ) = 0;

		virtual std::vector<cfint::ICFIntSubProjectObj*> getOptionalComponentsSubProject( bool forceRead = false ) = 0;
