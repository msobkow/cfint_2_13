...
// Description: C++18 Instance Edit Object interface for CFInt URLProtocol.
...
namespace cfint {
	...
	class ICFIntURLProtocolEditObj
	: public virtual cfint::ICFIntURLProtocolObj
	{
	public:
		static const std::string CLASS_NAME;
		ICFIntURLProtocolEditObj();
		virtual ~ICFIntURLProtocolEditObj();
		...
		virtual cfint::ICFIntURLProtocolObj* getOrig() = 0;

		virtual cfint::ICFIntURLProtocolObj* getOrigAsURLProtocol() = 0;
		...
		virtual cfint::ICFIntURLProtocolObj* create() = 0;

		virtual cfint::ICFIntURLProtocolEditObj* update() = 0;

		virtual cfint::ICFIntURLProtocolEditObj* deleteInstance() = 0;
		...
		virtual void setRequiredIsSecure( const bool value ) = 0;
