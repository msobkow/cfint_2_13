...
// Description: C++18 Object interface for CFInt URLProtocol.
...
namespace cfint {
	...
	public:
		...
		virtual cfint::ICFIntURLProtocolObj* realize() = 0;

		virtual cfint::ICFIntURLProtocolObj* read( bool forceRead = false ) = 0;

		virtual cfint::ICFIntURLProtocolEditObj* beginEdit() = 0;

		virtual void endEdit() = 0;

		virtual cfint::ICFIntURLProtocolEditObj* getEdit() = 0;

		virtual cfint::ICFIntURLProtocolEditObj* getURLProtocolEdit() = 0;

		virtual cfint::ICFIntURLProtocolTableObj* getURLProtocolTable() = 0;

		virtual cfint::ICFIntSchemaObj* getSchema() = 0;

		virtual cfint::CFIntURLProtocolBuff* getBuff() = 0;
		virtual void setBuff( cfint::CFIntURLProtocolBuff* value ) = 0;

		inline cfint::CFIntURLProtocolBuff* getURLProtocolBuff() {
			return( static_cast<cfint::CFIntURLProtocolBuff*>( getBuff() ) );
		};

		inline cfint::CFIntURLProtocolBuff* getURLProtocolEditBuff() {
			return( dynamic_cast<cfint::CFIntURLProtocolBuff*>( getBuff() ) );
		};

		virtual cfint::CFIntURLProtocolPKey* getPKey() = 0;
		virtual void setPKey( cfint::CFIntURLProtocolPKey* value ) = 0;

		virtual bool getIsNew() = 0;
		virtual void setIsNew( bool value ) = 0;

		virtual const int32_t getRequiredURLProtocolId() = 0;
		virtual const int32_t* getRequiredURLProtocolIdReference() = 0;
		...
		virtual const bool getRequiredIsSecure() = 0;
		virtual const bool* getRequiredIsSecureReference() = 0;
