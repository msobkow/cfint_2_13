...
namespace cfint {
	...
	const std::string CFIntRamISOCtryCcyTable::CLASS_NAME( "CFIntRamISOCtryCcyTable" );

	CFIntRamISOCtryCcyTable::CFIntRamISOCtryCcyTable( ICFIntSchema* argSchema )
	...
	CFIntRamISOCtryCcyTable::~CFIntRamISOCtryCcyTable() {
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::createISOCtryCcy( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryCcyPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryCcyBuff*> CFIntRamISOCtryCcyTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryCcyBuff*> CFIntRamISOCtryCcyTable::readDerivedByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryCcyBuff*> CFIntRamISOCtryCcyTable::readDerivedByCcyIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId,
			const int16_t ISOCcyId )
	{
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryCcyPKey* PKey )
	{
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryCcyPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryCcyBuff*> CFIntRamISOCtryCcyTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId,
			const int16_t ISOCcyId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryCcyBuff*> CFIntRamISOCtryCcyTable::readBuffByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryCcyBuff*> CFIntRamISOCtryCcyTable::readBuffByCcyIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCcyId )
	{
	...
	cfsec::CFSecISOCtryCcyBuff* CFIntRamISOCtryCcyTable::updateISOCtryCcy( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryCcyBuff* Buff )
	{
	...
	void CFIntRamISOCtryCcyTable::deleteISOCtryCcy( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryCcyBuff* Buff )
	{
	...
	void CFIntRamISOCtryCcyTable::deleteISOCtryCcyByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOCtryCcyTable::deleteISOCtryCcyByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t argISOCtryId )
	{
		cfsec::CFSecISOCtryCcyByCtryIdxKey key;
		key.setRequiredISOCtryId( argISOCtryId );
	...
	void CFIntRamISOCtryCcyTable::deleteISOCtryCcyByCcyIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t argISOCcyId )
	{
		cfsec::CFSecISOCtryCcyByCcyIdxKey key;
		key.setRequiredISOCcyId( argISOCcyId );
	...
	void CFIntRamISOCtryCcyTable::releasePreparedStatements() {
	}
