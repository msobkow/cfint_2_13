...
namespace cfint {
	...
	const std::string CFIntRamISOCtryLangTable::CLASS_NAME( "CFIntRamISOCtryLangTable" );

	CFIntRamISOCtryLangTable::CFIntRamISOCtryLangTable( ICFIntSchema* argSchema )
	...
	CFIntRamISOCtryLangTable::~CFIntRamISOCtryLangTable() {
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::createISOCtryLang( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryLangPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFIntRamISOCtryLangTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFIntRamISOCtryLangTable::readDerivedByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFIntRamISOCtryLangTable::readDerivedByLangIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId,
			const int16_t ISOLangId )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryLangPKey* PKey )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryLangPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFIntRamISOCtryLangTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId,
			const int16_t ISOLangId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFIntRamISOCtryLangTable::readBuffByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryLangBuff*> CFIntRamISOCtryLangTable::readBuffByLangIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOLangId )
	{
	...
	cfsec::CFSecISOCtryLangBuff* CFIntRamISOCtryLangTable::updateISOCtryLang( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryLangBuff* Buff )
	{
	...
	void CFIntRamISOCtryLangTable::deleteISOCtryLang( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryLangBuff* Buff )
	{
	...
	void CFIntRamISOCtryLangTable::deleteISOCtryLangByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOCtryLangTable::deleteISOCtryLangByCtryIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t argISOCtryId )
	{
		cfsec::CFSecISOCtryLangByCtryIdxKey key;
		key.setRequiredISOCtryId( argISOCtryId );
	...
	void CFIntRamISOCtryLangTable::deleteISOCtryLangByLangIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t argISOLangId )
	{
		cfsec::CFSecISOCtryLangByLangIdxKey key;
		key.setRequiredISOLangId( argISOLangId );
	...
	void CFIntRamISOCtryLangTable::releasePreparedStatements() {
	}
