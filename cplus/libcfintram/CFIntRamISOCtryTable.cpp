...
namespace cfint {
	...
	const std::string CFIntRamISOCtryTable::CLASS_NAME( "CFIntRamISOCtryTable" );

	CFIntRamISOCtryTable::CFIntRamISOCtryTable( ICFIntSchema* argSchema )
	...
	CFIntRamISOCtryTable::~CFIntRamISOCtryTable() {
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::createISOCtry( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryBuff*> CFIntRamISOCtryTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readDerivedByISOCodeIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readDerivedByNameIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryPKey* PKey )
	{
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOCtryPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOCtryBuff*> CFIntRamISOCtryTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOCtryId )
	{
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readBuffByISOCodeIdx( const cfsec::CFSecAuthorization* Authorization,
			const std::string& ISOCode )
	{
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readBuffByNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const std::string& Name )
	{
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readBuffByLookupISOCodeIdx( const cfsec::CFSecAuthorization* Authorization, const std::string& ISOCode,
		bool forceRead )
	{
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::readDerivedByLookupISOCodeIdx( const cfsec::CFSecAuthorization* Authorization, const std::string& ISOCode,
		bool forceRead )
	{
	...
	cfsec::CFSecISOCtryBuff* CFIntRamISOCtryTable::updateISOCtry( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryBuff* Buff )
	{
	...
	void CFIntRamISOCtryTable::deleteISOCtry( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOCtryBuff* Buff )
	{
	...
	void CFIntRamISOCtryTable::deleteISOCtryByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOCtryTable::deleteISOCtryByISOCodeIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOCtryTable::deleteISOCtryByNameIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOCtryTable::releasePreparedStatements() {
	}
