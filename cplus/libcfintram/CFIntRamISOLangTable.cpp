...
namespace cfint {
	...
	const std::string CFIntRamISOLangTable::CLASS_NAME( "CFIntRamISOLangTable" );

	CFIntRamISOLangTable::CFIntRamISOLangTable( ICFIntSchema* argSchema )
	...
	CFIntRamISOLangTable::~CFIntRamISOLangTable() {
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::createISOLang( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOLangPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOLangBuff*> CFIntRamISOLangTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readDerivedByCode3Idx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecISOLangBuff*> CFIntRamISOLangTable::readDerivedByCode2Idx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOLangPKey* PKey )
	{
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecISOLangPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOLangBuff*> CFIntRamISOLangTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int16_t ISOLangId )
	{
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readBuffByCode3Idx( const cfsec::CFSecAuthorization* Authorization,
			const std::string& ISO6392Code )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecISOLangBuff*> CFIntRamISOLangTable::readBuffByCode2Idx( const cfsec::CFSecAuthorization* Authorization,
			const std::string* ISO6391Code )
	{
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readBuffByLookupCode3Idx( const cfsec::CFSecAuthorization* Authorization, const std::string& ISO6392Code,
		bool forceRead )
	{
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::readDerivedByLookupCode3Idx( const cfsec::CFSecAuthorization* Authorization, const std::string& ISO6392Code,
		bool forceRead )
	{
	...
	cfsec::CFSecISOLangBuff* CFIntRamISOLangTable::updateISOLang( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOLangBuff* Buff )
	{
	...
	void CFIntRamISOLangTable::deleteISOLang( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecISOLangBuff* Buff )
	{
	...
	void CFIntRamISOLangTable::deleteISOLangByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOLangTable::deleteISOLangByCode3Idx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOLangTable::deleteISOLangByCode2Idx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamISOLangTable::releasePreparedStatements() {
	}
