...
namespace cfint {
	...
	const std::string CFIntRamSecAppTable::CLASS_NAME( "CFIntRamSecAppTable" );

	CFIntRamSecAppTable::CFIntRamSecAppTable( ICFIntSchema* argSchema )
	...
	CFIntRamSecAppTable::~CFIntRamSecAppTable() {
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::createSecApp( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecAppBuff* Buff )
	{
		static const std::string S_ProcName( "createSecApp" );
		cfsec::CFSecSecAppPKey pkey;
		pkey.setRequiredClusterId( Buff->getRequiredClusterId() );
		pkey.setRequiredSecAppId( dynamic_cast<CFIntRamClusterTable*>( schema->getTableCluster() )->nextSecAppIdGen( Authorization,
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecAppPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecAppBuff*> CFIntRamSecAppTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecSecAppBuff*> CFIntRamSecAppTable::readDerivedByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readDerivedByUJEEMountIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecAppPKey* PKey )
	{
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecAppPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecAppBuff*> CFIntRamSecAppTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecAppBuff*> CFIntRamSecAppTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecAppId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecAppBuff*> CFIntRamSecAppTable::readBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId )
	{
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readBuffByUJEEMountIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const std::string& JEEMountName )
	{
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readBuffByLookupUJEEMountIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::readDerivedByLookupUJEEMountIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId, const std::string& JEEMountName,
		bool forceRead )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecAppBuff*> CFIntRamSecAppTable::pageBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t* priorClusterId,
			const int32_t* priorSecAppId )
	{
	...
	cfsec::CFSecSecAppBuff* CFIntRamSecAppTable::updateSecApp( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecAppBuff* Buff )
	{
	...
	void CFIntRamSecAppTable::deleteSecApp( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecAppBuff* Buff )
	{
	...
	void CFIntRamSecAppTable::deleteSecAppByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSecAppTable::deleteSecAppByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId )
	{
		cfsec::CFSecSecAppByClusterIdxKey key;
		key.setRequiredClusterId( argClusterId );
	...
	void CFIntRamSecAppTable::deleteSecAppByUJEEMountIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
	...
	void CFIntRamSecAppTable::releasePreparedStatements() {
	}
