...
namespace cfint {
	...
	const std::string CFIntRamSecDeviceTable::CLASS_NAME( "CFIntRamSecDeviceTable" );

	CFIntRamSecDeviceTable::CFIntRamSecDeviceTable( ICFIntSchema* argSchema )
	...
	CFIntRamSecDeviceTable::~CFIntRamSecDeviceTable() {
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::createSecDevice( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecDevicePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecDeviceBuff*> CFIntRamSecDeviceTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readDerivedByNameIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecSecDeviceBuff*> CFIntRamSecDeviceTable::readDerivedByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId )
	{
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId,
			const std::string& DevName )
	{
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecDevicePKey* PKey )
	{
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecDevicePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecDeviceBuff*> CFIntRamSecDeviceTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecDeviceBuff*> CFIntRamSecDeviceTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId,
			const std::string& DevName )
	{
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readBuffByNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId,
			const std::string& DevName )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecDeviceBuff*> CFIntRamSecDeviceTable::readBuffByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId )
	{
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readBuffByLookupNameIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::readDerivedByLookupNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId, const std::string& DevName,
		bool forceRead )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecDeviceBuff*> CFIntRamSecDeviceTable::pageBuffByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId,
			const uuid_ptr_t priorSecUserId,
			const std::string* priorDevName )
	{
	...
	cfsec::CFSecSecDeviceBuff* CFIntRamSecDeviceTable::updateSecDevice( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecDeviceBuff* Buff )
	{
	...
	void CFIntRamSecDeviceTable::deleteSecDevice( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecDeviceBuff* Buff )
	{
	...
	void CFIntRamSecDeviceTable::deleteSecDeviceByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSecDeviceTable::deleteSecDeviceByNameIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t argSecUserId,
			const std::string& argDevName )
	{
		cfsec::CFSecSecDeviceByNameIdxKey key;
	...
	void CFIntRamSecDeviceTable::deleteSecDeviceByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t argSecUserId )
	{
		cfsec::CFSecSecDeviceByUserIdxKey key;
		key.setRequiredSecUserId( argSecUserId );
	...
	void CFIntRamSecDeviceTable::releasePreparedStatements() {
	}
