...
namespace cfint {
	...
	const std::string CFIntRamSecFormTable::CLASS_NAME( "CFIntRamSecFormTable" );

	CFIntRamSecFormTable::CFIntRamSecFormTable( ICFIntSchema* argSchema )
	...
	CFIntRamSecFormTable::~CFIntRamSecFormTable() {
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::createSecForm( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecFormBuff* Buff )
	{
		static const std::string S_ProcName( "createSecForm" );
		cfsec::CFSecSecFormPKey pkey;
		pkey.setRequiredClusterId( Buff->getRequiredClusterId() );
		pkey.setRequiredSecFormId( dynamic_cast<CFIntRamClusterTable*>( schema->getTableCluster() )->nextSecFormIdGen( Authorization,
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecFormPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::readDerivedByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::readDerivedBySecAppIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readDerivedByUJEEServletIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecAppId,
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecFormPKey* PKey )
	{
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecFormPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecFormId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::readBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::readBuffBySecAppIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecAppId )
	{
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readBuffByUJEEServletIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecAppId,
			const std::string& JEEServletMapName )
	{
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readBuffByLookupUJEEServletIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::readDerivedByLookupUJEEServletIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecAppId, const std::string& JEEServletMapName,
		bool forceRead )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::pageBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t* priorClusterId,
			const int32_t* priorSecFormId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecFormBuff*> CFIntRamSecFormTable::pageBuffBySecAppIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecAppId,
			const int64_t* priorClusterId,
			const int32_t* priorSecFormId )
	...
	cfsec::CFSecSecFormBuff* CFIntRamSecFormTable::updateSecForm( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecFormBuff* Buff )
	{
	...
	void CFIntRamSecFormTable::deleteSecForm( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecFormBuff* Buff )
	{
	...
	void CFIntRamSecFormTable::deleteSecFormByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSecFormTable::deleteSecFormByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId )
	{
		cfsec::CFSecSecFormByClusterIdxKey key;
		key.setRequiredClusterId( argClusterId );
	...
	void CFIntRamSecFormTable::deleteSecFormBySecAppIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
	...
	void CFIntRamSecFormTable::deleteSecFormByUJEEServletIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
			const int32_t argSecAppId,
	...
	void CFIntRamSecFormTable::releasePreparedStatements() {
	}
