...
namespace cfint {
	...
	const std::string CFIntRamSecGrpIncTable::CLASS_NAME( "CFIntRamSecGrpIncTable" );

	CFIntRamSecGrpIncTable::CFIntRamSecGrpIncTable( ICFIntSchema* argSchema )
	...
	CFIntRamSecGrpIncTable::~CFIntRamSecGrpIncTable() {
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::createSecGrpInc( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecGrpIncBuff* Buff )
	{
		static const std::string S_ProcName( "createSecGrpInc" );
		cfsec::CFSecSecGrpIncPKey pkey;
		pkey.setRequiredClusterId( Buff->getRequiredClusterId() );
		pkey.setRequiredSecGrpIncId( dynamic_cast<CFIntRamClusterTable*>( schema->getTableCluster() )->nextSecGrpIncIdGen( Authorization,
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecGrpIncPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readDerivedByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readDerivedByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readDerivedByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::readDerivedByUIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId,
			const int32_t IncludeGroupId )
	{
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecGrpIncPKey* PKey )
	{
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecGrpIncPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t SecGrpIncId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::readBuffByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t IncludeGroupId )
	{
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::readBuffByUIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId,
			const int32_t IncludeGroupId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::pageBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t* priorClusterId,
			const int64_t* priorSecGrpIncId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::pageBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId,
			const int64_t* priorClusterId,
			const int64_t* priorSecGrpIncId )
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpIncBuff*> CFIntRamSecGrpIncTable::pageBuffByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t IncludeGroupId,
			const int64_t* priorClusterId,
			const int64_t* priorSecGrpIncId )
	...
	cfsec::CFSecSecGrpIncBuff* CFIntRamSecGrpIncTable::updateSecGrpInc( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecGrpIncBuff* Buff )
	{
	...
	void CFIntRamSecGrpIncTable::deleteSecGrpInc( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecGrpIncBuff* Buff )
	{
	...
	void CFIntRamSecGrpIncTable::deleteSecGrpIncByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSecGrpIncTable::deleteSecGrpIncByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId )
	{
		cfsec::CFSecSecGrpIncByClusterIdxKey key;
		key.setRequiredClusterId( argClusterId );
	...
	void CFIntRamSecGrpIncTable::deleteSecGrpIncByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
	...
	void CFIntRamSecGrpIncTable::deleteSecGrpIncByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
	...
	void CFIntRamSecGrpIncTable::deleteSecGrpIncByUIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
			const int32_t argSecGroupId,
			const int32_t argIncludeGroupId )
	{
	...
	void CFIntRamSecGrpIncTable::releasePreparedStatements() {
	}
