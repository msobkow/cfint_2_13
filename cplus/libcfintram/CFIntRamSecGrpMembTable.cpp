...
namespace cfint {
	...
	const std::string CFIntRamSecGrpMembTable::CLASS_NAME( "CFIntRamSecGrpMembTable" );

	CFIntRamSecGrpMembTable::CFIntRamSecGrpMembTable( ICFIntSchema* argSchema )
	...
	CFIntRamSecGrpMembTable::~CFIntRamSecGrpMembTable() {
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::createSecGrpMemb( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecGrpMembBuff* Buff )
	{
		...
		pkey.setRequiredSecGrpMembId( dynamic_cast<CFIntRamClusterTable*>( schema->getTableCluster() )->nextSecGrpMembIdGen( Authorization,
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecGrpMembPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readDerivedByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readDerivedByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readDerivedByUserIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::readDerivedByUUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId,
			const uuid_ptr_t SecUserId )
	{
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecGrpMembPKey* PKey )
	{
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSecGrpMembPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t SecGrpMembId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::readBuffByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId )
	{
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::readBuffByUUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId,
			const uuid_ptr_t SecUserId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::pageBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t* priorClusterId,
			const int64_t* priorSecGrpMembId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::pageBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int32_t SecGroupId,
			const int64_t* priorClusterId,
			const int64_t* priorSecGrpMembId )
	...
	std::TCFLibOwningVector<cfsec::CFSecSecGrpMembBuff*> CFIntRamSecGrpMembTable::pageBuffByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId,
			const int64_t* priorClusterId,
			const int64_t* priorSecGrpMembId )
	{
	...
	cfsec::CFSecSecGrpMembBuff* CFIntRamSecGrpMembTable::updateSecGrpMemb( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecGrpMembBuff* Buff )
	{
	...
	void CFIntRamSecGrpMembTable::deleteSecGrpMemb( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSecGrpMembBuff* Buff )
	{
	...
	void CFIntRamSecGrpMembTable::deleteSecGrpMembByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSecGrpMembTable::deleteSecGrpMembByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId )
	{
		cfsec::CFSecSecGrpMembByClusterIdxKey key;
		key.setRequiredClusterId( argClusterId );
	...
	void CFIntRamSecGrpMembTable::deleteSecGrpMembByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
	...
	void CFIntRamSecGrpMembTable::deleteSecGrpMembByUserIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSecGrpMembTable::deleteSecGrpMembByUUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
			const int32_t argSecGroupId,
			const uuid_ptr_t argSecUserId )
	{
	...
	void CFIntRamSecGrpMembTable::releasePreparedStatements() {
	}
