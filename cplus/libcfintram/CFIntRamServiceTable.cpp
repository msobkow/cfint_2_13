...
namespace cfint {
	...
	const std::string CFIntRamServiceTable::CLASS_NAME( "CFIntRamServiceTable" );

	CFIntRamServiceTable::CFIntRamServiceTable( ICFIntSchema* argSchema )
	...
	CFIntRamServiceTable::~CFIntRamServiceTable() {
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::createService( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecServiceBuff* Buff )
	{
		static const std::string S_ProcName( "createService" );
		cfsec::CFSecServicePKey pkey;
		pkey.setRequiredClusterId( Buff->getRequiredClusterId() );
		pkey.setRequiredServiceId( dynamic_cast<CFIntRamClusterTable*>( schema->getTableCluster() )->nextServiceIdGen( Authorization,
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecServicePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readDerivedByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readDerivedByHostIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readDerivedByTypeIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readDerivedByUTypeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t HostNodeId,
			const int32_t ServiceTypeId )
	{
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readDerivedByUHostPortIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t HostNodeId,
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecServicePKey* PKey )
	{
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecServicePKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t ServiceId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readBuffByHostIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t HostNodeId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::readBuffByTypeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int32_t ServiceTypeId )
	{
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readBuffByUTypeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t HostNodeId,
			const int32_t ServiceTypeId )
	{
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::readBuffByUHostPortIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t HostNodeId,
			const int16_t HostPort )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::pageBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t* priorClusterId,
			const int64_t* priorServiceId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::pageBuffByHostIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId,
			const int64_t HostNodeId,
			const int64_t* priorClusterId,
			const int64_t* priorServiceId )
	...
	std::TCFLibOwningVector<cfsec::CFSecServiceBuff*> CFIntRamServiceTable::pageBuffByTypeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int32_t ServiceTypeId,
			const int64_t* priorClusterId,
			const int64_t* priorServiceId )
	{
	...
	cfsec::CFSecServiceBuff* CFIntRamServiceTable::updateService( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecServiceBuff* Buff )
	{
	...
	void CFIntRamServiceTable::deleteService( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecServiceBuff* Buff )
	{
	...
	void CFIntRamServiceTable::deleteServiceByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamServiceTable::deleteServiceByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId )
	{
		cfsec::CFSecServiceByClusterIdxKey key;
		key.setRequiredClusterId( argClusterId );
	...
	void CFIntRamServiceTable::deleteServiceByHostIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
	...
	void CFIntRamServiceTable::deleteServiceByTypeIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamServiceTable::deleteServiceByUTypeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
			const int64_t argHostNodeId,
			const int32_t argServiceTypeId )
	{
	...
	void CFIntRamServiceTable::deleteServiceByUHostPortIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argClusterId,
			const int64_t argHostNodeId,
	...
	void CFIntRamServiceTable::releasePreparedStatements() {
	}
