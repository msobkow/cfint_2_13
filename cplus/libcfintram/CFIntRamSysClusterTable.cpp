...
namespace cfint {
	...
	const std::string CFIntRamSysClusterTable::CLASS_NAME( "CFIntRamSysClusterTable" );

	CFIntRamSysClusterTable::CFIntRamSysClusterTable( ICFIntSchema* argSchema )
	...
	CFIntRamSysClusterTable::~CFIntRamSysClusterTable() {
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::createSysCluster( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSysClusterPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSysClusterBuff*> CFIntRamSysClusterTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecSysClusterBuff*> CFIntRamSysClusterTable::readDerivedByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSysClusterPKey* PKey )
	{
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecSysClusterPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSysClusterBuff*> CFIntRamSysClusterTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int32_t SingletonId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecSysClusterBuff*> CFIntRamSysClusterTable::readBuffByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t ClusterId )
	{
	...
	cfsec::CFSecSysClusterBuff* CFIntRamSysClusterTable::updateSysCluster( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSysClusterBuff* Buff )
	{
	...
	void CFIntRamSysClusterTable::deleteSysCluster( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecSysClusterBuff* Buff )
	{
	...
	void CFIntRamSysClusterTable::deleteSysClusterByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSysClusterTable::deleteSysClusterByClusterIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamSysClusterTable::releasePreparedStatements() {
	}
