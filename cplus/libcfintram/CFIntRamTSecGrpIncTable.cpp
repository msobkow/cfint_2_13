...
namespace cfint {
	...
	const std::string CFIntRamTSecGrpIncTable::CLASS_NAME( "CFIntRamTSecGrpIncTable" );

	CFIntRamTSecGrpIncTable::CFIntRamTSecGrpIncTable( ICFIntSchema* argSchema )
	...
	CFIntRamTSecGrpIncTable::~CFIntRamTSecGrpIncTable() {
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::createTSecGrpInc( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecTSecGrpIncBuff* Buff )
	{
		static const std::string S_ProcName( "createTSecGrpInc" );
		cfsec::CFSecTSecGrpIncPKey pkey;
		pkey.setRequiredTenantId( Buff->getRequiredTenantId() );
		pkey.setRequiredTSecGrpIncId( dynamic_cast<CFIntRamTenantTable*>( schema->getTableTenant() )->nextTSecGrpIncIdGen( Authorization,
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecTSecGrpIncPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readDerivedByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readDerivedByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readDerivedByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::readDerivedByUIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId,
			const int32_t IncludeGroupId )
	{
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecTSecGrpIncPKey* PKey )
	{
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecTSecGrpIncPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TSecGrpIncId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readBuffByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::readBuffByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t IncludeGroupId )
	{
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::readBuffByUIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId,
			const int32_t IncludeGroupId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::pageBuffByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t* priorTenantId,
			const int64_t* priorTSecGrpIncId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::pageBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId,
			const int64_t* priorTenantId,
			const int64_t* priorTSecGrpIncId )
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpIncBuff*> CFIntRamTSecGrpIncTable::pageBuffByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t IncludeGroupId,
			const int64_t* priorTenantId,
			const int64_t* priorTSecGrpIncId )
	...
	cfsec::CFSecTSecGrpIncBuff* CFIntRamTSecGrpIncTable::updateTSecGrpInc( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecTSecGrpIncBuff* Buff )
	{
	...
	void CFIntRamTSecGrpIncTable::deleteTSecGrpInc( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecTSecGrpIncBuff* Buff )
	{
	...
	void CFIntRamTSecGrpIncTable::deleteTSecGrpIncByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamTSecGrpIncTable::deleteTSecGrpIncByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
		cfsec::CFSecTSecGrpIncByTenantIdxKey key;
		key.setRequiredTenantId( argTenantId );
	...
	void CFIntRamTSecGrpIncTable::deleteTSecGrpIncByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFIntRamTSecGrpIncTable::deleteTSecGrpIncByIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFIntRamTSecGrpIncTable::deleteTSecGrpIncByUIncludeIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int32_t argTSecGroupId,
			const int32_t argIncludeGroupId )
	{
	...
	void CFIntRamTSecGrpIncTable::releasePreparedStatements() {
	}
