...
namespace cfint {
	...
	const std::string CFIntRamTSecGrpMembTable::CLASS_NAME( "CFIntRamTSecGrpMembTable" );

	CFIntRamTSecGrpMembTable::CFIntRamTSecGrpMembTable( ICFIntSchema* argSchema )
	...
	CFIntRamTSecGrpMembTable::~CFIntRamTSecGrpMembTable() {
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::createTSecGrpMemb( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecTSecGrpMembBuff* Buff )
	{
		...
		pkey.setRequiredTSecGrpMembId( dynamic_cast<CFIntRamTenantTable*>( schema->getTableTenant() )->nextTSecGrpMembIdGen( Authorization,
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::readDerived( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::lockDerived( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecTSecGrpMembPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readAllDerived( const cfsec::CFSecAuthorization* Authorization ) {
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readDerivedByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readDerivedByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readDerivedByUserIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::readDerivedByUUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId,
			const uuid_ptr_t SecUserId )
	{
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::readDerivedByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::readBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecTSecGrpMembPKey* PKey )
	{
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::lockBuff( const cfsec::CFSecAuthorization* Authorization,
		const cfsec::CFSecTSecGrpMembPKey* PKey )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readAllBuff( const cfsec::CFSecAuthorization* Authorization )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::pageAllBuff( const cfsec::CFSecAuthorization* Authorization,
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::readBuffByIdIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t TSecGrpMembId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readBuffByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::readBuffByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId )
	{
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::readBuffByUUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId,
			const uuid_ptr_t SecUserId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::pageBuffByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int64_t* priorTenantId,
			const int64_t* priorTSecGrpMembId )
	{
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::pageBuffByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t TenantId,
			const int32_t TSecGroupId,
			const int64_t* priorTenantId,
			const int64_t* priorTSecGrpMembId )
	...
	std::TCFLibOwningVector<cfsec::CFSecTSecGrpMembBuff*> CFIntRamTSecGrpMembTable::pageBuffByUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const uuid_ptr_t SecUserId,
			const int64_t* priorTenantId,
			const int64_t* priorTSecGrpMembId )
	{
	...
	cfsec::CFSecTSecGrpMembBuff* CFIntRamTSecGrpMembTable::updateTSecGrpMemb( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecTSecGrpMembBuff* Buff )
	{
	...
	void CFIntRamTSecGrpMembTable::deleteTSecGrpMemb( const cfsec::CFSecAuthorization* Authorization,
		cfsec::CFSecTSecGrpMembBuff* Buff )
	{
	...
	void CFIntRamTSecGrpMembTable::deleteTSecGrpMembByIdIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamTSecGrpMembTable::deleteTSecGrpMembByTenantIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId )
	{
		cfsec::CFSecTSecGrpMembByTenantIdxKey key;
		key.setRequiredTenantId( argTenantId );
	...
	void CFIntRamTSecGrpMembTable::deleteTSecGrpMembByGroupIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
	...
	void CFIntRamTSecGrpMembTable::deleteTSecGrpMembByUserIdx( const cfsec::CFSecAuthorization* Authorization,
	...
	void CFIntRamTSecGrpMembTable::deleteTSecGrpMembByUUserIdx( const cfsec::CFSecAuthorization* Authorization,
			const int64_t argTenantId,
			const int32_t argTSecGroupId,
			const uuid_ptr_t argSecUserId )
	{
	...
	void CFIntRamTSecGrpMembTable::releasePreparedStatements() {
	}
