...
namespace cfint {
	...
	protected:
		...
		std::map<cfint::CFIntRamClusterId32Gen, cfint::CFIntRamClusterId32Gen*>* id32Generator;
		std::map<cfint::CFIntRamClusterId64Gen, cfint::CFIntRamClusterId64Gen*>* id64Generator;
	...
	public:
		...
		CFIntRamClusterTable( cfint::ICFIntSchema* argSchema );

		virtual ~CFIntRamClusterTable();
