...
namespace cfint {
	...
	size_t hashCode() const;
		...
		bool operator <( const cfint::CFIntRamTenantId32Gen& rhs );
		...
		bool operator >( const cfint::CFIntRamTenantId32Gen& rhs );
		CFIntRamTenantId32Gen operator =( CFIntRamTenantId32Gen& src );
...
namespace std {
	...
	template<> struct hash<cfint::CFIntRamTenantId32Gen> {
		typedef cfint::CFIntRamTenantId32Gen argument_type;
