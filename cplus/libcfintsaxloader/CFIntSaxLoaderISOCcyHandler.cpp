...
namespace cfint {
	...
	const std::string CFIntSaxLoaderISOCcyHandler::CLASS_NAME( "CFIntSaxLoaderISOCcyHandler" );
	const std::string CFIntSaxLoaderISOCcyHandler::S_True( "true" );
	const std::string CFIntSaxLoaderISOCcyHandler::S_False( "false" );
	const std::string CFIntSaxLoaderISOCcyHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderISOCcyHandler::S_No( "no" );
	const std::string CFIntSaxLoaderISOCcyHandler::S_0( "0" );
	const std::string CFIntSaxLoaderISOCcyHandler::S_1( "1" );

	CFIntSaxLoaderISOCcyHandler::CFIntSaxLoaderISOCcyHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderISOCcyHandler::~CFIntSaxLoaderISOCcyHandler() {
	}

	void CFIntSaxLoaderISOCcyHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderISOCcyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
