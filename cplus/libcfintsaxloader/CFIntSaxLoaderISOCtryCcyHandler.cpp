...
namespace cfint {
	...
	const std::string CFIntSaxLoaderISOCtryCcyHandler::CLASS_NAME( "CFIntSaxLoaderISOCtryCcyHandler" );
	const std::string CFIntSaxLoaderISOCtryCcyHandler::S_True( "true" );
	const std::string CFIntSaxLoaderISOCtryCcyHandler::S_False( "false" );
	const std::string CFIntSaxLoaderISOCtryCcyHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderISOCtryCcyHandler::S_No( "no" );
	const std::string CFIntSaxLoaderISOCtryCcyHandler::S_0( "0" );
	const std::string CFIntSaxLoaderISOCtryCcyHandler::S_1( "1" );

	CFIntSaxLoaderISOCtryCcyHandler::CFIntSaxLoaderISOCtryCcyHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderISOCtryCcyHandler::~CFIntSaxLoaderISOCtryCcyHandler() {
	}

	void CFIntSaxLoaderISOCtryCcyHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderISOCtryCcyHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
