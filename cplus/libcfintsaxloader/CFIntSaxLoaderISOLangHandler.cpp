...
namespace cfint {
	...
	const std::string CFIntSaxLoaderISOLangHandler::CLASS_NAME( "CFIntSaxLoaderISOLangHandler" );
	const std::string CFIntSaxLoaderISOLangHandler::S_True( "true" );
	const std::string CFIntSaxLoaderISOLangHandler::S_False( "false" );
	const std::string CFIntSaxLoaderISOLangHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderISOLangHandler::S_No( "no" );
	const std::string CFIntSaxLoaderISOLangHandler::S_0( "0" );
	const std::string CFIntSaxLoaderISOLangHandler::S_1( "1" );

	CFIntSaxLoaderISOLangHandler::CFIntSaxLoaderISOLangHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderISOLangHandler::~CFIntSaxLoaderISOLangHandler() {
	}

	void CFIntSaxLoaderISOLangHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderISOLangHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
