...
namespace cfint {
	...
	const std::string CFIntSaxLoaderISOTZoneHandler::CLASS_NAME( "CFIntSaxLoaderISOTZoneHandler" );
	const std::string CFIntSaxLoaderISOTZoneHandler::S_True( "true" );
	const std::string CFIntSaxLoaderISOTZoneHandler::S_False( "false" );
	const std::string CFIntSaxLoaderISOTZoneHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderISOTZoneHandler::S_No( "no" );
	const std::string CFIntSaxLoaderISOTZoneHandler::S_0( "0" );
	const std::string CFIntSaxLoaderISOTZoneHandler::S_1( "1" );

	CFIntSaxLoaderISOTZoneHandler::CFIntSaxLoaderISOTZoneHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderISOTZoneHandler::~CFIntSaxLoaderISOTZoneHandler() {
	}

	void CFIntSaxLoaderISOTZoneHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderISOTZoneHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
