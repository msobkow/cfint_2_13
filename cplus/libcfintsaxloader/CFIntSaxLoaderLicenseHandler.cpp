...
namespace cfint {
	...
	const std::string CFIntSaxLoaderLicenseHandler::CLASS_NAME( "CFIntSaxLoaderLicenseHandler" );
	const std::string CFIntSaxLoaderLicenseHandler::S_True( "true" );
	const std::string CFIntSaxLoaderLicenseHandler::S_False( "false" );
	const std::string CFIntSaxLoaderLicenseHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderLicenseHandler::S_No( "no" );
	const std::string CFIntSaxLoaderLicenseHandler::S_0( "0" );
	const std::string CFIntSaxLoaderLicenseHandler::S_1( "1" );

	CFIntSaxLoaderLicenseHandler::CFIntSaxLoaderLicenseHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderLicenseHandler::~CFIntSaxLoaderLicenseHandler() {
	}

	void CFIntSaxLoaderLicenseHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderLicenseHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
