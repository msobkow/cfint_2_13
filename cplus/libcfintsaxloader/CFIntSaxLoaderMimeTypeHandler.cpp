...
namespace cfint {
	...
	const std::string CFIntSaxLoaderMimeTypeHandler::CLASS_NAME( "CFIntSaxLoaderMimeTypeHandler" );
	const std::string CFIntSaxLoaderMimeTypeHandler::S_True( "true" );
	const std::string CFIntSaxLoaderMimeTypeHandler::S_False( "false" );
	const std::string CFIntSaxLoaderMimeTypeHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderMimeTypeHandler::S_No( "no" );
	const std::string CFIntSaxLoaderMimeTypeHandler::S_0( "0" );
	const std::string CFIntSaxLoaderMimeTypeHandler::S_1( "1" );

	CFIntSaxLoaderMimeTypeHandler::CFIntSaxLoaderMimeTypeHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderMimeTypeHandler::~CFIntSaxLoaderMimeTypeHandler() {
	}

	void CFIntSaxLoaderMimeTypeHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderMimeTypeHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
