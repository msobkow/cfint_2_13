...
namespace cfint {
	...
	const std::string CFIntSaxLoaderSecAppHandler::CLASS_NAME( "CFIntSaxLoaderSecAppHandler" );
	const std::string CFIntSaxLoaderSecAppHandler::S_True( "true" );
	const std::string CFIntSaxLoaderSecAppHandler::S_False( "false" );
	const std::string CFIntSaxLoaderSecAppHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderSecAppHandler::S_No( "no" );
	const std::string CFIntSaxLoaderSecAppHandler::S_0( "0" );
	const std::string CFIntSaxLoaderSecAppHandler::S_1( "1" );

	CFIntSaxLoaderSecAppHandler::CFIntSaxLoaderSecAppHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderSecAppHandler::~CFIntSaxLoaderSecAppHandler() {
	}

	void CFIntSaxLoaderSecAppHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderSecAppHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
