...
namespace cfint {
	...
	const std::string CFIntSaxLoaderSecDeviceHandler::CLASS_NAME( "CFIntSaxLoaderSecDeviceHandler" );
	const std::string CFIntSaxLoaderSecDeviceHandler::S_True( "true" );
	const std::string CFIntSaxLoaderSecDeviceHandler::S_False( "false" );
	const std::string CFIntSaxLoaderSecDeviceHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderSecDeviceHandler::S_No( "no" );
	const std::string CFIntSaxLoaderSecDeviceHandler::S_0( "0" );
	const std::string CFIntSaxLoaderSecDeviceHandler::S_1( "1" );

	CFIntSaxLoaderSecDeviceHandler::CFIntSaxLoaderSecDeviceHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderSecDeviceHandler::~CFIntSaxLoaderSecDeviceHandler() {
	}

	void CFIntSaxLoaderSecDeviceHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderSecDeviceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
