...
namespace cfint {
	...
	const std::string CFIntSaxLoaderSecFormHandler::CLASS_NAME( "CFIntSaxLoaderSecFormHandler" );
	const std::string CFIntSaxLoaderSecFormHandler::S_True( "true" );
	const std::string CFIntSaxLoaderSecFormHandler::S_False( "false" );
	const std::string CFIntSaxLoaderSecFormHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderSecFormHandler::S_No( "no" );
	const std::string CFIntSaxLoaderSecFormHandler::S_0( "0" );
	const std::string CFIntSaxLoaderSecFormHandler::S_1( "1" );

	CFIntSaxLoaderSecFormHandler::CFIntSaxLoaderSecFormHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderSecFormHandler::~CFIntSaxLoaderSecFormHandler() {
	}

	void CFIntSaxLoaderSecFormHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderSecFormHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
