...
namespace cfint {
	...
	const std::string CFIntSaxLoaderSecSessionHandler::CLASS_NAME( "CFIntSaxLoaderSecSessionHandler" );
	const std::string CFIntSaxLoaderSecSessionHandler::S_True( "true" );
	const std::string CFIntSaxLoaderSecSessionHandler::S_False( "false" );
	const std::string CFIntSaxLoaderSecSessionHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderSecSessionHandler::S_No( "no" );
	const std::string CFIntSaxLoaderSecSessionHandler::S_0( "0" );
	const std::string CFIntSaxLoaderSecSessionHandler::S_1( "1" );

	CFIntSaxLoaderSecSessionHandler::CFIntSaxLoaderSecSessionHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderSecSessionHandler::~CFIntSaxLoaderSecSessionHandler() {
	}

	void CFIntSaxLoaderSecSessionHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderSecSessionHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
