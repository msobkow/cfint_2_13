...
namespace cfint {
	...
	const std::string CFIntSaxLoaderServiceHandler::CLASS_NAME( "CFIntSaxLoaderServiceHandler" );
	const std::string CFIntSaxLoaderServiceHandler::S_True( "true" );
	const std::string CFIntSaxLoaderServiceHandler::S_False( "false" );
	const std::string CFIntSaxLoaderServiceHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderServiceHandler::S_No( "no" );
	const std::string CFIntSaxLoaderServiceHandler::S_0( "0" );
	const std::string CFIntSaxLoaderServiceHandler::S_1( "1" );

	CFIntSaxLoaderServiceHandler::CFIntSaxLoaderServiceHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderServiceHandler::~CFIntSaxLoaderServiceHandler() {
	}

	void CFIntSaxLoaderServiceHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderServiceHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
