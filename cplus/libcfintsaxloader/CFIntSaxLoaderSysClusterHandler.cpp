...
namespace cfint {
	...
	const std::string CFIntSaxLoaderSysClusterHandler::CLASS_NAME( "CFIntSaxLoaderSysClusterHandler" );
	const std::string CFIntSaxLoaderSysClusterHandler::S_True( "true" );
	const std::string CFIntSaxLoaderSysClusterHandler::S_False( "false" );
	const std::string CFIntSaxLoaderSysClusterHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderSysClusterHandler::S_No( "no" );
	const std::string CFIntSaxLoaderSysClusterHandler::S_0( "0" );
	const std::string CFIntSaxLoaderSysClusterHandler::S_1( "1" );

	CFIntSaxLoaderSysClusterHandler::CFIntSaxLoaderSysClusterHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderSysClusterHandler::~CFIntSaxLoaderSysClusterHandler() {
	}

	void CFIntSaxLoaderSysClusterHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderSysClusterHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
