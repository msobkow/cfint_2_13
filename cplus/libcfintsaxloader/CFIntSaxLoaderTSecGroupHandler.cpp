...
namespace cfint {
	...
	const std::string CFIntSaxLoaderTSecGroupHandler::CLASS_NAME( "CFIntSaxLoaderTSecGroupHandler" );
	const std::string CFIntSaxLoaderTSecGroupHandler::S_True( "true" );
	const std::string CFIntSaxLoaderTSecGroupHandler::S_False( "false" );
	const std::string CFIntSaxLoaderTSecGroupHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderTSecGroupHandler::S_No( "no" );
	const std::string CFIntSaxLoaderTSecGroupHandler::S_0( "0" );
	const std::string CFIntSaxLoaderTSecGroupHandler::S_1( "1" );

	CFIntSaxLoaderTSecGroupHandler::CFIntSaxLoaderTSecGroupHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderTSecGroupHandler::~CFIntSaxLoaderTSecGroupHandler() {
	}

	void CFIntSaxLoaderTSecGroupHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderTSecGroupHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
