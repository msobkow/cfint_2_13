...
namespace cfint {
	...
	const std::string CFIntSaxLoaderTSecGrpMembHandler::CLASS_NAME( "CFIntSaxLoaderTSecGrpMembHandler" );
	const std::string CFIntSaxLoaderTSecGrpMembHandler::S_True( "true" );
	const std::string CFIntSaxLoaderTSecGrpMembHandler::S_False( "false" );
	const std::string CFIntSaxLoaderTSecGrpMembHandler::S_Yes( "yes" );
	const std::string CFIntSaxLoaderTSecGrpMembHandler::S_No( "no" );
	const std::string CFIntSaxLoaderTSecGrpMembHandler::S_0( "0" );
	const std::string CFIntSaxLoaderTSecGrpMembHandler::S_1( "1" );

	CFIntSaxLoaderTSecGrpMembHandler::CFIntSaxLoaderTSecGrpMembHandler( cfint::CFIntSaxLoader* saxLoader )
	: cflib::CFLibXmlCoreElementHandler( saxLoader )
	{
	}

	CFIntSaxLoaderTSecGrpMembHandler::~CFIntSaxLoaderTSecGrpMembHandler() {
	}

	void CFIntSaxLoaderTSecGrpMembHandler::startElement (
...
cleanup:
	...
	void CFIntSaxLoaderTSecGrpMembHandler::endElement(
		const XMLCh* const uri,
		const XMLCh* const localname,
		const XMLCh* const qname )
	{
