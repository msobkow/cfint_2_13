...
// Description: C++18 XML Command Line Interface common core specification for CFInt.
...
namespace cfint {
	...
	protected:
		...
		cfint::CFIntSaxLoader* saxLoader;
	...
	public:
		...
		CFIntSaxLdr( cflib::ICFLibMessageLog* messageLog );


		void setSaxLoader( cfint::CFIntSaxLoader* value );
		CFIntSaxLoader* getSaxLoader();
		...
		static void applyLoaderOptions( cfint::CFIntSaxLoader* loader, const std::string& loaderOptions );


		static void evalLoaderSegment( cfint::CFIntSaxLoader* loader, const std::string& evalSegment );
