...
// Description: C++18 XML SAX2 Element Handler specification for License
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderLicenseHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderLicenseHandler();
