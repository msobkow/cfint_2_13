...
// Description: C++18 XML SAX2 Element Handler specification for MajorVersion
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderMajorVersionHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderMajorVersionHandler();
