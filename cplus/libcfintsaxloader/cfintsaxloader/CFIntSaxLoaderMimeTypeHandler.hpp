...
// Description: C++18 XML SAX2 Element Handler specification for MimeType
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderMimeTypeHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderMimeTypeHandler();
