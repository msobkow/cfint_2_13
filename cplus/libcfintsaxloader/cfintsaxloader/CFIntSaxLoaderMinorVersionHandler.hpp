...
// Description: C++18 XML SAX2 Element Handler specification for MinorVersion
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderMinorVersionHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderMinorVersionHandler();
