...
// Description: C++18 XML SAX2 Element Handler specification for SubProject
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderSubProjectHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderSubProjectHandler();
