...
// Description: C++18 XML SAX2 Element Handler specification for Tld
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderTldHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderTldHandler();
