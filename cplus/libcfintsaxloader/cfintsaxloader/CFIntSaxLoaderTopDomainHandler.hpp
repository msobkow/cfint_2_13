...
// Description: C++18 XML SAX2 Element Handler specification for TopDomain
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderTopDomainHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderTopDomainHandler();
