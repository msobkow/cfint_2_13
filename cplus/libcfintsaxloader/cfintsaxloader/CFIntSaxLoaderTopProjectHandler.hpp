...
// Description: C++18 XML SAX2 Element Handler specification for TopProject
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderTopProjectHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderTopProjectHandler();
