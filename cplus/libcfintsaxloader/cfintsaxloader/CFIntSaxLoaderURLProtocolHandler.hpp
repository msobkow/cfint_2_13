...
// Description: C++18 XML SAX2 Element Handler specification for URLProtocol
...
namespace cfint {
	...
	public:
		...
		CFIntSaxLoaderURLProtocolHandler( cfint::CFIntSaxLoader* saxLoader );
		virtual ~CFIntSaxLoaderURLProtocolHandler();
