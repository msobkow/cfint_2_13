#!/bin/bash
#
#	@(#) dbcreate/cfint/db2luw/crrel_cfinet213.bash
#
...
echo "#	Running crrel_mjvrdef.sql ..."
db2 -l db2output.log -f crrel_mjvrdef.sql
echo "#	Running crrel_mimetype.sql ..."
db2 -l db2output.log -f crrel_mimetype.sql
echo "#	Running crrel_mnvrdef.sql ..."
db2 -l db2output.log -f crrel_mnvrdef.sql
