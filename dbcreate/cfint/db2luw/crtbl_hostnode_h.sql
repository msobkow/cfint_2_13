--
--	@(#) dbcreate/cfint/db2luw/crtbl_hostnode_h.sql
--
...
--
CREATE TABLE cfinet213.hostnode_h (	\
...
CREATE UNIQUE INDEX cfinet213.hostnode_h_ididx ON cfinet213.hostnode_h (	\
	auditclusterid,	\
	auditstamp,	\
	ClusterId,	\
	HostNodeId,	\
...
ALTER TABLE cfinet213.hostnode_h	\
