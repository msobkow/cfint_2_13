--
--	@(#) dbcreate/cfint/db2luw/crtbl_iso_lang_h.sql
--
...
--
CREATE TABLE cfinet213.iso_lang_h (	\
...
CREATE UNIQUE INDEX cfinet213.iso_lang_h_ididx ON cfinet213.iso_lang_h (	\
	auditclusterid,	\
	auditstamp,	\
	ISOLangId,	\
	auditaction,	\
...
ALTER TABLE cfinet213.iso_lang_h	\
