--
--	@(#) dbcreate/cfint/db2luw/crtbl_isotz_h.sql
--
...
--
CREATE TABLE cfinet213.isotz_h (	\
...
CREATE UNIQUE INDEX cfinet213.isotz_h_ididx ON cfinet213.isotz_h (	\
	auditclusterid,	\
	auditstamp,	\
	ISOTZoneId,	\
	auditaction,	\
