--
--	@(#) dbcreate/cfint/db2luw/crtbl_mnvrdef_h.sql
--
...
CREATE UNIQUE INDEX cfinet213.mnvrdef_h_ididx ON cfinet213.mnvrdef_h (	\
	auditclusterid,	\
	auditstamp,	\
	TenantId,	\
	Id,	\
...
ALTER TABLE cfinet213.mnvrdef_h	\
	ADD CONSTRAINT pk_mnvrdef_pk_h PRIMARY KEY (	\
	auditclusterid,	\
