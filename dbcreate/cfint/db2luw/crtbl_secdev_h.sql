--
--	@(#) dbcreate/cfint/db2luw/crtbl_secdev_h.sql
--
...
--
CREATE TABLE cfinet213.secdev_h (	\
...
CREATE UNIQUE INDEX cfinet213.secdev_h_ididx ON cfinet213.secdev_h (	\
	auditclusterid,	\
	auditstamp,	\
	SecUserId,	\
	DevName,	\
...
ALTER TABLE cfinet213.secdev_h	\
