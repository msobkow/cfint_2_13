--
--	@(#) dbcreate/cfint/db2luw/crtbl_secuser_h.sql
--
...
--
CREATE TABLE cfinet213.secuser_h (	\
...
CREATE UNIQUE INDEX cfinet213.secuser_h_ididx ON cfinet213.secuser_h (	\
	auditclusterid,	\
	auditstamp,	\
	SecUserId,	\
	auditaction,	\
...
ALTER TABLE cfinet213.secuser_h	\
