...
bash shell integration to install a CFINet213 database.

You must be logged in as the schema administrator cfinet213
...
crtbl_tprjdef.sql
crtbl_urlproto.sql
	The individual table creation scripts called by crtbl_cfinet213.sql.
...
cridx_mjvrdef_xtenant.sql
cridx_mjvrdef_xsprj.sql
cridx_mjvrdef_unameidx.sql
cridx_mimetype_xuname.sql
cridx_mnvrdef_xtenant.sql
cridx_mnvrdef_xmjvr.sql
cridx_mnvrdef_unameidx.sql
...
cridx_sprjdef_xtenant.sql
cridx_sprjdef_xtprj.sql
...
cridx_tlddef_xtenant.sql
cridx_tlddef_unameidx.sql
cridx_tdomdef_xtenant.sql
cridx_tdomdef_xtld.sql
cridx_tdomdef_unameidx.sql
cridx_tprjdef_xtenant.sql
cridx_tprjdef_xsdom.sql
cridx_tprjdef_unameidx.sql
cridx_urlproto_xuname.sql
cridx_urlproto_xsecure.sql
	The individual table index creation scripts called by cridx_cfinet213.sql.
