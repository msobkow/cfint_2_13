...
%cmddb% <cridx_lic_xtdom.tsql >>%logfilename%
%cmddb% <cridx_lic_xuname.tsql >>%logfilename%
%cmddb% <cridx_mjvrdef_xtenant.tsql >>%logfilename%
%cmddb% <cridx_mjvrdef_xsprj.tsql >>%logfilename%
%cmddb% <cridx_mjvrdef_unameidx.tsql >>%logfilename%
%cmddb% <cridx_mimetype_xuname.tsql >>%logfilename%
%cmddb% <cridx_mnvrdef_xtenant.tsql >>%logfilename%
%cmddb% <cridx_mnvrdef_xmjvr.tsql >>%logfilename%
%cmddb% <cridx_mnvrdef_unameidx.tsql >>%logfilename%
...
%cmddb% <cridx_sprjdef_xtenant.tsql >>%logfilename%
%cmddb% <cridx_sprjdef_xtprj.tsql >>%logfilename%
...
%cmddb% <cridx_tlddef_xtenant.tsql >>%logfilename%
%cmddb% <cridx_tlddef_unameidx.tsql >>%logfilename%
%cmddb% <cridx_tdomdef_xtenant.tsql >>%logfilename%
%cmddb% <cridx_tdomdef_xtld.tsql >>%logfilename%
%cmddb% <cridx_tdomdef_unameidx.tsql >>%logfilename%
%cmddb% <cridx_tprjdef_xtenant.tsql >>%logfilename%
%cmddb% <cridx_tprjdef_xsdom.tsql >>%logfilename%
