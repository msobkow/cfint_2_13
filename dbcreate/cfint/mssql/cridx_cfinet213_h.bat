@ECHO OFF
REM	@(#) dbcreate/cfint/mssql/cridx_cfinet213_h.bat
REM
...
%cmddb% <cridx_mjvrdef_h_tenantidx.tsql >>%logfilename%
%cmddb% <cridx_mjvrdef_h_subprojectidx.tsql >>%logfilename%
%cmddb% <cridx_mjvrdef_h_nameidx.tsql >>%logfilename%
%cmddb% <cridx_mimetype_h_unameidx.tsql >>%logfilename%
%cmddb% <cridx_mnvrdef_h_tenantidx.tsql >>%logfilename%
%cmddb% <cridx_mnvrdef_h_majorveridx.tsql >>%logfilename%
%cmddb% <cridx_mnvrdef_h_nameidx.tsql >>%logfilename%
...
%cmddb% <cridx_sprjdef_h_topprojectidx.tsql >>%logfilename%
...
%cmddb% <cridx_tprjdef_h_topdomainidx.tsql >>%logfilename%
