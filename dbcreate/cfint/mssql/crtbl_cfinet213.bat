@ECHO OFF
REM	@(#) dbcreate/cfint/mssql/crtbl_cfinet213.bat
REM
...
%cmddb% <crtbl_cfinet213_idg16.tsql >>%logfilename%
%cmddb% <crtbl_cfinet213_idg32.tsql >>%logfilename%
%cmddb% <crtbl_cfinet213_idg64.tsql >>%logfilename%
...
%cmddb% <crtbl_mjvrdef.tsql >>%logfilename%
%cmddb% <crtbl_mimetype.tsql >>%logfilename%
%cmddb% <crtbl_mnvrdef.tsql >>%logfilename%
...
%cmddb% <crtbl_mjvrdef_h.tsql >>%logfilename%
%cmddb% <crtbl_mimetype_h.tsql >>%logfilename%
%cmddb% <crtbl_mnvrdef_h.tsql >>%logfilename%
