...
crdatabase_cfinet213.tsql
	Creates the database "cfinet213" and the database owner
	login "cfinet213dba".  The initial password for the database
	owner is "cfinet213pwd" and should not be changed until after
	...
	Creating the database itself takes roughly two hours on my C300 Linux system.
		...
		drop database cfinet213
		go

		exec sp_droplogin cfinet213dba
		go
...
crtbl_tprjdef.tsql
crtbl_urlproto.tsql
	The individual table creation scripts called by crtbl_cfinet213.tsql.
...
cridx_lic_xtdom.tsql
cridx_lic_xuname.tsql
cridx_mjvrdef_xtenant.tsql
cridx_mjvrdef_xsprj.tsql
cridx_mjvrdef_unameidx.tsql
cridx_mimetype_xuname.tsql
cridx_mnvrdef_xtenant.tsql
cridx_mnvrdef_xmjvr.tsql
cridx_mnvrdef_unameidx.tsql
...
cridx_sprjdef_xtenant.tsql
cridx_sprjdef_xtprj.tsql
...
cridx_tlddef_xtenant.tsql
cridx_tlddef_unameidx.tsql
cridx_tdomdef_xtenant.tsql
cridx_tdomdef_xtld.tsql
cridx_tdomdef_unameidx.tsql
cridx_tprjdef_xtenant.tsql
cridx_tprjdef_xsdom.tsql
cridx_tprjdef_unameidx.tsql
cridx_urlproto_xuname.tsql
cridx_urlproto_xsecure.tsql
	The individual table index creation scripts called by cridx_cfinet213.tsql.
...
crsp_next_urlprotocolidgen.tsql
...
crsp_next_tenant_majorversionidgen.tsql
crsp_next_tenant_minorversionidgen.tsql
crsp_next_tenant_subprojectidgen.tsql
crsp_next_tenant_tldidgen.tsql
crsp_next_tenant_topdomainidgen.tsql
crsp_next_tenant_topprojectidgen.tsql
...
dridg_cfinet213.tsql
	Drops the database id generator objects.

drtbl_cfinet213.tsql
	Drops the database tables.

dridx_cfinet213.tsql
	Drops the database table indexes.

drrel_cfinet213.tsql
