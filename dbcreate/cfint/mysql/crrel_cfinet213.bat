@echo off
REM
REM	@(#) dbcreate/cfint/mysql/crrel_cfinet213.bat
REM
...
echo crrel_mjvrdef.mysql >>%logfilename%
mysql -v -u %mysqluser% --password=%mysqlpwd% < crrel_mjvrdef.mysql >>%logfilename% 2>&1
echo crrel_mimetype.mysql >>%logfilename%
mysql -v -u %mysqluser% --password=%mysqlpwd% < crrel_mimetype.mysql >>%logfilename% 2>&1
echo crrel_mnvrdef.mysql >>%logfilename%
mysql -v -u %mysqluser% --password=%mysqlpwd% < crrel_mnvrdef.mysql >>%logfilename% 2>&1
