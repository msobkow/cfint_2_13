--
--	@(#) dbcreate/cfint/oracle/crcrt_hostnode.plsql
--
...
create or replace procedure cfinet213.crt_hostnode(
...
begin
	...
	argHostNodeId := cfinet213.nxt_hostnodeidgen( argClusterId );
	insert into cfinet213.hostnode(
		createdby,
		createdat,
		updatedby,
		updatedat,
...
show errors procedure cfinet213.crt_hostnode;
