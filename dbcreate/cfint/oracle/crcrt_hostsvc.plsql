--
--	@(#) dbcreate/cfint/oracle/crcrt_hostsvc.plsql
--
...
create or replace procedure cfinet213.crt_hostsvc(
...
begin
	...
	argServiceId := cfinet213.nxt_serviceidgen( argClusterId );
...
show errors procedure cfinet213.crt_hostsvc;
