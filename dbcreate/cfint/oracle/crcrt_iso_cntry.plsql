--
--	@(#) dbcreate/cfint/oracle/crcrt_iso_cntry.plsql
--
...
create or replace procedure cfinet213.crt_iso_cntry(
...
begin
	...
	argISOCtryId := cfinet213.nxt_isoctryidgen();
...
show errors procedure cfinet213.crt_iso_cntry;
