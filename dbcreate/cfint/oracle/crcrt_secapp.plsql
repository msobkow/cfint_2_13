--
--	@(#) dbcreate/cfint/oracle/crcrt_secapp.plsql
--
...
create or replace procedure cfinet213.crt_secapp(
...
begin
	...
	argSecAppId := cfinet213.nxt_secappidgen( argClusterId );
	insert into cfinet213.secapp(
		createdby,
		createdat,
		updatedby,
		updatedat,
...
show errors procedure cfinet213.crt_secapp;
