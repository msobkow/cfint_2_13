--
--	@(#) dbcreate/cfint/oracle/crcrt_secinc.plsql
--
...
create or replace procedure cfinet213.crt_secinc(
...
begin
	...
	argSecGrpIncId := cfinet213.nxt_secgrpincidgen( argClusId );
...
show errors procedure cfinet213.crt_secinc;
