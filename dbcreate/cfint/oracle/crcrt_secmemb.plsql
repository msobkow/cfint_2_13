--
--	@(#) dbcreate/cfint/oracle/crcrt_secmemb.plsql
--
...
create or replace procedure cfinet213.crt_secmemb(
...
is
	...
	use_stamp cfinet213.SecMemb_h.auditstamp%type;
...
begin
	...
	argSecGrpMembId := cfinet213.nxt_secgrpmembidgen( argClusterId );
...
show errors procedure cfinet213.crt_secmemb;
