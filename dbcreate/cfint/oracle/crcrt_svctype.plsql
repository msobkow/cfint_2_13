--
--	@(#) dbcreate/cfint/oracle/crcrt_svctype.plsql
--
...
create or replace procedure cfinet213.crt_svctype(
...
is
	...
	use_stamp cfinet213.SvcType_h.auditstamp%type;
...
begin
	...
	argServiceTypeId := cfinet213.nxt_servicetypeidgen();
	insert into cfinet213.svctype(
		createdby,
		createdat,
		updatedby,
		updatedat,
...
show errors procedure cfinet213.crt_svctype;
