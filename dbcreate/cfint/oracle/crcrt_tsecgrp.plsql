--
--	@(#) dbcreate/cfint/oracle/crcrt_tsecgrp.plsql
--
...
create or replace procedure cfinet213.crt_tsecgrp(
...
begin
	...
	argTSecGroupId := cfinet213.nxt_tsecgroupidgen( argTenantId );
...
show errors procedure cfinet213.crt_tsecgrp;
