--
--	@(#) dbcreate/cfint/oracle/crcrt_tsecinc.plsql
--
...
create or replace procedure cfinet213.crt_tsecinc(
...
begin
	...
	argTSecGrpIncId := cfinet213.nxt_tsecgrpincidgen( argTenantId );
...
show errors procedure cfinet213.crt_tsecinc;
