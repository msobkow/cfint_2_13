--
--	@(#) dbcreate/cfint/oracle/crdl_clus.plsql
--
...
create or replace procedure cfinet213.dl_clus(
...
begin
	...
	loop
		cfinet213.dl_secgrpfrmbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_secincbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_secgrpbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_secappbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_tenantbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_hostnodebyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
...
show errors procedure cfinet213.dl_clus;
