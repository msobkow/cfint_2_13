--
--	@(#) dbcreate/cfint/oracle/crdl_hostnodebyclusteridx.plsql
--
...
create or replace procedure cfinet213.dl_hostnodebyclusteridx(
...
show errors procedure cfinet213.dl_hostnodebyclusteridx;
