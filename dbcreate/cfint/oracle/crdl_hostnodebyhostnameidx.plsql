--
--	@(#) dbcreate/cfint/oracle/crdl_hostnodebyhostnameidx.plsql
--
...
create or replace procedure cfinet213.dl_hostnodebyhostnameidx(
...
show errors procedure cfinet213.dl_hostnodebyhostnameidx;
