--
--	@(#) dbcreate/cfint/oracle/crdl_hostnodebyudescridx.plsql
--
...
create or replace procedure cfinet213.dl_hostnodebyudescridx(
...
show errors procedure cfinet213.dl_hostnodebyudescridx;
