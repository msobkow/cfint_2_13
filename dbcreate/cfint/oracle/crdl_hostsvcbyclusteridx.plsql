--
--	@(#) dbcreate/cfint/oracle/crdl_hostsvcbyclusteridx.plsql
--
...
create or replace procedure cfinet213.dl_hostsvcbyclusteridx(
...
show errors procedure cfinet213.dl_hostsvcbyclusteridx;
