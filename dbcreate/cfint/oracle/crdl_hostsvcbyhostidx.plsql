--
--	@(#) dbcreate/cfint/oracle/crdl_hostsvcbyhostidx.plsql
--
...
create or replace procedure cfinet213.dl_hostsvcbyhostidx(
...
show errors procedure cfinet213.dl_hostsvcbyhostidx;
