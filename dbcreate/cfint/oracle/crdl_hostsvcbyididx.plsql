--
--	@(#) dbcreate/cfint/oracle/crdl_hostsvcbyididx.plsql
--
...
create or replace procedure cfinet213.dl_hostsvcbyididx(
...
show errors procedure cfinet213.dl_hostsvcbyididx;
