--
--	@(#) dbcreate/cfint/oracle/crdl_hostsvcbytypeidx.plsql
--
...
create or replace procedure cfinet213.dl_hostsvcbytypeidx(
...
show errors procedure cfinet213.dl_hostsvcbytypeidx;
