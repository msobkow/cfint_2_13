--
--	@(#) dbcreate/cfint/oracle/crdl_hostsvcbyuhostportidx.plsql
--
...
create or replace procedure cfinet213.dl_hostsvcbyuhostportidx(
...
begin
	...
	then
		...
		loop
			cfinet213.dl_hostsvc( argAuditClusterId,
					argAuditUserId,
					argAuditSessionId,
					secClusterId,
					secTenantId,
...
show errors procedure cfinet213.dl_hostsvcbyuhostportidx;
