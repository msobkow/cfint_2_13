--
--	@(#) dbcreate/cfint/oracle/crdl_hostsvcbyutypeidx.plsql
--
...
create or replace procedure cfinet213.dl_hostsvcbyutypeidx(
...
show errors procedure cfinet213.dl_hostsvcbyutypeidx;
