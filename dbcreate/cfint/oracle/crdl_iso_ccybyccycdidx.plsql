--
--	@(#) dbcreate/cfint/oracle/crdl_iso_ccybyccycdidx.plsql
--
...
create or replace procedure cfinet213.dl_iso_ccybyccycdidx(
...
show errors procedure cfinet213.dl_iso_ccybyccycdidx;
