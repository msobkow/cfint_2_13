--
--	@(#) dbcreate/cfint/oracle/crdl_iso_ccybyccynmidx.plsql
--
...
create or replace procedure cfinet213.dl_iso_ccybyccynmidx(
...
show errors procedure cfinet213.dl_iso_ccybyccynmidx;
