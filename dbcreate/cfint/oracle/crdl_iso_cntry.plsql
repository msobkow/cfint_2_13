--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntry.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntry(
...
is
	use_stamp cfinet213.iso_cntry_h.auditstamp%type;
	...
	cursor cursDelCtryLangs is
		...
		from cfinet213.iso_cntry a004
			inner join cfinet213.iso_cntrylng a006 on
	...
	cursor cursDelCtryCcys is
		select
			...
			a005.ISOCcyId
		from cfinet213.iso_cntry a004
			inner join cfinet213.iso_cntryccy a005 on
...
begin
	...
	loop
		cfinet213.dl_iso_cntrylngbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_iso_cntryccybyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	delete from cfinet213.iso_cntry
	where
		ISOCtryId = argISOCtryId;
...
show errors procedure cfinet213.dl_iso_cntry;
