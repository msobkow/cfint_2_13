--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntrybyisocodeidx.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntrybyisocodeidx(
...
show errors procedure cfinet213.dl_iso_cntrybyisocodeidx;
