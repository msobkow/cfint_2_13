--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntrybynameidx.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntrybynameidx(
...
show errors procedure cfinet213.dl_iso_cntrybynameidx;
