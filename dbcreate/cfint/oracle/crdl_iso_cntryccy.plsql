--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntryccy.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntryccy(
...
begin
	...
	delete from cfinet213.iso_cntryccy
	where
		ISOCtryId = argISOCtryId
		and ISOCcyId = argISOCcyId;
...
show errors procedure cfinet213.dl_iso_cntryccy;
