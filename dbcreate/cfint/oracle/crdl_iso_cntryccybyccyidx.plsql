--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntryccybyccyidx.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntryccybyccyidx(
...
show errors procedure cfinet213.dl_iso_cntryccybyccyidx;
