--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntryccybyididx.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntryccybyididx(
...
show errors procedure cfinet213.dl_iso_cntryccybyididx;
