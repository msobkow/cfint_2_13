--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntrylngbyididx.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntrylngbyididx(
...
show errors procedure cfinet213.dl_iso_cntrylngbyididx;
