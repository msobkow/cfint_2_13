--
--	@(#) dbcreate/cfint/oracle/crdl_iso_cntrylngbylangidx.plsql
--
...
create or replace procedure cfinet213.dl_iso_cntrylngbylangidx(
...
show errors procedure cfinet213.dl_iso_cntrylngbylangidx;
