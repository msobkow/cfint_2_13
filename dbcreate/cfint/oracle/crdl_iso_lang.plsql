--
--	@(#) dbcreate/cfint/oracle/crdl_iso_lang.plsql
--
...
create or replace procedure cfinet213.dl_iso_lang(
...
begin
	...
	delete from cfinet213.iso_lang
	where
		ISOLangId = argISOLangId;
...
show errors procedure cfinet213.dl_iso_lang;
