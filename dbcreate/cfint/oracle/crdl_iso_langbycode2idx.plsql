--
--	@(#) dbcreate/cfint/oracle/crdl_iso_langbycode2idx.plsql
--
...
create or replace procedure cfinet213.dl_iso_langbycode2idx(
...
begin
	...
	loop
			cfinet213.dl_iso_lang( argAuditClusterId,
					argAuditUserId,
					argAuditSessionId,
					secClusterId,
					secTenantId,
...
show errors procedure cfinet213.dl_iso_langbycode2idx;
