--
--	@(#) dbcreate/cfint/oracle/crdl_isotzbyoffsetidx.plsql
--
...
create or replace procedure cfinet213.dl_isotzbyoffsetidx(
...
show errors procedure cfinet213.dl_isotzbyoffsetidx;
