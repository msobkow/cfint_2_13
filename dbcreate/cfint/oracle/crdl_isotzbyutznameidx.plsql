--
--	@(#) dbcreate/cfint/oracle/crdl_isotzbyutznameidx.plsql
--
...
create or replace procedure cfinet213.dl_isotzbyutznameidx(
...
show errors procedure cfinet213.dl_isotzbyutznameidx;
