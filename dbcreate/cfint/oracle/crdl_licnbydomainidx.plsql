--
--	@(#) dbcreate/cfint/oracle/crdl_licnbydomainidx.plsql
--
...
create or replace procedure cfinet213.dl_licnbydomainidx(
...
show errors procedure cfinet213.dl_licnbydomainidx;
