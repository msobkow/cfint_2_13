--
--	@(#) dbcreate/cfint/oracle/crdl_licnbylicntenantidx.plsql
--
...
create or replace procedure cfinet213.dl_licnbylicntenantidx(
...
show errors procedure cfinet213.dl_licnbylicntenantidx;
