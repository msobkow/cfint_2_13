--
--	@(#) dbcreate/cfint/oracle/crdl_mjvrdefbyididx.plsql
--
...
create or replace procedure cfinet213.dl_mjvrdefbyididx(
...
end dl_mjvrdefbyididx;
/

show errors procedure cfinet213.dl_mjvrdefbyididx;
