--
--	@(#) dbcreate/cfint/oracle/crdl_mjvrdefbynameidx.plsql
--
...
create or replace procedure cfinet213.dl_mjvrdefbynameidx(
...
end dl_mjvrdefbynameidx;
/

show errors procedure cfinet213.dl_mjvrdefbynameidx;
