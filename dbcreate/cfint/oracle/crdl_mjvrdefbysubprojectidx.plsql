--
--	@(#) dbcreate/cfint/oracle/crdl_mjvrdefbysubprojectidx.plsql
--
...
create or replace procedure cfinet213.dl_mjvrdefbysubprojectidx(
...
begin
	...
	then
		...
		loop
			cfinet213.dl_mjvrdef( argAuditClusterId,
					argAuditUserId,
					argAuditSessionId,
					secClusterId,
					secTenantId,
...
end dl_mjvrdefbysubprojectidx;
/

show errors procedure cfinet213.dl_mjvrdefbysubprojectidx;
