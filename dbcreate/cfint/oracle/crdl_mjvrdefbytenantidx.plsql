--
--	@(#) dbcreate/cfint/oracle/crdl_mjvrdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.dl_mjvrdefbytenantidx(
...
end dl_mjvrdefbytenantidx;
/

show errors procedure cfinet213.dl_mjvrdefbytenantidx;
