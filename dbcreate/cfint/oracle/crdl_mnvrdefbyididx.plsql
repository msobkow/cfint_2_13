--
--	@(#) dbcreate/cfint/oracle/crdl_mnvrdefbyididx.plsql
--
...
create or replace procedure cfinet213.dl_mnvrdefbyididx(
...
end dl_mnvrdefbyididx;
/

show errors procedure cfinet213.dl_mnvrdefbyididx;
