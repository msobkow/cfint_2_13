--
--	@(#) dbcreate/cfint/oracle/crdl_mnvrdefbynameidx.plsql
--
...
create or replace procedure cfinet213.dl_mnvrdefbynameidx(
...
end dl_mnvrdefbynameidx;
/

show errors procedure cfinet213.dl_mnvrdefbynameidx;
