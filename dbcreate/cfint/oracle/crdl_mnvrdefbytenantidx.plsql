--
--	@(#) dbcreate/cfint/oracle/crdl_mnvrdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.dl_mnvrdefbytenantidx(
...
end dl_mnvrdefbytenantidx;
/

show errors procedure cfinet213.dl_mnvrdefbytenantidx;
