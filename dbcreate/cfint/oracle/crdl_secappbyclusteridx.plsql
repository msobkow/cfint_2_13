--
--	@(#) dbcreate/cfint/oracle/crdl_secappbyclusteridx.plsql
--
...
create or replace procedure cfinet213.dl_secappbyclusteridx(
...
show errors procedure cfinet213.dl_secappbyclusteridx;
