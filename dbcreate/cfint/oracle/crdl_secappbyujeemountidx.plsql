--
--	@(#) dbcreate/cfint/oracle/crdl_secappbyujeemountidx.plsql
--
...
create or replace procedure cfinet213.dl_secappbyujeemountidx(
...
show errors procedure cfinet213.dl_secappbyujeemountidx;
