--
--	@(#) dbcreate/cfint/oracle/crdl_secdevbynameidx.plsql
--
...
create or replace procedure cfinet213.dl_secdevbynameidx(
...
show errors procedure cfinet213.dl_secdevbynameidx;
