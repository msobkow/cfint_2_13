--
--	@(#) dbcreate/cfint/oracle/crdl_secformbyclusteridx.plsql
--
...
create or replace procedure cfinet213.dl_secformbyclusteridx(
...
show errors procedure cfinet213.dl_secformbyclusteridx;
