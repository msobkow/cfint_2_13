--
--	@(#) dbcreate/cfint/oracle/crdl_secformbyididx.plsql
--
...
create or replace procedure cfinet213.dl_secformbyididx(
...
show errors procedure cfinet213.dl_secformbyididx;
