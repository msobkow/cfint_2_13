--
--	@(#) dbcreate/cfint/oracle/crdl_secformbyujeeservletidx.plsql
--
...
create or replace procedure cfinet213.dl_secformbyujeeservletidx(
...
show errors procedure cfinet213.dl_secformbyujeeservletidx;
