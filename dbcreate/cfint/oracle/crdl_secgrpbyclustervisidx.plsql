--
--	@(#) dbcreate/cfint/oracle/crdl_secgrpbyclustervisidx.plsql
--
...
create or replace procedure cfinet213.dl_secgrpbyclustervisidx(
...
show errors procedure cfinet213.dl_secgrpbyclustervisidx;
