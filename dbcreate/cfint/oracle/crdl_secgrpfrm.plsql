--
--	@(#) dbcreate/cfint/oracle/crdl_secgrpfrm.plsql
--
...
create or replace procedure cfinet213.dl_secgrpfrm(
...
show errors procedure cfinet213.dl_secgrpfrm;
