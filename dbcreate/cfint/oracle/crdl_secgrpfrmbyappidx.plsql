--
--	@(#) dbcreate/cfint/oracle/crdl_secgrpfrmbyappidx.plsql
--
...
create or replace procedure cfinet213.dl_secgrpfrmbyappidx(
...
show errors procedure cfinet213.dl_secgrpfrmbyappidx;
