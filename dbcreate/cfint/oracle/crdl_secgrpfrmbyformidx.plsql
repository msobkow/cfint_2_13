--
--	@(#) dbcreate/cfint/oracle/crdl_secgrpfrmbyformidx.plsql
--
...
create or replace procedure cfinet213.dl_secgrpfrmbyformidx(
...
show errors procedure cfinet213.dl_secgrpfrmbyformidx;
