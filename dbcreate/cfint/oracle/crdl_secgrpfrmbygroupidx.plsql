--
--	@(#) dbcreate/cfint/oracle/crdl_secgrpfrmbygroupidx.plsql
--
...
create or replace procedure cfinet213.dl_secgrpfrmbygroupidx(
...
show errors procedure cfinet213.dl_secgrpfrmbygroupidx;
