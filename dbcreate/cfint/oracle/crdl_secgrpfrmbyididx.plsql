--
--	@(#) dbcreate/cfint/oracle/crdl_secgrpfrmbyididx.plsql
--
...
create or replace procedure cfinet213.dl_secgrpfrmbyididx(
...
show errors procedure cfinet213.dl_secgrpfrmbyididx;
