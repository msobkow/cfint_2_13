--
--	@(#) dbcreate/cfint/oracle/crdl_secgrpfrmbyuformidx.plsql
--
...
create or replace procedure cfinet213.dl_secgrpfrmbyuformidx(
...
show errors procedure cfinet213.dl_secgrpfrmbyuformidx;
