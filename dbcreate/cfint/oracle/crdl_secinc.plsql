--
--	@(#) dbcreate/cfint/oracle/crdl_secinc.plsql
--
...
create or replace procedure cfinet213.dl_secinc(
...
is
	use_stamp cfinet213.SecInc_h.auditstamp%type;
...
begin
	...
	permissionFlag := cfinet213.sp_is_cluster_user( oldClusId,
		'DeleteSecGrpInc',
		argAuditUserId );
	if( permissionFlag = 0 )
	then
...
show errors procedure cfinet213.dl_secinc;
