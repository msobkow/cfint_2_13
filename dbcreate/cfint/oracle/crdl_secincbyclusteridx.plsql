--
--	@(#) dbcreate/cfint/oracle/crdl_secincbyclusteridx.plsql
--
...
create or replace procedure cfinet213.dl_secincbyclusteridx(
...
show errors procedure cfinet213.dl_secincbyclusteridx;
