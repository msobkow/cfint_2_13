--
--	@(#) dbcreate/cfint/oracle/crdl_secincbygroupidx.plsql
--
...
create or replace procedure cfinet213.dl_secincbygroupidx(
...
show errors procedure cfinet213.dl_secincbygroupidx;
