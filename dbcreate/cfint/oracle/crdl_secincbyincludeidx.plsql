--
--	@(#) dbcreate/cfint/oracle/crdl_secincbyincludeidx.plsql
--
...
create or replace procedure cfinet213.dl_secincbyincludeidx(
...
show errors procedure cfinet213.dl_secincbyincludeidx;
