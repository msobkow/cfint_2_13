--
--	@(#) dbcreate/cfint/oracle/crdl_secincbyuincludeidx.plsql
--
...
create or replace procedure cfinet213.dl_secincbyuincludeidx(
...
begin
	...
	then
		...
		loop
			cfinet213.dl_secinc( argAuditClusterId,
					argAuditUserId,
					argAuditSessionId,
					secClusterId,
					secTenantId,
...
show errors procedure cfinet213.dl_secincbyuincludeidx;
