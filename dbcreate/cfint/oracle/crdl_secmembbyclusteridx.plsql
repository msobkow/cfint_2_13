--
--	@(#) dbcreate/cfint/oracle/crdl_secmembbyclusteridx.plsql
--
...
create or replace procedure cfinet213.dl_secmembbyclusteridx(
...
show errors procedure cfinet213.dl_secmembbyclusteridx;
