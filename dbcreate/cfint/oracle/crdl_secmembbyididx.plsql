--
--	@(#) dbcreate/cfint/oracle/crdl_secmembbyididx.plsql
--
...
create or replace procedure cfinet213.dl_secmembbyididx(
...
show errors procedure cfinet213.dl_secmembbyididx;
