--
--	@(#) dbcreate/cfint/oracle/crdl_secmembbyuseridx.plsql
--
...
create or replace procedure cfinet213.dl_secmembbyuseridx(
...
show errors procedure cfinet213.dl_secmembbyuseridx;
