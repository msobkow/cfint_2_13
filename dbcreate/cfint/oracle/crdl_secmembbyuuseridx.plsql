--
--	@(#) dbcreate/cfint/oracle/crdl_secmembbyuuseridx.plsql
--
...
create or replace procedure cfinet213.dl_secmembbyuuseridx(
...
show errors procedure cfinet213.dl_secmembbyuuseridx;
