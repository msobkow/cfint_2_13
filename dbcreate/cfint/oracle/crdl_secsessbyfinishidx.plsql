--
--	@(#) dbcreate/cfint/oracle/crdl_secsessbyfinishidx.plsql
--
...
create or replace procedure cfinet213.dl_secsessbyfinishidx(
...
show errors procedure cfinet213.dl_secsessbyfinishidx;
