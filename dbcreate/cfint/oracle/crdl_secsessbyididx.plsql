--
--	@(#) dbcreate/cfint/oracle/crdl_secsessbyididx.plsql
--
...
create or replace procedure cfinet213.dl_secsessbyididx(
...
show errors procedure cfinet213.dl_secsessbyididx;
