--
--	@(#) dbcreate/cfint/oracle/crdl_secsessbysecdevidx.plsql
--
...
create or replace procedure cfinet213.dl_secsessbysecdevidx(
...
show errors procedure cfinet213.dl_secsessbysecdevidx;
