--
--	@(#) dbcreate/cfint/oracle/crdl_secsessbysecuseridx.plsql
--
...
create or replace procedure cfinet213.dl_secsessbysecuseridx(
...
show errors procedure cfinet213.dl_secsessbysecuseridx;
