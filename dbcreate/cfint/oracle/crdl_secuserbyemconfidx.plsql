--
--	@(#) dbcreate/cfint/oracle/crdl_secuserbyemconfidx.plsql
--
...
create or replace procedure cfinet213.dl_secuserbyemconfidx(
...
show errors procedure cfinet213.dl_secuserbyemconfidx;
