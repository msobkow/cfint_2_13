--
--	@(#) dbcreate/cfint/oracle/crdl_secuserbyididx.plsql
--
...
create or replace procedure cfinet213.dl_secuserbyididx(
...
show errors procedure cfinet213.dl_secuserbyididx;
