--
--	@(#) dbcreate/cfint/oracle/crdl_sprjdefbyididx.plsql
--
...
create or replace procedure cfinet213.dl_sprjdefbyididx(
...
show errors procedure cfinet213.dl_sprjdefbyididx;
