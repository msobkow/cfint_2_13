--
--	@(#) dbcreate/cfint/oracle/crdl_sprjdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.dl_sprjdefbytenantidx(
...
show errors procedure cfinet213.dl_sprjdefbytenantidx;
