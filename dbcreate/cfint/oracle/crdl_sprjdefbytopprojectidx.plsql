--
--	@(#) dbcreate/cfint/oracle/crdl_sprjdefbytopprojectidx.plsql
--
...
create or replace procedure cfinet213.dl_sprjdefbytopprojectidx(
...
end dl_sprjdefbytopprojectidx;
/

show errors procedure cfinet213.dl_sprjdefbytopprojectidx;
