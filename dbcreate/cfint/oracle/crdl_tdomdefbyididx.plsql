--
--	@(#) dbcreate/cfint/oracle/crdl_tdomdefbyididx.plsql
--
...
create or replace procedure cfinet213.dl_tdomdefbyididx(
...
show errors procedure cfinet213.dl_tdomdefbyididx;
