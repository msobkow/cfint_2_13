--
--	@(#) dbcreate/cfint/oracle/crdl_tdomdefbynameidx.plsql
--
...
create or replace procedure cfinet213.dl_tdomdefbynameidx(
...
show errors procedure cfinet213.dl_tdomdefbynameidx;
