--
--	@(#) dbcreate/cfint/oracle/crdl_tdomdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.dl_tdomdefbytenantidx(
...
show errors procedure cfinet213.dl_tdomdefbytenantidx;
