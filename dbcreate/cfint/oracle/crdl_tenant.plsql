--
--	@(#) dbcreate/cfint/oracle/crdl_tenant.plsql
--
...
create or replace procedure cfinet213.dl_tenant(
...
begin
	...
	loop
		cfinet213.dl_tlddefbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_tsecincbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	loop
		cfinet213.dl_tsecgrpbyididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
...
show errors procedure cfinet213.dl_tenant;
