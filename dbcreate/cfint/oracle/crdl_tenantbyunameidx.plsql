--
--	@(#) dbcreate/cfint/oracle/crdl_tenantbyunameidx.plsql
--
...
create or replace procedure cfinet213.dl_tenantbyunameidx(
...
show errors procedure cfinet213.dl_tenantbyunameidx;
