--
--	@(#) dbcreate/cfint/oracle/crdl_tlddefbynameidx.plsql
--
...
create or replace procedure cfinet213.dl_tlddefbynameidx(
...
show errors procedure cfinet213.dl_tlddefbynameidx;
