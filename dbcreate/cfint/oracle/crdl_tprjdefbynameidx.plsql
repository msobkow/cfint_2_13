--
--	@(#) dbcreate/cfint/oracle/crdl_tprjdefbynameidx.plsql
--
...
create or replace procedure cfinet213.dl_tprjdefbynameidx(
...
show errors procedure cfinet213.dl_tprjdefbynameidx;
