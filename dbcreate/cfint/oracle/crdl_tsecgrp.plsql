--
--	@(#) dbcreate/cfint/oracle/crdl_tsecgrp.plsql
--
...
create or replace procedure cfinet213.dl_tsecgrp(
...
is
	use_stamp cfinet213.TSecGrp_h.auditstamp%type;
...
show errors procedure cfinet213.dl_tsecgrp;
