--
--	@(#) dbcreate/cfint/oracle/crdl_tsecgrpbytenantidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecgrpbytenantidx(
...
show errors procedure cfinet213.dl_tsecgrpbytenantidx;
