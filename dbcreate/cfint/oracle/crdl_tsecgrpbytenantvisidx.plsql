--
--	@(#) dbcreate/cfint/oracle/crdl_tsecgrpbytenantvisidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecgrpbytenantvisidx(
...
begin
	...
	then
		...
		loop
			cfinet213.dl_tsecgrp( argAuditClusterId,
					argAuditUserId,
					argAuditSessionId,
					secClusterId,
					secTenantId,
...
show errors procedure cfinet213.dl_tsecgrpbytenantvisidx;
