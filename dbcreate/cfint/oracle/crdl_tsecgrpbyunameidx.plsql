--
--	@(#) dbcreate/cfint/oracle/crdl_tsecgrpbyunameidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecgrpbyunameidx(
...
show errors procedure cfinet213.dl_tsecgrpbyunameidx;
