--
--	@(#) dbcreate/cfint/oracle/crdl_tsecincbygroupidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecincbygroupidx(
...
show errors procedure cfinet213.dl_tsecincbygroupidx;
