--
--	@(#) dbcreate/cfint/oracle/crdl_tsecincbyididx.plsql
--
...
create or replace procedure cfinet213.dl_tsecincbyididx(
...
show errors procedure cfinet213.dl_tsecincbyididx;
