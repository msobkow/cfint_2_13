--
--	@(#) dbcreate/cfint/oracle/crdl_tsecincbyincludeidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecincbyincludeidx(
...
show errors procedure cfinet213.dl_tsecincbyincludeidx;
