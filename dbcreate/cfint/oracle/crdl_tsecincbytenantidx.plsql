--
--	@(#) dbcreate/cfint/oracle/crdl_tsecincbytenantidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecincbytenantidx(
...
show errors procedure cfinet213.dl_tsecincbytenantidx;
