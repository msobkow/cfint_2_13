--
--	@(#) dbcreate/cfint/oracle/crdl_tsecincbyuincludeidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecincbyuincludeidx(
...
begin
	...
	then
		...
		loop
			cfinet213.dl_tsecinc( argAuditClusterId,
					argAuditUserId,
					argAuditSessionId,
					secClusterId,
					secTenantId,
...
show errors procedure cfinet213.dl_tsecincbyuincludeidx;
