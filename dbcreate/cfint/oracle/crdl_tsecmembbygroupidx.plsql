--
--	@(#) dbcreate/cfint/oracle/crdl_tsecmembbygroupidx.plsql
--
...
create or replace procedure cfinet213.dl_tsecmembbygroupidx(
...
show errors procedure cfinet213.dl_tsecmembbygroupidx;
