--
--	@(#) dbcreate/cfint/oracle/crdl_tsecmembbyuuseridx.plsql
--
...
create or replace procedure cfinet213.dl_tsecmembbyuuseridx(
...
show errors procedure cfinet213.dl_tsecmembbyuuseridx;
