--
--	@(#) dbcreate/cfint/oracle/crdl_urlprotobyididx.plsql
--
...
create or replace procedure cfinet213.dl_urlprotobyididx(
...
show errors procedure cfinet213.dl_urlprotobyididx;
