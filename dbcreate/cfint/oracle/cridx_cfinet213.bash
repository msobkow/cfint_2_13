#!/bin/bash
#
#	@(#) dbcreate/cfint/oracle/cridx_cfinet213.bash
#
...
echo "# cridx_lic_xtdom.plsql" >>${logfilename}
${sqlpluscmd} <cridx_lic_xtdom.plsql >>${logfilename} 2>&1
echo "# cridx_lic_xuname.plsql" >>${logfilename}
${sqlpluscmd} <cridx_lic_xuname.plsql >>${logfilename} 2>&1
echo "# cridx_mjvrdef_xtenant.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mjvrdef_xtenant.plsql >>${logfilename} 2>&1
echo "# cridx_mjvrdef_xsprj.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mjvrdef_xsprj.plsql >>${logfilename} 2>&1
echo "# cridx_mjvrdef_unameidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mjvrdef_unameidx.plsql >>${logfilename} 2>&1
echo "# cridx_mimetype_xuname.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mimetype_xuname.plsql >>${logfilename} 2>&1
echo "# cridx_mnvrdef_xtenant.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mnvrdef_xtenant.plsql >>${logfilename} 2>&1
echo "# cridx_mnvrdef_xmjvr.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mnvrdef_xmjvr.plsql >>${logfilename} 2>&1
echo "# cridx_mnvrdef_unameidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mnvrdef_unameidx.plsql >>${logfilename} 2>&1
...
echo "# cridx_sprjdef_xtenant.plsql" >>${logfilename}
${sqlpluscmd} <cridx_sprjdef_xtenant.plsql >>${logfilename} 2>&1
echo "# cridx_sprjdef_xtprj.plsql" >>${logfilename}
${sqlpluscmd} <cridx_sprjdef_xtprj.plsql >>${logfilename} 2>&1
...
echo "# cridx_tlddef_xtenant.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tlddef_xtenant.plsql >>${logfilename} 2>&1
echo "# cridx_tlddef_unameidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tlddef_unameidx.plsql >>${logfilename} 2>&1
echo "# cridx_tdomdef_xtenant.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tdomdef_xtenant.plsql >>${logfilename} 2>&1
echo "# cridx_tdomdef_xtld.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tdomdef_xtld.plsql >>${logfilename} 2>&1
echo "# cridx_tdomdef_unameidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tdomdef_unameidx.plsql >>${logfilename} 2>&1
echo "# cridx_tprjdef_xtenant.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tprjdef_xtenant.plsql >>${logfilename} 2>&1
echo "# cridx_tprjdef_xsdom.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tprjdef_xsdom.plsql >>${logfilename} 2>&1
