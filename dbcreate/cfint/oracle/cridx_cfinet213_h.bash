#!/bin/bash
#
#	@(#) dbcreate/cfint/oracle/cridx_cfinet213_h.bash
#
...
echo "# cridx_mjvrdef_htenantidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mjvrdef_htenantidx.plsql >>${logfilename} 2>&1
echo "# cridx_mjvrdef_hsubprojectidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mjvrdef_hsubprojectidx.plsql >>${logfilename} 2>&1
echo "# cridx_mjvrdef_hnameidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mjvrdef_hnameidx.plsql >>${logfilename} 2>&1
echo "# cridx_mimetype_hunameidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mimetype_hunameidx.plsql >>${logfilename} 2>&1
echo "# cridx_mnvrdef_htenantidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mnvrdef_htenantidx.plsql >>${logfilename} 2>&1
echo "# cridx_mnvrdef_hmajorveridx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mnvrdef_hmajorveridx.plsql >>${logfilename} 2>&1
echo "# cridx_mnvrdef_hnameidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_mnvrdef_hnameidx.plsql >>${logfilename} 2>&1
...
echo "# cridx_sprjdef_htopprojectidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_sprjdef_htopprojectidx.plsql >>${logfilename} 2>&1
...
echo "# cridx_tprjdef_htopdomainidx.plsql" >>${logfilename}
${sqlpluscmd} <cridx_tprjdef_htopdomainidx.plsql >>${logfilename} 2>&1
