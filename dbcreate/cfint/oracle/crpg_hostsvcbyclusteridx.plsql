--
--	@(#) dbcreate/cfint/oracle/crpg_hostsvcbyclusteridx.plsql
--
...
create or replace procedure cfinet213.pg_hostsvcbyclusteridx(
...
show errors procedure cfinet213.pg_hostsvcbyclusteridx;
