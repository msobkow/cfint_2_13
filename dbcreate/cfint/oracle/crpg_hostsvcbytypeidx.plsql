--
--	@(#) dbcreate/cfint/oracle/crpg_hostsvcbytypeidx.plsql
--
...
create or replace procedure cfinet213.pg_hostsvcbytypeidx(
...
show errors procedure cfinet213.pg_hostsvcbytypeidx;
