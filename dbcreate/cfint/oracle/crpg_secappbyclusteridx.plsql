--
--	@(#) dbcreate/cfint/oracle/crpg_secappbyclusteridx.plsql
--
...
create or replace procedure cfinet213.pg_secappbyclusteridx(
...
show errors procedure cfinet213.pg_secappbyclusteridx;
