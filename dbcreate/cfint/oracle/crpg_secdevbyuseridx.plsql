--
--	@(#) dbcreate/cfint/oracle/crpg_secdevbyuseridx.plsql
--
...
create or replace procedure cfinet213.pg_secdevbyuseridx(
...
show errors procedure cfinet213.pg_secdevbyuseridx;
