--
--	@(#) dbcreate/cfint/oracle/crpg_secformbyclusteridx.plsql
--
...
create or replace procedure cfinet213.pg_secformbyclusteridx(
...
show errors procedure cfinet213.pg_secformbyclusteridx;
