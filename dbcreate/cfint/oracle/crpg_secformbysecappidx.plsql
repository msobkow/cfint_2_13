--
--	@(#) dbcreate/cfint/oracle/crpg_secformbysecappidx.plsql
--
...
create or replace procedure cfinet213.pg_secformbysecappidx(
...
show errors procedure cfinet213.pg_secformbysecappidx;
