--
--	@(#) dbcreate/cfint/oracle/crpg_secgrpfrmbyappidx.plsql
--
...
create or replace procedure cfinet213.pg_secgrpfrmbyappidx(
...
show errors procedure cfinet213.pg_secgrpfrmbyappidx;
