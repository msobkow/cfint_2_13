--
--	@(#) dbcreate/cfint/oracle/crpg_secgrpfrmbyformidx.plsql
--
...
create or replace procedure cfinet213.pg_secgrpfrmbyformidx(
...
show errors procedure cfinet213.pg_secgrpfrmbyformidx;
