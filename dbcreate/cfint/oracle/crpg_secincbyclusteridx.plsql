--
--	@(#) dbcreate/cfint/oracle/crpg_secincbyclusteridx.plsql
--
...
create or replace procedure cfinet213.pg_secincbyclusteridx(
...
show errors procedure cfinet213.pg_secincbyclusteridx;
