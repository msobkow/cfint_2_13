--
--	@(#) dbcreate/cfint/oracle/crpg_secincbyincludeidx.plsql
--
...
create or replace procedure cfinet213.pg_secincbyincludeidx(
...
show errors procedure cfinet213.pg_secincbyincludeidx;
