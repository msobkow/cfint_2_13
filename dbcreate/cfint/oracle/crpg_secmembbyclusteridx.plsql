--
--	@(#) dbcreate/cfint/oracle/crpg_secmembbyclusteridx.plsql
--
...
create or replace procedure cfinet213.pg_secmembbyclusteridx(
...
show errors procedure cfinet213.pg_secmembbyclusteridx;
