--
--	@(#) dbcreate/cfint/oracle/crpg_secmembbygroupidx.plsql
--
...
create or replace procedure cfinet213.pg_secmembbygroupidx(
...
show errors procedure cfinet213.pg_secmembbygroupidx;
