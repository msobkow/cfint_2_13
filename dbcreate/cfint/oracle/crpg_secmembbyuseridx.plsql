--
--	@(#) dbcreate/cfint/oracle/crpg_secmembbyuseridx.plsql
--
...
create or replace procedure cfinet213.pg_secmembbyuseridx(
...
show errors procedure cfinet213.pg_secmembbyuseridx;
