--
--	@(#) dbcreate/cfint/oracle/crpg_secsessbysecdevidx.plsql
--
...
create or replace procedure cfinet213.pg_secsessbysecdevidx(
...
show errors procedure cfinet213.pg_secsessbysecdevidx;
