--
--	@(#) dbcreate/cfint/oracle/crpg_secsessbysecproxyidx.plsql
--
...
create or replace procedure cfinet213.pg_secsessbysecproxyidx(
...
show errors procedure cfinet213.pg_secsessbysecproxyidx;
