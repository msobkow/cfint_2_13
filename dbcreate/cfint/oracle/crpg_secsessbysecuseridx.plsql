--
--	@(#) dbcreate/cfint/oracle/crpg_secsessbysecuseridx.plsql
--
...
create or replace procedure cfinet213.pg_secsessbysecuseridx(
...
show errors procedure cfinet213.pg_secsessbysecuseridx;
