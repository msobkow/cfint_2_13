--
--	@(#) dbcreate/cfint/oracle/crpg_secuserbydefdevidx.plsql
--
...
create or replace procedure cfinet213.pg_secuserbydefdevidx(
...
show errors procedure cfinet213.pg_secuserbydefdevidx;
