--
--	@(#) dbcreate/cfint/oracle/crpg_secuserbyemconfidx.plsql
--
...
create or replace procedure cfinet213.pg_secuserbyemconfidx(
...
show errors procedure cfinet213.pg_secuserbyemconfidx;
