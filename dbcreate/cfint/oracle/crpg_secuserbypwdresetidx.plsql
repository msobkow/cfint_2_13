--
--	@(#) dbcreate/cfint/oracle/crpg_secuserbypwdresetidx.plsql
--
...
create or replace procedure cfinet213.pg_secuserbypwdresetidx(
...
show errors procedure cfinet213.pg_secuserbypwdresetidx;
