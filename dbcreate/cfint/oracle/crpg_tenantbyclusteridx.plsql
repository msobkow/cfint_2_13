--
--	@(#) dbcreate/cfint/oracle/crpg_tenantbyclusteridx.plsql
--
...
create or replace procedure cfinet213.pg_tenantbyclusteridx(
...
show errors procedure cfinet213.pg_tenantbyclusteridx;
