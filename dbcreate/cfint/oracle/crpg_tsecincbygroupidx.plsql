--
--	@(#) dbcreate/cfint/oracle/crpg_tsecincbygroupidx.plsql
--
...
create or replace procedure cfinet213.pg_tsecincbygroupidx(
...
show errors procedure cfinet213.pg_tsecincbygroupidx;
