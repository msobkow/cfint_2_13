--
--	@(#) dbcreate/cfint/oracle/crpg_tsecincbyincludeidx.plsql
--
...
create or replace procedure cfinet213.pg_tsecincbyincludeidx(
...
show errors procedure cfinet213.pg_tsecincbyincludeidx;
