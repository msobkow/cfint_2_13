--
--	@(#) dbcreate/cfint/oracle/crpg_tsecincbytenantidx.plsql
--
...
create or replace procedure cfinet213.pg_tsecincbytenantidx(
...
show errors procedure cfinet213.pg_tsecincbytenantidx;
