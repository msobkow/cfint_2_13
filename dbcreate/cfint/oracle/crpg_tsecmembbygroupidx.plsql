--
--	@(#) dbcreate/cfint/oracle/crpg_tsecmembbygroupidx.plsql
--
...
create or replace procedure cfinet213.pg_tsecmembbygroupidx(
...
show errors procedure cfinet213.pg_tsecmembbygroupidx;
