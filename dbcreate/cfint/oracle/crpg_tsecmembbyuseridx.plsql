--
--	@(#) dbcreate/cfint/oracle/crpg_tsecmembbyuseridx.plsql
--
...
create or replace procedure cfinet213.pg_tsecmembbyuseridx(
...
show errors procedure cfinet213.pg_tsecmembbyuseridx;
