#!/bin/bash
#
#	@(#) dbcreate/cfint/oracle/crprocs_cfinet213.bash
#
...
echo "#	crnxt_urlprotocolidgen.plsql" >>${logfilename}
${sqlpluscmd} < crnxt_urlprotocolidgen.plsql >>$logfilename 2>&1
...
echo "# crnxt_majorversionidgen.plsql" >>$logfilename 2>&1
${sqlpluscmd} <crnxt_majorversionidgen.plsql >>${logfilename} 2>&1
echo "# crnxt_minorversionidgen.plsql" >>$logfilename 2>&1
${sqlpluscmd} <crnxt_minorversionidgen.plsql >>${logfilename} 2>&1
echo "# crnxt_subprojectidgen.plsql" >>$logfilename 2>&1
${sqlpluscmd} <crnxt_subprojectidgen.plsql >>${logfilename} 2>&1
echo "# crnxt_tldidgen.plsql" >>$logfilename 2>&1
${sqlpluscmd} <crnxt_tldidgen.plsql >>${logfilename} 2>&1
echo "# crnxt_topdomainidgen.plsql" >>$logfilename 2>&1
${sqlpluscmd} <crnxt_topdomainidgen.plsql >>${logfilename} 2>&1
echo "# crnxt_topprojectidgen.plsql" >>$logfilename 2>&1
${sqlpluscmd} <crnxt_topprojectidgen.plsql >>${logfilename} 2>&1
...
echo "#	crcrt_mjvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crcrt_mjvrdef.plsql >>$logfilename 2>&1
echo "#	crcrt_mimetype.plsql" >>${logfilename}
${sqlpluscmd} < crcrt_mimetype.plsql >>$logfilename 2>&1
echo "#	crcrt_mnvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crcrt_mnvrdef.plsql >>$logfilename 2>&1
...
echo "#	crlck_mjvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crlck_mjvrdef.plsql >>$logfilename 2>&1
echo "#	crlck_mimetype.plsql" >>${logfilename}
${sqlpluscmd} < crlck_mimetype.plsql >>$logfilename 2>&1
echo "#	crlck_mnvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crlck_mnvrdef.plsql >>$logfilename 2>&1
...
echo "#	crrd_mjvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mjvrdef.plsql >>$logfilename 2>&1
echo "#	crrd_mjvrdefall.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mjvrdefall.plsql >>$logfilename 2>&1
echo "#	crrd_mjvrdefbyididx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mjvrdefbyididx.plsql >>$logfilename 2>&1
echo "#	crrd_mjvrdefbytenantidx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mjvrdefbytenantidx.plsql >>$logfilename 2>&1
echo "#	crrd_mjvrdefbysubprojectidx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mjvrdefbysubprojectidx.plsql >>$logfilename 2>&1
echo "#	crrd_mjvrdefbynameidx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mjvrdefbynameidx.plsql >>$logfilename 2>&1
...
echo "#	crrd_mnvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mnvrdef.plsql >>$logfilename 2>&1
echo "#	crrd_mnvrdefall.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mnvrdefall.plsql >>$logfilename 2>&1
echo "#	crrd_mnvrdefbyididx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mnvrdefbyididx.plsql >>$logfilename 2>&1
echo "#	crrd_mnvrdefbytenantidx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mnvrdefbytenantidx.plsql >>$logfilename 2>&1
echo "#	crrd_mnvrdefbymajorveridx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mnvrdefbymajorveridx.plsql >>$logfilename 2>&1
echo "#	crrd_mnvrdefbynameidx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_mnvrdefbynameidx.plsql >>$logfilename 2>&1
...
echo "#	crrd_sprjdefbytopprojectidx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_sprjdefbytopprojectidx.plsql >>$logfilename 2>&1
...
echo "#	crrd_tprjdefbytopdomainidx.plsql" >>${logfilename}
${sqlpluscmd} < crrd_tprjdefbytopdomainidx.plsql >>$logfilename 2>&1
...
echo "#	crupd_mjvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crupd_mjvrdef.plsql >>$logfilename 2>&1
echo "#	crupd_mimetype.plsql" >>${logfilename}
${sqlpluscmd} < crupd_mimetype.plsql >>$logfilename 2>&1
echo "#	crupd_mnvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crupd_mnvrdef.plsql >>$logfilename 2>&1
...
echo "#	crdl_mjvrdef_stub.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mjvrdef_stub.plsql >>$logfilename 2>&1
echo "#	crdl_mimetype_stub.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mimetype_stub.plsql >>$logfilename 2>&1
echo "#	crdl_mnvrdef_stub.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mnvrdef_stub.plsql >>$logfilename 2>&1
...
echo "#	crdl_mjvrdefbyididx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mjvrdefbyididx.plsql >>$logfilename 2>&1
echo "#	crdl_mjvrdefbytenantidx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mjvrdefbytenantidx.plsql >>$logfilename 2>&1
echo "#	crdl_mjvrdefbysubprojectidx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mjvrdefbysubprojectidx.plsql >>$logfilename 2>&1
echo "#	crdl_mjvrdefbynameidx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mjvrdefbynameidx.plsql >>$logfilename 2>&1
...
echo "#	crdl_mnvrdefbyididx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mnvrdefbyididx.plsql >>$logfilename 2>&1
echo "#	crdl_mnvrdefbytenantidx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mnvrdefbytenantidx.plsql >>$logfilename 2>&1
echo "#	crdl_mnvrdefbymajorveridx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mnvrdefbymajorveridx.plsql >>$logfilename 2>&1
echo "#	crdl_mnvrdefbynameidx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mnvrdefbynameidx.plsql >>$logfilename 2>&1
...
echo "#	crdl_sprjdefbytopprojectidx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_sprjdefbytopprojectidx.plsql >>$logfilename 2>&1
...
echo "#	crdl_tprjdefbytopdomainidx.plsql" >>${logfilename}
${sqlpluscmd} < crdl_tprjdefbytopdomainidx.plsql >>$logfilename 2>&1
...
echo "#	crdl_mjvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mjvrdef.plsql >>$logfilename 2>&1
echo "#	crdl_mimetype.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mimetype.plsql >>$logfilename 2>&1
echo "#	crdl_mnvrdef.plsql" >>${logfilename}
${sqlpluscmd} < crdl_mnvrdef.plsql >>$logfilename 2>&1
