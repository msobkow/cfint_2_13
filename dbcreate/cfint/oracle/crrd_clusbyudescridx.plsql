--
--	@(#) dbcreate/cfint/oracle/crrd_clusbyudescridx.plsql
--
...
create or replace procedure cfinet213.rd_clusbyudescridx(
...
show errors procedure cfinet213.rd_clusbyudescridx;
