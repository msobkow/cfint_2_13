--
--	@(#) dbcreate/cfint/oracle/crrd_clusbyudomnameidx.plsql
--
...
create or replace procedure cfinet213.rd_clusbyudomnameidx(
...
show errors procedure cfinet213.rd_clusbyudomnameidx;
