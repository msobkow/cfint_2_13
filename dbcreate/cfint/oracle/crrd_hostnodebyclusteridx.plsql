--
--	@(#) dbcreate/cfint/oracle/crrd_hostnodebyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_hostnodebyclusteridx(
...
show errors procedure cfinet213.rd_hostnodebyclusteridx;
