--
--	@(#) dbcreate/cfint/oracle/crrd_hostnodebyididx.plsql
--
...
create or replace procedure cfinet213.rd_hostnodebyididx(
...
show errors procedure cfinet213.rd_hostnodebyididx;
