--
--	@(#) dbcreate/cfint/oracle/crrd_hostnodebyudescridx.plsql
--
...
create or replace procedure cfinet213.rd_hostnodebyudescridx(
...
show errors procedure cfinet213.rd_hostnodebyudescridx;
