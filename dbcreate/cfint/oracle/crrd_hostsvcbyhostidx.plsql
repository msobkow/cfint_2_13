--
--	@(#) dbcreate/cfint/oracle/crrd_hostsvcbyhostidx.plsql
--
...
create or replace procedure cfinet213.rd_hostsvcbyhostidx(
...
show errors procedure cfinet213.rd_hostsvcbyhostidx;
