--
--	@(#) dbcreate/cfint/oracle/crrd_hostsvcbyididx.plsql
--
...
create or replace procedure cfinet213.rd_hostsvcbyididx(
...
show errors procedure cfinet213.rd_hostsvcbyididx;
