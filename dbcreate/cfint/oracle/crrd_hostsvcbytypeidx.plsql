--
--	@(#) dbcreate/cfint/oracle/crrd_hostsvcbytypeidx.plsql
--
...
create or replace procedure cfinet213.rd_hostsvcbytypeidx(
...
show errors procedure cfinet213.rd_hostsvcbytypeidx;
