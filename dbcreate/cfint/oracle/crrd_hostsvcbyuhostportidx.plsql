--
--	@(#) dbcreate/cfint/oracle/crrd_hostsvcbyuhostportidx.plsql
--
...
create or replace procedure cfinet213.rd_hostsvcbyuhostportidx(
...
show errors procedure cfinet213.rd_hostsvcbyuhostportidx;
