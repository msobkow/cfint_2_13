--
--	@(#) dbcreate/cfint/oracle/crrd_iso_ccybyccycdidx.plsql
--
...
create or replace procedure cfinet213.rd_iso_ccybyccycdidx(
...
show errors procedure cfinet213.rd_iso_ccybyccycdidx;
