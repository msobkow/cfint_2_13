--
--	@(#) dbcreate/cfint/oracle/crrd_iso_ccybyccynmidx.plsql
--
...
create or replace procedure cfinet213.rd_iso_ccybyccynmidx(
...
show errors procedure cfinet213.rd_iso_ccybyccynmidx;
