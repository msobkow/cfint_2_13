--
--	@(#) dbcreate/cfint/oracle/crrd_iso_ccybyididx.plsql
--
...
create or replace procedure cfinet213.rd_iso_ccybyididx(
...
show errors procedure cfinet213.rd_iso_ccybyididx;
