--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntrybyididx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntrybyididx(
...
show errors procedure cfinet213.rd_iso_cntrybyididx;
