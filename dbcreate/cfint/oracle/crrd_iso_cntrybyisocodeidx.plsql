--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntrybyisocodeidx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntrybyisocodeidx(
...
show errors procedure cfinet213.rd_iso_cntrybyisocodeidx;
