--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntrybynameidx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntrybynameidx(
...
show errors procedure cfinet213.rd_iso_cntrybynameidx;
