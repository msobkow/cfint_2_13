--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntryccyall.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntryccyall(
...
show errors procedure cfinet213.rd_iso_cntryccyall;
