--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntryccybyccyidx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntryccybyccyidx(
...
show errors procedure cfinet213.rd_iso_cntryccybyccyidx;
