--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntryccybyctryidx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntryccybyctryidx(
...
show errors procedure cfinet213.rd_iso_cntryccybyctryidx;
