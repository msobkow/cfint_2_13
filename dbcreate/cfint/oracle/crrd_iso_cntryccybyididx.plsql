--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntryccybyididx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntryccybyididx(
...
show errors procedure cfinet213.rd_iso_cntryccybyididx;
