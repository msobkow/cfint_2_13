--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntrylngall.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntrylngall(
...
show errors procedure cfinet213.rd_iso_cntrylngall;
