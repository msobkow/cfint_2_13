--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntrylngbyididx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntrylngbyididx(
...
show errors procedure cfinet213.rd_iso_cntrylngbyididx;
