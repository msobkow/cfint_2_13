--
--	@(#) dbcreate/cfint/oracle/crrd_iso_cntrylngbylangidx.plsql
--
...
create or replace procedure cfinet213.rd_iso_cntrylngbylangidx(
...
show errors procedure cfinet213.rd_iso_cntrylngbylangidx;
