--
--	@(#) dbcreate/cfint/oracle/crrd_iso_langbycode2idx.plsql
--
...
create or replace procedure cfinet213.rd_iso_langbycode2idx(
...
show errors procedure cfinet213.rd_iso_langbycode2idx;
