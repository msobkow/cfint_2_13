--
--	@(#) dbcreate/cfint/oracle/crrd_iso_langbyididx.plsql
--
...
create or replace procedure cfinet213.rd_iso_langbyididx(
...
show errors procedure cfinet213.rd_iso_langbyididx;
