--
--	@(#) dbcreate/cfint/oracle/crrd_isotzbyiso8601idx.plsql
--
...
create or replace procedure cfinet213.rd_isotzbyiso8601idx(
...
show errors procedure cfinet213.rd_isotzbyiso8601idx;
