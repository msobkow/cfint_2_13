--
--	@(#) dbcreate/cfint/oracle/crrd_isotzbyoffsetidx.plsql
--
...
create or replace procedure cfinet213.rd_isotzbyoffsetidx(
...
show errors procedure cfinet213.rd_isotzbyoffsetidx;
