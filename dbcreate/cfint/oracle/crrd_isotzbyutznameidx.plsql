--
--	@(#) dbcreate/cfint/oracle/crrd_isotzbyutznameidx.plsql
--
...
create or replace procedure cfinet213.rd_isotzbyutznameidx(
...
show errors procedure cfinet213.rd_isotzbyutznameidx;
