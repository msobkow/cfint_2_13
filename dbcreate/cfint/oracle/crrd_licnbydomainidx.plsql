--
--	@(#) dbcreate/cfint/oracle/crrd_licnbydomainidx.plsql
--
...
create or replace procedure cfinet213.rd_licnbydomainidx(
...
show errors procedure cfinet213.rd_licnbydomainidx;
