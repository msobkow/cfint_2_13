--
--	@(#) dbcreate/cfint/oracle/crrd_licnbylicntenantidx.plsql
--
...
create or replace procedure cfinet213.rd_licnbylicntenantidx(
...
show errors procedure cfinet213.rd_licnbylicntenantidx;
