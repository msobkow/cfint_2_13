--
--	@(#) dbcreate/cfint/oracle/crrd_mimetypebyunameidx.plsql
--
...
create or replace procedure cfinet213.rd_mimetypebyunameidx(
...
show errors procedure cfinet213.rd_mimetypebyunameidx;
