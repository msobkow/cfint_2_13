--
--	@(#) dbcreate/cfint/oracle/crrd_mjvrdefall.plsql
--
...
create or replace procedure cfinet213.rd_mjvrdefall(
...
show errors procedure cfinet213.rd_mjvrdefall;
