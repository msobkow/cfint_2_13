--
--	@(#) dbcreate/cfint/oracle/crrd_mjvrdefbyididx.plsql
--
...
create or replace procedure cfinet213.rd_mjvrdefbyididx(
...
end rd_mjvrdefbyididx;
/

show errors procedure cfinet213.rd_mjvrdefbyididx;
