--
--	@(#) dbcreate/cfint/oracle/crrd_mjvrdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.rd_mjvrdefbytenantidx(
...
end rd_mjvrdefbytenantidx;
/

show errors procedure cfinet213.rd_mjvrdefbytenantidx;
