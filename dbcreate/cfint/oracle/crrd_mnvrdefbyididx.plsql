--
--	@(#) dbcreate/cfint/oracle/crrd_mnvrdefbyididx.plsql
--
...
create or replace procedure cfinet213.rd_mnvrdefbyididx(
...
end rd_mnvrdefbyididx;
/

show errors procedure cfinet213.rd_mnvrdefbyididx;
