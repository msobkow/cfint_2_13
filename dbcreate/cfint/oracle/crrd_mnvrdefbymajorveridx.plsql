--
--	@(#) dbcreate/cfint/oracle/crrd_mnvrdefbymajorveridx.plsql
--
...
create or replace procedure cfinet213.rd_mnvrdefbymajorveridx(
...
end rd_mnvrdefbymajorveridx;
/

show errors procedure cfinet213.rd_mnvrdefbymajorveridx;
