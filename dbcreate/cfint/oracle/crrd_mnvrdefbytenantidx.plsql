--
--	@(#) dbcreate/cfint/oracle/crrd_mnvrdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.rd_mnvrdefbytenantidx(
...
end rd_mnvrdefbytenantidx;
/

show errors procedure cfinet213.rd_mnvrdefbytenantidx;
