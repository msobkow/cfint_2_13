--
--	@(#) dbcreate/cfint/oracle/crrd_secappbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_secappbyclusteridx(
...
show errors procedure cfinet213.rd_secappbyclusteridx;
