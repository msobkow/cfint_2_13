--
--	@(#) dbcreate/cfint/oracle/crrd_secappbyujeemountidx.plsql
--
...
create or replace procedure cfinet213.rd_secappbyujeemountidx(
...
show errors procedure cfinet213.rd_secappbyujeemountidx;
