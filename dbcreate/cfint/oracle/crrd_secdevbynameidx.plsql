--
--	@(#) dbcreate/cfint/oracle/crrd_secdevbynameidx.plsql
--
...
create or replace procedure cfinet213.rd_secdevbynameidx(
...
show errors procedure cfinet213.rd_secdevbynameidx;
