--
--	@(#) dbcreate/cfint/oracle/crrd_secdevbyuseridx.plsql
--
...
create or replace procedure cfinet213.rd_secdevbyuseridx(
...
show errors procedure cfinet213.rd_secdevbyuseridx;
