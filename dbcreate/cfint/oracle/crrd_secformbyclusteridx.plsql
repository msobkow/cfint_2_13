--
--	@(#) dbcreate/cfint/oracle/crrd_secformbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_secformbyclusteridx(
...
show errors procedure cfinet213.rd_secformbyclusteridx;
