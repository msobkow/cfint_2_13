--
--	@(#) dbcreate/cfint/oracle/crrd_secformbyididx.plsql
--
...
create or replace procedure cfinet213.rd_secformbyididx(
...
show errors procedure cfinet213.rd_secformbyididx;
