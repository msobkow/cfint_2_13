--
--	@(#) dbcreate/cfint/oracle/crrd_secformbysecappidx.plsql
--
...
create or replace procedure cfinet213.rd_secformbysecappidx(
...
show errors procedure cfinet213.rd_secformbysecappidx;
