--
--	@(#) dbcreate/cfint/oracle/crrd_secformbyujeeservletidx.plsql
--
...
create or replace procedure cfinet213.rd_secformbyujeeservletidx(
...
show errors procedure cfinet213.rd_secformbyujeeservletidx;
