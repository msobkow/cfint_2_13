--
--	@(#) dbcreate/cfint/oracle/crrd_secgrpbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_secgrpbyclusteridx(
...
show errors procedure cfinet213.rd_secgrpbyclusteridx;
