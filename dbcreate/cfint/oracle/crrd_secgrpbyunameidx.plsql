--
--	@(#) dbcreate/cfint/oracle/crrd_secgrpbyunameidx.plsql
--
...
create or replace procedure cfinet213.rd_secgrpbyunameidx(
...
show errors procedure cfinet213.rd_secgrpbyunameidx;
