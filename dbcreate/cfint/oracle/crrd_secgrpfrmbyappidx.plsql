--
--	@(#) dbcreate/cfint/oracle/crrd_secgrpfrmbyappidx.plsql
--
...
create or replace procedure cfinet213.rd_secgrpfrmbyappidx(
...
show errors procedure cfinet213.rd_secgrpfrmbyappidx;
