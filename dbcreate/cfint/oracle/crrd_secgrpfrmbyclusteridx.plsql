--
--	@(#) dbcreate/cfint/oracle/crrd_secgrpfrmbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_secgrpfrmbyclusteridx(
...
show errors procedure cfinet213.rd_secgrpfrmbyclusteridx;
