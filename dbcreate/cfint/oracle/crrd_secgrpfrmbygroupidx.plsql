--
--	@(#) dbcreate/cfint/oracle/crrd_secgrpfrmbygroupidx.plsql
--
...
create or replace procedure cfinet213.rd_secgrpfrmbygroupidx(
...
show errors procedure cfinet213.rd_secgrpfrmbygroupidx;
