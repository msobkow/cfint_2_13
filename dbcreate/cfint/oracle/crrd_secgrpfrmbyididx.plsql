--
--	@(#) dbcreate/cfint/oracle/crrd_secgrpfrmbyididx.plsql
--
...
create or replace procedure cfinet213.rd_secgrpfrmbyididx(
...
show errors procedure cfinet213.rd_secgrpfrmbyididx;
