--
--	@(#) dbcreate/cfint/oracle/crrd_secgrpfrmbyuformidx.plsql
--
...
create or replace procedure cfinet213.rd_secgrpfrmbyuformidx(
...
show errors procedure cfinet213.rd_secgrpfrmbyuformidx;
