--
--	@(#) dbcreate/cfint/oracle/crrd_secincbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_secincbyclusteridx(
...
show errors procedure cfinet213.rd_secincbyclusteridx;
