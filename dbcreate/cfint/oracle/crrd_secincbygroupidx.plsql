--
--	@(#) dbcreate/cfint/oracle/crrd_secincbygroupidx.plsql
--
...
create or replace procedure cfinet213.rd_secincbygroupidx(
...
show errors procedure cfinet213.rd_secincbygroupidx;
