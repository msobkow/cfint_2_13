--
--	@(#) dbcreate/cfint/oracle/crrd_secincbyincludeidx.plsql
--
...
create or replace procedure cfinet213.rd_secincbyincludeidx(
...
show errors procedure cfinet213.rd_secincbyincludeidx;
