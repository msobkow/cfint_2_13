--
--	@(#) dbcreate/cfint/oracle/crrd_secincbyuincludeidx.plsql
--
...
create or replace procedure cfinet213.rd_secincbyuincludeidx(
...
show errors procedure cfinet213.rd_secincbyuincludeidx;
