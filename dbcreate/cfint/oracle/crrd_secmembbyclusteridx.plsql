--
--	@(#) dbcreate/cfint/oracle/crrd_secmembbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_secmembbyclusteridx(
...
show errors procedure cfinet213.rd_secmembbyclusteridx;
