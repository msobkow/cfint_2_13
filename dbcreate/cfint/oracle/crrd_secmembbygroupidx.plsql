--
--	@(#) dbcreate/cfint/oracle/crrd_secmembbygroupidx.plsql
--
...
create or replace procedure cfinet213.rd_secmembbygroupidx(
...
show errors procedure cfinet213.rd_secmembbygroupidx;
