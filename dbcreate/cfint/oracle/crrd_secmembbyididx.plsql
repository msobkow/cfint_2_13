--
--	@(#) dbcreate/cfint/oracle/crrd_secmembbyididx.plsql
--
...
create or replace procedure cfinet213.rd_secmembbyididx(
...
show errors procedure cfinet213.rd_secmembbyididx;
