--
--	@(#) dbcreate/cfint/oracle/crrd_secmembbyuseridx.plsql
--
...
create or replace procedure cfinet213.rd_secmembbyuseridx(
...
show errors procedure cfinet213.rd_secmembbyuseridx;
