--
--	@(#) dbcreate/cfint/oracle/crrd_secmembbyuuseridx.plsql
--
...
create or replace procedure cfinet213.rd_secmembbyuuseridx(
...
show errors procedure cfinet213.rd_secmembbyuuseridx;
