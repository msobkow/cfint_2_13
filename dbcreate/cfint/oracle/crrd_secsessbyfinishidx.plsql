--
--	@(#) dbcreate/cfint/oracle/crrd_secsessbyfinishidx.plsql
--
...
create or replace procedure cfinet213.rd_secsessbyfinishidx(
...
show errors procedure cfinet213.rd_secsessbyfinishidx;
