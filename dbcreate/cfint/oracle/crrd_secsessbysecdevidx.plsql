--
--	@(#) dbcreate/cfint/oracle/crrd_secsessbysecdevidx.plsql
--
...
create or replace procedure cfinet213.rd_secsessbysecdevidx(
...
show errors procedure cfinet213.rd_secsessbysecdevidx;
