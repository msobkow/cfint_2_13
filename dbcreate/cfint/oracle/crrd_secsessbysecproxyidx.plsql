--
--	@(#) dbcreate/cfint/oracle/crrd_secsessbysecproxyidx.plsql
--
...
create or replace procedure cfinet213.rd_secsessbysecproxyidx(
...
show errors procedure cfinet213.rd_secsessbysecproxyidx;
