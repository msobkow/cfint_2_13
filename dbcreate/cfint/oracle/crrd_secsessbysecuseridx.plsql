--
--	@(#) dbcreate/cfint/oracle/crrd_secsessbysecuseridx.plsql
--
...
create or replace procedure cfinet213.rd_secsessbysecuseridx(
...
show errors procedure cfinet213.rd_secsessbysecuseridx;
