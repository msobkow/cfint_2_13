--
--	@(#) dbcreate/cfint/oracle/crrd_secsessbystartidx.plsql
--
...
create or replace procedure cfinet213.rd_secsessbystartidx(
...
show errors procedure cfinet213.rd_secsessbystartidx;
