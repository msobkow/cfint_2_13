--
--	@(#) dbcreate/cfint/oracle/crrd_secuserbydefdevidx.plsql
--
...
create or replace procedure cfinet213.rd_secuserbydefdevidx(
...
show errors procedure cfinet213.rd_secuserbydefdevidx;
