--
--	@(#) dbcreate/cfint/oracle/crrd_secuserbyemconfidx.plsql
--
...
create or replace procedure cfinet213.rd_secuserbyemconfidx(
...
show errors procedure cfinet213.rd_secuserbyemconfidx;
