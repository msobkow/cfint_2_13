--
--	@(#) dbcreate/cfint/oracle/crrd_secuserbyididx.plsql
--
...
create or replace procedure cfinet213.rd_secuserbyididx(
...
show errors procedure cfinet213.rd_secuserbyididx;
