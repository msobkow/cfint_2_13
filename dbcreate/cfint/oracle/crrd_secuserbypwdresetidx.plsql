--
--	@(#) dbcreate/cfint/oracle/crrd_secuserbypwdresetidx.plsql
--
...
create or replace procedure cfinet213.rd_secuserbypwdresetidx(
...
show errors procedure cfinet213.rd_secuserbypwdresetidx;
