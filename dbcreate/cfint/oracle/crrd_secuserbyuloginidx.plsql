--
--	@(#) dbcreate/cfint/oracle/crrd_secuserbyuloginidx.plsql
--
...
create or replace procedure cfinet213.rd_secuserbyuloginidx(
...
show errors procedure cfinet213.rd_secuserbyuloginidx;
