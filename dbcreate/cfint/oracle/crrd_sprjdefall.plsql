--
--	@(#) dbcreate/cfint/oracle/crrd_sprjdefall.plsql
--
...
create or replace procedure cfinet213.rd_sprjdefall(
...
show errors procedure cfinet213.rd_sprjdefall;
