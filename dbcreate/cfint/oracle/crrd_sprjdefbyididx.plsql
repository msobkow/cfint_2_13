--
--	@(#) dbcreate/cfint/oracle/crrd_sprjdefbyididx.plsql
--
...
create or replace procedure cfinet213.rd_sprjdefbyididx(
...
show errors procedure cfinet213.rd_sprjdefbyididx;
