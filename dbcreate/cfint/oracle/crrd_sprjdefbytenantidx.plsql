--
--	@(#) dbcreate/cfint/oracle/crrd_sprjdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.rd_sprjdefbytenantidx(
...
show errors procedure cfinet213.rd_sprjdefbytenantidx;
