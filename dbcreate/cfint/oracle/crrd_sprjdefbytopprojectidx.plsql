--
--	@(#) dbcreate/cfint/oracle/crrd_sprjdefbytopprojectidx.plsql
--
...
create or replace procedure cfinet213.rd_sprjdefbytopprojectidx(
	...
	secTenantId numeric,
	argTenantId numeric,
	argTopProjectId numeric ) authid definer
is
...
end rd_sprjdefbytopprojectidx;
/

show errors procedure cfinet213.rd_sprjdefbytopprojectidx;
