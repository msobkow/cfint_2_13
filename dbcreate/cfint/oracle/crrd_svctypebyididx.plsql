--
--	@(#) dbcreate/cfint/oracle/crrd_svctypebyididx.plsql
--
...
create or replace procedure cfinet213.rd_svctypebyididx(
...
show errors procedure cfinet213.rd_svctypebyididx;
