--
--	@(#) dbcreate/cfint/oracle/crrd_svctypebyudescridx.plsql
--
...
create or replace procedure cfinet213.rd_svctypebyudescridx(
...
show errors procedure cfinet213.rd_svctypebyudescridx;
