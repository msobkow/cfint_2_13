--
--	@(#) dbcreate/cfint/oracle/crrd_sysclusbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_sysclusbyclusteridx(
...
show errors procedure cfinet213.rd_sysclusbyclusteridx;
