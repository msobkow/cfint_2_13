--
--	@(#) dbcreate/cfint/oracle/crrd_tdomdefbytenantidx.plsql
--
...
create or replace procedure cfinet213.rd_tdomdefbytenantidx(
...
show errors procedure cfinet213.rd_tdomdefbytenantidx;
