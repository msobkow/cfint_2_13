--
--	@(#) dbcreate/cfint/oracle/crrd_tdomdefbytldidx.plsql
--
...
create or replace procedure cfinet213.rd_tdomdefbytldidx(
...
show errors procedure cfinet213.rd_tdomdefbytldidx;
