--
--	@(#) dbcreate/cfint/oracle/crrd_tenantbyclusteridx.plsql
--
...
create or replace procedure cfinet213.rd_tenantbyclusteridx(
...
show errors procedure cfinet213.rd_tenantbyclusteridx;
