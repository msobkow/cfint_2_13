--
--	@(#) dbcreate/cfint/oracle/crrd_tenantbyunameidx.plsql
--
...
create or replace procedure cfinet213.rd_tenantbyunameidx(
...
show errors procedure cfinet213.rd_tenantbyunameidx;
