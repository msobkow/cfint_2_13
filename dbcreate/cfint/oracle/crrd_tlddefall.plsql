--
--	@(#) dbcreate/cfint/oracle/crrd_tlddefall.plsql
--
...
create or replace procedure cfinet213.rd_tlddefall(
...
show errors procedure cfinet213.rd_tlddefall;
