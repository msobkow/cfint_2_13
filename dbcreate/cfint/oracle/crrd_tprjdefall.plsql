--
--	@(#) dbcreate/cfint/oracle/crrd_tprjdefall.plsql
--
...
create or replace procedure cfinet213.rd_tprjdefall(
...
show errors procedure cfinet213.rd_tprjdefall;
