--
--	@(#) dbcreate/cfint/oracle/crrd_tprjdefbytopdomainidx.plsql
--
...
create or replace procedure cfinet213.rd_tprjdefbytopdomainidx(
...
end rd_tprjdefbytopdomainidx;
/

show errors procedure cfinet213.rd_tprjdefbytopdomainidx;
