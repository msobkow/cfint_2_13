--
--	@(#) dbcreate/cfint/oracle/crrd_tsecgrpbyididx.plsql
--
...
create or replace procedure cfinet213.rd_tsecgrpbyididx(
...
show errors procedure cfinet213.rd_tsecgrpbyididx;
