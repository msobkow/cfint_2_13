--
--	@(#) dbcreate/cfint/oracle/crrd_tsecgrpbytenantidx.plsql
--
...
create or replace procedure cfinet213.rd_tsecgrpbytenantidx(
...
show errors procedure cfinet213.rd_tsecgrpbytenantidx;
