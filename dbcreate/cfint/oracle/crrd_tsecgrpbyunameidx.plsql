--
--	@(#) dbcreate/cfint/oracle/crrd_tsecgrpbyunameidx.plsql
--
...
create or replace procedure cfinet213.rd_tsecgrpbyunameidx(
...
show errors procedure cfinet213.rd_tsecgrpbyunameidx;
