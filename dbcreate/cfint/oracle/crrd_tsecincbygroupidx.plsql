--
--	@(#) dbcreate/cfint/oracle/crrd_tsecincbygroupidx.plsql
--
...
create or replace procedure cfinet213.rd_tsecincbygroupidx(
...
show errors procedure cfinet213.rd_tsecincbygroupidx;
