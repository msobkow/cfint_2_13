--
--	@(#) dbcreate/cfint/oracle/crrd_tsecincbyididx.plsql
--
...
create or replace procedure cfinet213.rd_tsecincbyididx(
...
show errors procedure cfinet213.rd_tsecincbyididx;
