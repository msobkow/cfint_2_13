--
--	@(#) dbcreate/cfint/oracle/crrd_tsecincbyincludeidx.plsql
--
...
create or replace procedure cfinet213.rd_tsecincbyincludeidx(
...
show errors procedure cfinet213.rd_tsecincbyincludeidx;
