--
--	@(#) dbcreate/cfint/oracle/crrd_tsecincbytenantidx.plsql
--
...
create or replace procedure cfinet213.rd_tsecincbytenantidx(
...
show errors procedure cfinet213.rd_tsecincbytenantidx;
