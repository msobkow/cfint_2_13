--
--	@(#) dbcreate/cfint/oracle/crrd_tsecincbyuincludeidx.plsql
--
...
create or replace procedure cfinet213.rd_tsecincbyuincludeidx(
...
show errors procedure cfinet213.rd_tsecincbyuincludeidx;
