--
--	@(#) dbcreate/cfint/oracle/crrd_tsecmembbygroupidx.plsql
--
...
create or replace procedure cfinet213.rd_tsecmembbygroupidx(
...
show errors procedure cfinet213.rd_tsecmembbygroupidx;
