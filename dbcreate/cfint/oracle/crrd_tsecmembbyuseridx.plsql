--
--	@(#) dbcreate/cfint/oracle/crrd_tsecmembbyuseridx.plsql
--
...
create or replace procedure cfinet213.rd_tsecmembbyuseridx(
...
show errors procedure cfinet213.rd_tsecmembbyuseridx;
