--
--	@(#) dbcreate/cfint/oracle/crrd_urlprotobyididx.plsql
--
...
create or replace procedure cfinet213.rd_urlprotobyididx(
...
show errors procedure cfinet213.rd_urlprotobyididx;
