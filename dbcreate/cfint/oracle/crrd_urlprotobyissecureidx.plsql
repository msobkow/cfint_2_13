--
--	@(#) dbcreate/cfint/oracle/crrd_urlprotobyissecureidx.plsql
--
...
create or replace procedure cfinet213.rd_urlprotobyissecureidx(
...
begin
	...
	where
		...
		order by URLProtocolId desc;
end rd_urlprotobyissecureidx;
/

show errors procedure cfinet213.rd_urlprotobyissecureidx;
