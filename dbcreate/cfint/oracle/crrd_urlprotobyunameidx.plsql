--
--	@(#) dbcreate/cfint/oracle/crrd_urlprotobyunameidx.plsql
--
...
create or replace procedure cfinet213.rd_urlprotobyunameidx(
...
show errors procedure cfinet213.rd_urlprotobyunameidx;
