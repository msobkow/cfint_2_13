#!/bin/bash
#
#	@(#) dbcreate/cfint/oracle/crrel_cfinet213.bash
#
...
echo "# crrel_mjvrdef.plsql" >>${logfilename}
${sqlpluscmd} <crrel_mjvrdef.plsql >>${logfilename} 2>&1
echo "# crrel_mimetype.plsql" >>${logfilename}
${sqlpluscmd} <crrel_mimetype.plsql >>${logfilename} 2>&1
echo "# crrel_mnvrdef.plsql" >>${logfilename}
${sqlpluscmd} <crrel_mnvrdef.plsql >>${logfilename} 2>&1
