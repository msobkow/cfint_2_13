--
--	@(#) dbcreate/cfint/oracle/crsp_bootstrap.plsql
--
...
create or replace procedure cfinet213.sp_bootstrap authid definer
is
	curtime timestamp;
	clusid numeric(22,0);
...
begin
	...
	select cfinet213.nxt_clusteridgen()
	into clusid
	from dual;
	...
	select cfinet213.nxt_tenantidgen()
	into tenantid
	from dual;
...
show errors procedure cfinet213.sp_bootstrap;

call cfinet213.sp_bootstrap();
