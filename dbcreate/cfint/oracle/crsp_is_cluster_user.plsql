--
--	@(#) dbcreate/cfint/oracle/crsp_is_cluster_user.plsql
--
...
create or replace function cfinet213.sp_is_cluster_user(
...
show errors function cfinet213.sp_is_cluster_user;
