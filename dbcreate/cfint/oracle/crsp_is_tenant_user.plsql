--
--	@(#) dbcreate/cfint/oracle/crsp_is_tenant_user.plsql
--
...
create or replace function cfinet213.sp_is_tenant_user(
	argTenantId numeric,
...
is
	...
	cursor curs is 
		...
		union
			...
			from cfinet213.TSecGrp sgrp1
				inner join cfinet213.TSecMemb smemb1 on
		...
		union
			...
			from cfinet213.TSecGrp sgrp2
				inner join cfinet213.TSecInc sinc2a on
					sinc2a.tenantid = sgrp2.tenantid
					and sinc2a.tsecgrpid = sgrp2.tsecgroupid
				inner join cfinet213.TSecMemb smemb2 on
		...
		union
			...
			from cfinet213.TSecGrp sgrp3
				inner join cfinet213.TSecInc sinc3a on
					sinc3a.tenantid = sgrp3.tenantid
					and sinc3a.tsecgrpid = sgrp3.tsecgroupid
				inner join cfinet213.TSecInc sinc3b on
					sinc3b.tenantid = sinc3a.tenantid
					and sinc3b.tsecgrpid = sinc3a.incgrpid
				inner join cfinet213.TSecMemb smemb3 on
...
show errors function cfinet213.sp_is_tenant_user;
