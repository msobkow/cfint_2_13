...
echo "# crtbl_mjvrdef.plsql" >>${logfilename}
${sqlpluscmd} <crtbl_mjvrdef.plsql >>${logfilename} 2>&1
echo "# crtbl_mimetype.plsql" >>${logfilename}
${sqlpluscmd} <crtbl_mimetype.plsql >>${logfilename} 2>&1
echo "# crtbl_mnvrdef.plsql" >>${logfilename}
${sqlpluscmd} <crtbl_mnvrdef.plsql >>${logfilename} 2>&1
...
echo "# crtbl_mjvrdef_h.plsql" >>${logfilename}
${sqlpluscmd} <crtbl_mjvrdef_h.plsql >>${logfilename} 2>&1
echo "# crtbl_mimetype_h.plsql" >>${logfilename}
${sqlpluscmd} <crtbl_mimetype_h.plsql >>${logfilename} 2>&1
echo "# crtbl_mnvrdef_h.plsql" >>${logfilename}
${sqlpluscmd} <crtbl_mnvrdef_h.plsql >>${logfilename} 2>&1
