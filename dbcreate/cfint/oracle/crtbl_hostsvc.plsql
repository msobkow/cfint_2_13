--
--	@(#) dbcreate/cfint/oracle/crtbl_hostsvc.plsql
--
...
--
CREATE TABLE cfinet213.HostSvc (
...
CREATE UNIQUE INDEX Service_pidx ON cfinet213.HostSvc (
	clusterid,
	serviceid ) TABLESPACE cfinet213_idx1;

ALTER TABLE cfinet213.HostSvc
