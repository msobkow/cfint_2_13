--
--	@(#) dbcreate/cfint/oracle/crtbl_mnvrdef_h.plsql
--
...
CREATE TABLE cfinet213.mnvrdef_h (
	...
	auditclusterid	NUMERIC(22,0) NOT NULL,
		CONSTRAINT chkh_mnvrdefauditcluster
			FOREIGN KEY ( auditclusterid )
			REFERENCES cfinet213.clus( id )
			ON DELETE CASCADE,
	auditsessionid	VARCHAR(36) NOT NULL,
		CONSTRAINT chkh_mnvrdefauditsession
			FOREIGN KEY ( auditsessionid )
			REFERENCES cfinet213.SecSess( secsessionid )
			ON DELETE CASCADE,
	majorversionid	numeric(22,0) NOT NULL,
...
CREATE UNIQUE INDEX mnvrdef_hididx ON cfinet213.mnvrdef_h (
	auditclusterid,
	auditstamp,
	tenantid,
	id,
...
ALTER TABLE cfinet213.mnvrdef_h
	ADD CONSTRAINT pk_mnvrdef_hididx PRIMARY KEY ( auditclusterid, auditstamp, tenantid, id, auditaction, revision );
