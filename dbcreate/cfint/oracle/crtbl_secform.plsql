--
--	@(#) dbcreate/cfint/oracle/crtbl_secform.plsql
--
...
--
CREATE TABLE cfinet213.SecForm (
...
CREATE UNIQUE INDEX SecForm_pidx ON cfinet213.SecForm (
	clusterid,
	secformid ) TABLESPACE cfinet213_idx1;

ALTER TABLE cfinet213.SecForm
