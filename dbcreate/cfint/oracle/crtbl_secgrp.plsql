--
--	@(#) dbcreate/cfint/oracle/crtbl_secgrp.plsql
--
...
CREATE UNIQUE INDEX SecGroup_pidx ON cfinet213.SecGrp (
	clusterid,
	secgroupid ) TABLESPACE cfinet213_idx1;

ALTER TABLE cfinet213.SecGrp
