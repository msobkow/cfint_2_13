--
--	@(#) dbcreate/cfint/oracle/crtbl_secsess.plsql
--
...
--
CREATE TABLE cfinet213.SecSess (
...
CREATE UNIQUE INDEX Session_pidx ON cfinet213.SecSess (
	secsessionid ) TABLESPACE cfinet213_idx1;

ALTER TABLE cfinet213.SecSess
