--
--	@(#) dbcreate/cfint/oracle/crtbl_tlddef_h.plsql
--
...
CREATE UNIQUE INDEX tlddef_hididx ON cfinet213.tlddef_h (
	auditclusterid,
	auditstamp,
	tenantid,
	id,
...
ALTER TABLE cfinet213.tlddef_h
	ADD CONSTRAINT pk_tlddef_hididx PRIMARY KEY ( auditclusterid, auditstamp, tenantid, id, auditaction, revision );
