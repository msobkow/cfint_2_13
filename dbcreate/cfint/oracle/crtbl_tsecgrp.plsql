--
--	@(#) dbcreate/cfint/oracle/crtbl_tsecgrp.plsql
--
...
--
CREATE TABLE cfinet213.TSecGrp (
...
CREATE UNIQUE INDEX TSecGroup_pidx ON cfinet213.TSecGrp (
	tenantid,
	tsecgroupid ) TABLESPACE cfinet213_idx1;

ALTER TABLE cfinet213.TSecGrp
