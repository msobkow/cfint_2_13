--
--	@(#) dbcreate/cfint/oracle/crtbl_tsecmemb.plsql
--
...
--
CREATE TABLE cfinet213.TSecMemb (
...
CREATE UNIQUE INDEX TSecMember_pidx ON cfinet213.TSecMemb (
	tenantid,
	tsecgrpmembid ) TABLESPACE cfinet213_idx1;

ALTER TABLE cfinet213.TSecMemb
