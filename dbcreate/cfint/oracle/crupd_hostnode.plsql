--
--	@(#) dbcreate/cfint/oracle/crupd_hostnode.plsql
--
...
create or replace procedure cfinet213.upd_hostnode(
...
show errors procedure cfinet213.upd_hostnode;
