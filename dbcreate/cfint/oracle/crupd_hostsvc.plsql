--
--	@(#) dbcreate/cfint/oracle/crupd_hostsvc.plsql
--
...
create or replace procedure cfinet213.upd_hostsvc(
...
show errors procedure cfinet213.upd_hostsvc;
