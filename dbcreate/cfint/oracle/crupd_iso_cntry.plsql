--
--	@(#) dbcreate/cfint/oracle/crupd_iso_cntry.plsql
--
...
create or replace procedure cfinet213.upd_iso_cntry(
...
show errors procedure cfinet213.upd_iso_cntry;
