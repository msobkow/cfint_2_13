--
--	@(#) dbcreate/cfint/oracle/crupd_secform.plsql
--
...
create or replace procedure cfinet213.upd_secform(
...
show errors procedure cfinet213.upd_secform;
