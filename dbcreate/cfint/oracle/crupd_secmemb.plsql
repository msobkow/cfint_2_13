--
--	@(#) dbcreate/cfint/oracle/crupd_secmemb.plsql
--
...
create or replace procedure cfinet213.upd_secmemb(
...
show errors procedure cfinet213.upd_secmemb;
