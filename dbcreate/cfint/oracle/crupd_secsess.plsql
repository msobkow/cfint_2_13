--
--	@(#) dbcreate/cfint/oracle/crupd_secsess.plsql
--
...
create or replace procedure cfinet213.upd_secsess(
...
show errors procedure cfinet213.upd_secsess;
