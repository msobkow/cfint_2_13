@ECHO off
REM
REM	@(#) dbcreate/cfint/pgsql/cridx_cfinet213_h.bat
REM
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_mjvrdef_h_tenantidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_mjvrdef_h_subprojectidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_mjvrdef_h_nameidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_mimetype_h_unameidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_mnvrdef_h_tenantidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_mnvrdef_h_majorveridx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_mnvrdef_h_nameidx.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_sprjdef_h_topprojectidx.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f cridx_tprjdef_h_topdomainidx.pgsql >>%logfilename% 2>&1
