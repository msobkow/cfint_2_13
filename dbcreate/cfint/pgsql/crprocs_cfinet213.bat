@ECHO off
REM
REM	@(#) dbcreate/cfint/pgsql/crprocs_cfinet213.bat
REM
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_next_urlprotocolidgen.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_next_majorversionidgen.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_next_minorversionidgen.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_next_subprojectidgen.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_next_tldidgen.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_next_topdomainidgen.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_next_topprojectidgen.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_create_mjvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_lock_mjvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mjvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mjvrdef_all.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mjvrdef_by_ididx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mjvrdef_by_tenantidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mjvrdef_by_subprojectidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mjvrdef_by_nameidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_update_mjvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mjvrdef.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_create_mnvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_lock_mnvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mnvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mnvrdef_all.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mnvrdef_by_ididx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mnvrdef_by_tenantidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mnvrdef_by_majorveridx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_mnvrdef_by_nameidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_update_mnvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mnvrdef.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_sprjdef_by_topprojectidx.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_read_tprjdef_by_topdomainidx.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mjvrdef_by_ididx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mjvrdef_by_tenantidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mjvrdef_by_subprojectidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mjvrdef_by_nameidx.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mnvrdef_by_ididx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mnvrdef_by_tenantidx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mnvrdef_by_majorveridx.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_mnvrdef_by_nameidx.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_sprjdef_by_topprojectidx.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crsp_delete_tprjdef_by_topdomainidx.pgsql >>%logfilename% 2>&1
