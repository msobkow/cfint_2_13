@ECHO off
REM
REM	@(#) dbcreate/cfint/pgsqlcrschema_cfinet213.bat
REM
...
psql -h %pghost% -U %pguser% -a -e -c "drop schema cfinet213" >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -c "create schema cfinet213" >>%logfilename% 2>&1
...
ECHO REM >>%logfilename%
CALL crtbl_cfinet213.bat %pghost% %pgdb% %pguser% %pgpwd% %logfilename%
...
ECHO REM >>%logfilename%
CALL cridx_cfinet213.bat %pghost% %pgdb% %pguser% %pgpwd% %logfilename%
...
ECHO REM >>%logfilename%
CALL crrel_cfinet213.bat %pghost% %pgdb% %pguser% %pgpwd% %logfilename%
...
ECHO  >>%logfilename%
ECHO REM >>%logfilename%
ECHO REM	Executing script crseq_cfinet213.bat >>%logfilename%
ECHO REM >>%logfilename%
CALL crseq_cfinet213.bat %pghost% %pgdb% %pguser% %pgpwd% %logfilename%
...
ECHO  >>%logfilename%
ECHO REM >>%logfilename%
ECHO REM	Executing script crtypes_cfinet213.bat >>%logfilename%
ECHO REM >>%logfilename%
CALL crtypes_cfinet213.bat %pghost% %pgdb% %pguser% %pgpwd% %logfilename%
...
ECHO REM >>%logfilename%
CALL crprocs_cfinet213.bat %pghost% %pgdb% %pguser% %pgpwd% %logfilename%
