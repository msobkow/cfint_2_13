--
--	@(#) dbcreate/cfint/pgsql/crsp_bootstrap.pgsql
--
...
--
create or replace function cfinet213.sp_bootstrap()
returns boolean as $$
declare
	curtime timestamp;
	clusid bigint;
begin
	...
	values (
		...
		curtime,
		'654dbba0-eda7-11e1-aff1-0800200c9a66',
		cfinet213.sp_next_clusteridgen(),
		'system',
		'system',
		1 );
	...
	select
		...
		'654dbba0-eda7-11e1-aff1-0800200c9a66',
		clus.id,
		cfinet213.sp_next_tenantidgen(),
		'system',
		1
	from cfinet213.clus as clus
	where
...
select cfinet213.sp_bootstrap();

drop function cfinet213.sp_bootstrap();
