--
--	@(#) dbcreate/cfint/pgsql/crsp_create_hostnode.pgsql
--
...
--
create or replace function cfinet213.sp_create_hostnode(
...
begin
	...
	select cfinet213.sp_next_hostnodeidgen( argClusterId )
	into argHostNodeId;
