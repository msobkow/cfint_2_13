--
--	@(#) dbcreate/cfint/pgsql/crsp_create_secform.pgsql
--
...
--
create or replace function cfinet213.sp_create_secform(
...
begin
	...
	select cfinet213.sp_next_secformidgen( argClusterId )
	into argSecFormId;
