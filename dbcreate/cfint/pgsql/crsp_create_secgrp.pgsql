--
--	@(#) dbcreate/cfint/pgsql/crsp_create_secgrp.pgsql
--
...
--
create or replace function cfinet213.sp_create_secgrp(
...
returns setof cfinet213.type_secgrp_rec as $$
declare
...
begin
	...
	select cfinet213.sp_next_secgroupidgen( argClusterId )
	into argSecGroupId;
