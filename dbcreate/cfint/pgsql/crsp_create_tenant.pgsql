--
--	@(#) dbcreate/cfint/pgsql/crsp_create_tenant.pgsql
--
...
--
create or replace function cfinet213.sp_create_tenant(
...
returns setof cfinet213.type_tenant_rec as $$
declare
