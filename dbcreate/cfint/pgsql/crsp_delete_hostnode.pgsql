--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_hostnode.pgsql
--
...
--
create or replace function cfinet213.sp_delete_hostnode(
...
begin
	...
	for cur in
		...
		where
			...
			and a002.HostNodeId = argHostNodeId
	loop
		select cfinet213.sp_delete_hostsvc_by_ididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
