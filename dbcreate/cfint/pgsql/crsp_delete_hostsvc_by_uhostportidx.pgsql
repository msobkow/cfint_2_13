--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_hostsvc_by_uhostportidx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_hostsvc_by_uhostportidx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_hostsvc( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
