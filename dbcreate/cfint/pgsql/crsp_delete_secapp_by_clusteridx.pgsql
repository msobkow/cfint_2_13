--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_secapp_by_clusteridx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_secapp_by_clusteridx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_secapp( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
