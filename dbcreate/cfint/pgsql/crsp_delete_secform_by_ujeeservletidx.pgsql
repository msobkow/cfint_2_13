--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_secform_by_ujeeservletidx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_secform_by_ujeeservletidx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_secform( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
