--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_secgrp_by_clustervisidx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_secgrp_by_clustervisidx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_secgrp( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
