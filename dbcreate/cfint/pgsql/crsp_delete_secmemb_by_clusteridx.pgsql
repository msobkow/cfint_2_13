--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_secmemb_by_clusteridx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_secmemb_by_clusteridx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_secmemb( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
