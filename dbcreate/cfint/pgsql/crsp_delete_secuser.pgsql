--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_secuser.pgsql
--
...
--
create or replace function cfinet213.sp_delete_secuser(
...
begin
	...
	for cur in
		...
		where
			a011.SecUserId = argSecUserId
	loop
		select cfinet213.sp_delete_tsecmemb_by_ididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	for cur in
		...
		where
			a011.SecUserId = argSecUserId
	loop
		select cfinet213.sp_delete_secsess_by_ididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
	...
	for cur in
		...
		where
			a011.SecUserId = argSecUserId
	loop
		select cfinet213.sp_delete_secdev_by_ididx( argAuditClusterId,
				argAuditUserId,
				argAuditSessionId,
				secClusterId,
				secTenantId,
