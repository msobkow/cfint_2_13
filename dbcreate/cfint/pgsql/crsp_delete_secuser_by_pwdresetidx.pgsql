--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_secuser_by_pwdresetidx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_secuser_by_pwdresetidx(
...
begin
	...
	loop
				select cfinet213.sp_delete_secuser( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
