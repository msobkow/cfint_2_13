--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_tsecgrp_by_tenantvisidx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_tsecgrp_by_tenantvisidx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_tsecgrp( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
