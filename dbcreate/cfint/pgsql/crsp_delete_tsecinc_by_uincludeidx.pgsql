--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_tsecinc_by_uincludeidx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_tsecinc_by_uincludeidx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_tsecinc( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
