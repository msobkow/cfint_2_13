--
--	@(#) dbcreate/cfint/pgsql/crsp_delete_tsecmemb_by_tenantidx.pgsql
--
...
--
create or replace function cfinet213.sp_delete_tsecmemb_by_tenantidx(
...
begin
	...
	then
		...
		loop
				select cfinet213.sp_delete_tsecmemb( argAuditClusterId,
						argAuditUserId,
						argAuditSessionId,
						secClusterId,
						secTenantId,
