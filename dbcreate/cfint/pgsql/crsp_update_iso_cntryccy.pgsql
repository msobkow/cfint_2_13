--
--	@(#) dbcreate/cfint/pgsql/crsp_update_iso_cntryccy.pgsql
--
...
create or replace function cfinet213.sp_update_iso_cntryccy(
	...
	argRevision integer )
returns setof cfinet213.type_iso_cntryccy_rec as $$
declare
