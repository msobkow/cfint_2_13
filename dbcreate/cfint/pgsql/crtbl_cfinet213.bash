#!/bin/bash
#
#	@(#) dbcreate/cfint/pgsql/crtbl_cfinet213.bash
#
...
psql -h ${pghost} ${PGPORT} -d ${pgdb} -U ${pguser} -a -e -f crtbl_mjvrdef.pgsql >>${logfilename} 2>&1
psql -h ${pghost} ${PGPORT} -d ${pgdb} -U ${pguser} -a -e -f crtbl_mimetype.pgsql >>${logfilename} 2>&1
psql -h ${pghost} ${PGPORT} -d ${pgdb} -U ${pguser} -a -e -f crtbl_mnvrdef.pgsql >>${logfilename} 2>&1
...
psql -h ${pghost} ${PGPORT} -d ${pgdb} -U ${pguser} -a -e -f crtbl_mjvrdef_h.pgsql >>${logfilename} 2>&1
psql -h ${pghost} ${PGPORT} -d ${pgdb} -U ${pguser} -a -e -f crtbl_mimetype_h.pgsql >>${logfilename} 2>&1
psql -h ${pghost} ${PGPORT} -d ${pgdb} -U ${pguser} -a -e -f crtbl_mnvrdef_h.pgsql >>${logfilename} 2>&1
