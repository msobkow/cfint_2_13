@ECHO off
REM
REM	@(#) dbcreate/cfint/pgsql/crtbl_cfinet213.bat
REM
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crtbl_mjvrdef.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crtbl_mimetype.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crtbl_mnvrdef.pgsql >>%logfilename% 2>&1
...
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crtbl_mjvrdef_h.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crtbl_mimetype_h.pgsql >>%logfilename% 2>&1
psql -h %pghost% -d %pgdb% -U %pguser% -a -e -f crtbl_mnvrdef_h.pgsql >>%logfilename% 2>&1
