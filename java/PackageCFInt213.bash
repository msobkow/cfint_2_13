...
if [ "$Revision" == "" ]; then
	...
	cd $MSSCFHOME/cfint_2_13/java
	if [ ! -d ../installer ]; then
		mkdir ../installer
	fi
	export Revision
	archiveFileName="../installer/cfint_2_13_${Revision}-DualGPLv3-java-installer.zip"
	export archiveFileName
	rm -f ${archiveFileName}
	rm -f bin/*.jar
	cp ~/.m2/repository/org/msscf/msscf/v2_13/org.msscf.msscf.v2_13.cfint*/2.13.${Build}/*-2.13.${Build}.jar bin
