...
// Description: Java 11 XML Message message formatter for CFInt.ISOCtryLang
...
/*
 *	CFIntXMsgISOCtryLangMessageFormatter XML message formatter
 *	for CFInt.ISOCtryLang.
 */
public class CFIntXMsgISOCtryLangMessageFormatter
{
	public CFIntXMsgISOCtryLangMessageFormatter() {
	}
	...
	public static String formatISOCtryLangBuffAttributes( String separator, CFSecISOCtryLangBuff buff ) {
		String retval = CFIntXMsgISOCtryLangMessageFormatter.formatISOCtryLangPKeyAttributes( separator, buff )
