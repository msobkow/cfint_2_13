...
// Description: Java 11 XML Message message formatter for CFInt.TSecGroup
...
/*
 *	CFIntXMsgTSecGroupMessageFormatter XML message formatter
 *	for CFInt.TSecGroup.
 */
public class CFIntXMsgTSecGroupMessageFormatter
{
	public CFIntXMsgTSecGroupMessageFormatter() {
	}
	...
	public static String formatTSecGroupBuffAttributes( String separator, CFSecTSecGroupBuff buff ) {
		String retval = CFIntXMsgTSecGroupMessageFormatter.formatTSecGroupPKeyAttributes( separator, buff )
			+	CFLibXmlUtil.formatRequiredInt32( separator,
					"Revision",
