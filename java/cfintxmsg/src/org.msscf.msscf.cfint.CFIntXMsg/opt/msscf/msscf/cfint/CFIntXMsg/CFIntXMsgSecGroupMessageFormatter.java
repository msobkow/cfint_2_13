...
// Description: Java 11 XML Message message formatter for CFInt.SecGroup
...
/*
 *	CFIntXMsgSecGroupMessageFormatter XML message formatter
 *	for CFInt.SecGroup.
 */
public class CFIntXMsgSecGroupMessageFormatter
{
	public CFIntXMsgSecGroupMessageFormatter() {
	}
	...
	public static String formatSecGroupBuffAttributes( String separator, CFSecSecGroupBuff buff ) {
		String retval = CFIntXMsgSecGroupMessageFormatter.formatSecGroupPKeyAttributes( separator, buff )
			+	CFLibXmlUtil.formatRequiredInt32( separator,
					"Revision",
