...
// Description: Java 11 XML Message message formatter for CFInt.Cluster
...
/*
 *	CFIntXMsgClusterMessageFormatter XML message formatter
 *	for CFInt.Cluster.
 */
public class CFIntXMsgClusterMessageFormatter
{
	public CFIntXMsgClusterMessageFormatter() {
	}
	...
	public static String formatClusterBuffAttributes( String separator, CFSecClusterBuff buff ) {
		String retval = CFIntXMsgClusterMessageFormatter.formatClusterPKeyAttributes( separator, buff )
