...
// Description: Java 11 XML Message message formatter for CFInt.HostNode
...
/*
 *	CFIntXMsgHostNodeMessageFormatter XML message formatter
 *	for CFInt.HostNode.
 */
public class CFIntXMsgHostNodeMessageFormatter
{
	public CFIntXMsgHostNodeMessageFormatter() {
	}
	...
	public static String formatHostNodeBuffAttributes( String separator, CFSecHostNodeBuff buff ) {
		String retval = CFIntXMsgHostNodeMessageFormatter.formatHostNodePKeyAttributes( separator, buff )
