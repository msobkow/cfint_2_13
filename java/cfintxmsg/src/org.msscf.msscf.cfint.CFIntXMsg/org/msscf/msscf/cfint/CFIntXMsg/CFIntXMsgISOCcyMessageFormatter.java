...
// Description: Java 11 XML Message message formatter for CFInt.ISOCcy
...
/*
 *	CFIntXMsgISOCcyMessageFormatter XML message formatter
 *	for CFInt.ISOCcy.
 */
public class CFIntXMsgISOCcyMessageFormatter
{
	public CFIntXMsgISOCcyMessageFormatter() {
	}
	...
	public static String formatISOCcyBuffAttributes( String separator, CFSecISOCcyBuff buff ) {
		String retval = CFIntXMsgISOCcyMessageFormatter.formatISOCcyPKeyAttributes( separator, buff )
