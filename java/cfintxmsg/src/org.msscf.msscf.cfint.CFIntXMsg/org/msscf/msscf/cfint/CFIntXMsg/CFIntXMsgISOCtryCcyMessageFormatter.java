...
// Description: Java 11 XML Message message formatter for CFInt.ISOCtryCcy
...
/*
 *	CFIntXMsgISOCtryCcyMessageFormatter XML message formatter
 *	for CFInt.ISOCtryCcy.
 */
public class CFIntXMsgISOCtryCcyMessageFormatter
{
	public CFIntXMsgISOCtryCcyMessageFormatter() {
	}
	...
	public static String formatISOCtryCcyBuffAttributes( String separator, CFSecISOCtryCcyBuff buff ) {
		String retval = CFIntXMsgISOCtryCcyMessageFormatter.formatISOCtryCcyPKeyAttributes( separator, buff )
