...
// Description: Java 11 XML Message message formatter for CFInt.ISOCtry
...
/*
 *	CFIntXMsgISOCtryMessageFormatter XML message formatter
 *	for CFInt.ISOCtry.
 */
public class CFIntXMsgISOCtryMessageFormatter
{
	public CFIntXMsgISOCtryMessageFormatter() {
	}
	...
	public static String formatISOCtryBuffAttributes( String separator, CFSecISOCtryBuff buff ) {
		String retval = CFIntXMsgISOCtryMessageFormatter.formatISOCtryPKeyAttributes( separator, buff )
