...
// Description: Java 11 XML Message message formatter for CFInt.SecForm
...
/*
 *	CFIntXMsgSecFormMessageFormatter XML message formatter
 *	for CFInt.SecForm.
 */
public class CFIntXMsgSecFormMessageFormatter
{
	public CFIntXMsgSecFormMessageFormatter() {
	}
	...
	public static String formatSecFormBuffAttributes( String separator, CFSecSecFormBuff buff ) {
		String retval = CFIntXMsgSecFormMessageFormatter.formatSecFormPKeyAttributes( separator, buff )
			+	CFLibXmlUtil.formatRequiredInt32( separator,
					"Revision",
