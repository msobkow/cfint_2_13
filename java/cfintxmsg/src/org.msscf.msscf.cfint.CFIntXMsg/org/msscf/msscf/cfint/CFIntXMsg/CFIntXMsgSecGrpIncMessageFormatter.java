...
// Description: Java 11 XML Message message formatter for CFInt.SecGrpInc
...
/*
 *	CFIntXMsgSecGrpIncMessageFormatter XML message formatter
 *	for CFInt.SecGrpInc.
 */
public class CFIntXMsgSecGrpIncMessageFormatter
{
	public CFIntXMsgSecGrpIncMessageFormatter() {
	}
	...
	public static String formatSecGrpIncBuffAttributes( String separator, CFSecSecGrpIncBuff buff ) {
		String retval = CFIntXMsgSecGrpIncMessageFormatter.formatSecGrpIncPKeyAttributes( separator, buff )
