...
// Description: Java 11 XML Message message formatter for CFInt.SecUser
...
/*
 *	CFIntXMsgSecUserMessageFormatter XML message formatter
 *	for CFInt.SecUser.
 */
public class CFIntXMsgSecUserMessageFormatter
{
	public CFIntXMsgSecUserMessageFormatter() {
	}
	...
	public static String formatSecUserBuffAttributes( String separator, CFSecSecUserBuff buff ) {
		String retval = CFIntXMsgSecUserMessageFormatter.formatSecUserPKeyAttributes( separator, buff )
