...
// Description: Java 11 XML Message message formatter for CFInt.Service
...
/*
 *	CFIntXMsgServiceMessageFormatter XML message formatter
 *	for CFInt.Service.
 */
public class CFIntXMsgServiceMessageFormatter
{
	public CFIntXMsgServiceMessageFormatter() {
	}
	...
	public static String formatServiceBuffAttributes( String separator, CFSecServiceBuff buff ) {
		String retval = CFIntXMsgServiceMessageFormatter.formatServicePKeyAttributes( separator, buff )
