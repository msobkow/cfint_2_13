...
// Description: Java 11 XML Message message formatter for CFInt.ServiceType
...
/*
 *	CFIntXMsgServiceTypeMessageFormatter XML message formatter
 *	for CFInt.ServiceType.
 */
public class CFIntXMsgServiceTypeMessageFormatter
{
	public CFIntXMsgServiceTypeMessageFormatter() {
	}
	...
	public static String formatServiceTypeBuffAttributes( String separator, CFSecServiceTypeBuff buff ) {
		String retval = CFIntXMsgServiceTypeMessageFormatter.formatServiceTypePKeyAttributes( separator, buff )
