...
// Description: Java 11 XML Message message formatter for CFInt.SysCluster
...
/*
 *	CFIntXMsgSysClusterMessageFormatter XML message formatter
 *	for CFInt.SysCluster.
 */
public class CFIntXMsgSysClusterMessageFormatter
{
	public CFIntXMsgSysClusterMessageFormatter() {
	}
	...
	public static String formatSysClusterBuffAttributes( String separator, CFSecSysClusterBuff buff ) {
		String retval = CFIntXMsgSysClusterMessageFormatter.formatSysClusterPKeyAttributes( separator, buff )
