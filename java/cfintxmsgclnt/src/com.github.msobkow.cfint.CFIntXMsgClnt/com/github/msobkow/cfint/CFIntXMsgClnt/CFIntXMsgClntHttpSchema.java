// Description: Java 11 XMsg Client HTTP DbIO implementation for CFInt.
...
public class CFIntXMsgClntHttpSchema
	extends CFIntXMsgClntSchema
{
	protected String serverURL = "http://localhost/cfintxmsgsrvwar/CFIntXMsgSrvWarRequestXml";
	protected HttpClientContext clientContext = null;

	public CFIntXMsgClntHttpSchema() {
		super();
	}

	public CFIntXMsgClntHttpSchema( CFIntSchemaObj handlerSchema ) {
		super( handlerSchema );
	}

	public CFIntXMsgClntHttpSchema( CFIntSchemaObj handlerSchema, CFIntConfigurationFile conf ) {
		super( handlerSchema, conf );
	}

	public CFIntXMsgClntHttpSchema( CFIntSchemaObj handlerSchema, String argJndiName ) {
