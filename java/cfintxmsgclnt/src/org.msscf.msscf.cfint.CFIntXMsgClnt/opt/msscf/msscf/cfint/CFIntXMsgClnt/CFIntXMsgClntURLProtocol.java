// Description: Java 11 XMsg Client DbIO implementation for URLProtocol.
...
/*
 *	CFIntXMsgClntURLProtocol XMsg Client DbIO implementation
 *	for URLProtocol.
 */
public class CFIntXMsgClntURLProtocol
	implements ICFIntURLProtocolTable
{
	private CFIntXMsgClntSchema schema;

	public CFIntXMsgClntURLProtocol( CFIntXMsgClntSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFIntURLProtocolBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstCreate( "\n\t\t\t", Buff )
			+	"\n"
		...
		if( lastObjectProcessed != null ) {
			ICFIntURLProtocolObj realised = null;
			if( lastObjectProcessed instanceof ICFIntURLProtocolObj ) {
				realised = (ICFIntURLProtocolObj)lastObjectProcessed;
			}
			else {
			...
			if( realised != null ) {
				Buff.set( realised.getURLProtocolBuff() );
			}
		}
		else {
		...
		CFIntURLProtocolPKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstRead( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		if( lastObjectProcessed != null ) {
			...
			if( realised != null ) {
				buff = realised.getURLProtocolBuff();
			}
		}
		return( buff );
	}
		...
		CFIntURLProtocolPKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstLock( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
	...
	public CFIntURLProtocolBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstReadAll( "\n\t\t\t" )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		List<ICFIntURLProtocolObj> sortedList =
			(List<ICFIntURLProtocolObj>)sortedListObj;
		CFIntURLProtocolBuff arr[];
		if( sortedList != null ) {
			int sz = sortedList.size();
			arr = new CFIntURLProtocolBuff[ sz ];
			Iterator<ICFIntURLProtocolObj> iter = sortedList.iterator();
			ICFIntURLProtocolObj cur;
			for( int idx = 0; idx < sz; idx ++ ) {
				cur = (ICFIntURLProtocolObj)iter.next();
				arr[idx] = cur.getURLProtocolBuff();
			}
		}
		else {
			arr = new CFIntURLProtocolBuff[ 0 ];
		}
		return( arr );
	}
		...
		int argURLProtocolId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstRdByIdIdx( "\n\t\t\t",
							argURLProtocolId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		String argName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstRdByUNameIdx( "\n\t\t\t",
							argName )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		boolean argIsSecure )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstRdByIsSecureIdx( "\n\t\t\t",
							argIsSecure )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		CFIntURLProtocolBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstUpdate( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFIntURLProtocolBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstDelete( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		int argURLProtocolId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstDelByIdIdx( "\n\t\t\t",
							argURLProtocolId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		String argName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstDelByUNameIdx( "\n\t\t\t",
							argName )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		boolean argIsSecure )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgURLProtocolMessageFormatter.formatURLProtocolRqstDelByIsSecureIdx( "\n\t\t\t",
							argIsSecure )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
