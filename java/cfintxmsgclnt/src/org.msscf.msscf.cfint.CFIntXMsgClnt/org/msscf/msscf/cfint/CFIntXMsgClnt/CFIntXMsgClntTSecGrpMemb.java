...
/*
 *	CFIntXMsgClntTSecGrpMemb XMsg Client DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFIntXMsgClntTSecGrpMemb
	implements ICFIntTSecGrpMembTable
{
	private CFIntXMsgClntSchema schema;

	public CFIntXMsgClntTSecGrpMemb( CFIntXMsgClntSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecTSecGrpMembBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstCreate( "\n\t\t\t", Buff )
			+	"\n"
		...
		if( lastObjectProcessed != null ) {
			ICFIntTSecGrpMembObj realised = null;
			if( lastObjectProcessed instanceof ICFIntTSecGrpMembObj ) {
				realised = (ICFIntTSecGrpMembObj)lastObjectProcessed;
			}
			else {
		...
		CFSecTSecGrpMembPKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstRead( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecTSecGrpMembPKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstLock( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
	...
	public CFSecTSecGrpMembBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstReadAll( "\n\t\t\t" )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		long argTSecGrpMembId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstRdByIdIdx( "\n\t\t\t",
							argTenantId,
							argTSecGrpMembId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		long argTenantId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstRdByTenantIdx( "\n\t\t\t",
							argTenantId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		int argTSecGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstRdByGroupIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		UUID argSecUserId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstRdByUserIdx( "\n\t\t\t",
							argSecUserId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		UUID argSecUserId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstRdByUUserIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId,
							argSecUserId )
			+	"\n"
		...
		Long priorTSecGrpMembId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstPageAll( "\n\t\t\t",
							priorTenantId,
							priorTSecGrpMembId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		Long priorTSecGrpMembId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstPageByTenantIdx( "\n\t\t\t",
						TenantId,
							priorTenantId,
							priorTSecGrpMembId )
			+	"\n"
		...
		Long priorTSecGrpMembId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstPageByGroupIdx( "\n\t\t\t",
						TenantId,
						TSecGroupId,
							priorTenantId,
							priorTSecGrpMembId )
		...
		Long priorTSecGrpMembId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstPageByUserIdx( "\n\t\t\t",
						SecUserId,
							priorTenantId,
							priorTSecGrpMembId )
			+	"\n"
		...
		CFSecTSecGrpMembBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstUpdate( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecTSecGrpMembBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstDelete( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		long argTSecGrpMembId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstDelByIdIdx( "\n\t\t\t",
							argTenantId,
							argTSecGrpMembId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		long argTenantId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstDelByTenantIdx( "\n\t\t\t",
							argTenantId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		int argTSecGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstDelByGroupIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		UUID argSecUserId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstDelByUserIdx( "\n\t\t\t",
							argSecUserId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		UUID argSecUserId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembRqstDelByUUserIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId,
							argSecUserId )
			+	"\n"
