...
/*
 *	CFIntMSSqlISOCtryTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtry.
 */
public class CFIntMSSqlISOCtryTable
	implements ICFIntISOCtryTable
{
	...
	public CFIntMSSqlISOCtryTable( CFIntMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCtryId )
	{
		final String S_ProcName = "CFIntMSSqlISOCtryTable.readDerivedByIdIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByISOCodeIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFIntMSSqlISOCtryTable.readDerivedByISOCodeIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntMSSqlISOCtryTable.readDerivedByNameIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
