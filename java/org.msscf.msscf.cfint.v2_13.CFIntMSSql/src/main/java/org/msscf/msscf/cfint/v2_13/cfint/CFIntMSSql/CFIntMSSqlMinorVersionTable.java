// Description: Java 11 MS SQL Server Developer Edition Jdbc DbIO implementation for MinorVersion.
...
/*
 *	CFIntMSSqlMinorVersionTable PostgreSQL Jdbc DbIO implementation
 *	for MinorVersion.
 */
public class CFIntMSSqlMinorVersionTable
	implements ICFIntMinorVersionTable
{
	...
	public CFIntMSSqlMinorVersionTable( CFIntMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMinorVersionBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntMSSqlMinorVersionTable.readDerivedByIdIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMinorVersionBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntMSSqlMinorVersionTable.readDerivedByNameIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
		...
		CFIntMinorVersionPKey PKey )
	{
		...
		try {
			...
			String sql = "{ call sp_read_mnvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ) }";
		...
		CFIntMinorVersionPKey PKey )
	{
		...
		try {
			...
			long TenantId = PKey.getRequiredTenantId();
			long Id = PKey.getRequiredId();
			String sql = "{ call sp_lock_mnvrdef( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ) }";
	...
	public CFIntMinorVersionBuff[] readAllBuff( CFSecAuthorization Authorization ) {
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "{ call sp_read_mnvrdef_all( ?, ?, ?, ?, ? ) }";
		...
		long Id )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "{ call sp_read_mnvrdef_by_ididx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ) }";
		...
		long TenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "{ call sp_read_mnvrdef_by_tenantidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + " ) }";
		...
		long MajorVersionId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "{ call sp_read_mnvrdef_by_majorveridx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + " ) }";
		...
		String Name )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "{ call sp_read_mnvrdef_by_nameidx( ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?" + " ) }";
		...
		CFIntMinorVersionBuff Buff )
	{
		...
		try {
			...
			String sql = "exec sp_delete_mnvrdef ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?";
		...
		long argId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_mnvrdef_by_ididx ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?";
		...
		long argTenantId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_mnvrdef_by_tenantidx ?, ?, ?, ?, ?" + ", "
				+		"?";
		...
		long argMajorVersionId )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_mnvrdef_by_majorveridx ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?";
			...
			Object stuff = null;
			boolean moreResults = stmtDeleteByMajorVerIdx.execute();
			while( stuff == null ) {
				try {
					moreResults = stmtDeleteByMajorVerIdx.getMoreResults();
				}
				catch( SQLException e ) {
					throw new CFLibDbException( getClass(),
						S_ProcName,
				...
				if( moreResults ) {
					try {
						stuff = stmtDeleteByMajorVerIdx.getResultSet();
					}
					catch( SQLException e ) {
					}
				}
				else if( -1 == stmtDeleteByMajorVerIdx.getUpdateCount() ) {
					break;
				}
			}
		}
		...
		String argName )
	{
		...
		try {
			Connection cnx = schema.getCnx();
			String sql = "exec sp_delete_mnvrdef_by_nameidx ?, ?, ?, ?, ?" + ", "
				+		"?" + ", "
				+		"?" + ", "
				+		"?";
