...
/*
 *	CFIntMSSqlServiceTypeTable PostgreSQL Jdbc DbIO implementation
 *	for ServiceType.
 */
public class CFIntMSSqlServiceTypeTable
	implements ICFIntServiceTypeTable
{
	...
	public CFIntMSSqlServiceTypeTable( CFIntMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int ServiceTypeId )
	{
		final String S_ProcName = "CFIntMSSqlServiceTypeTable.readDerivedByIdIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceTypeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFIntMSSqlServiceTypeTable.readDerivedByUDescrIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
