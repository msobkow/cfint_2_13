...
/*
 *	CFIntMySqlClusterTable MySQL Jdbc DbIO implementation
 *	for Cluster.
 */
public class CFIntMySqlClusterTable
	implements ICFIntClusterTable
{
	...
	public CFIntMySqlClusterTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFIntMySqlClusterTable.readDerivedByIdIdx() ";
		CFSecClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecClusterBuff readDerivedByUDomNameIdx( CFSecAuthorization Authorization,
		String FullDomName )
	{
		final String S_ProcName = "CFIntMySqlClusterTable.readDerivedByUDomNameIdx() ";
		CFSecClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecClusterBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFIntMySqlClusterTable.readDerivedByUDescrIdx() ";
		CFSecClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
