...
/*
 *	CFIntMySqlHostNodeTable MySQL Jdbc DbIO implementation
 *	for HostNode.
 */
public class CFIntMySqlHostNodeTable
	implements ICFIntHostNodeTable
{
	...
	public CFIntMySqlHostNodeTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecHostNodeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long HostNodeId )
	{
		final String S_ProcName = "CFIntMySqlHostNodeTable.readDerivedByIdIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		...
		String Description )
	{
		final String S_ProcName = "CFIntMySqlHostNodeTable.readDerivedByUDescrIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByHostNameIdx( CFSecAuthorization Authorization,
		...
		String HostName )
	{
		final String S_ProcName = "CFIntMySqlHostNodeTable.readDerivedByHostNameIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
