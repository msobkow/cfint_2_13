...
/*
 *	CFIntMySqlISOCtryCcyTable MySQL Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFIntMySqlISOCtryCcyTable
	implements ICFIntISOCtryCcyTable
{
	...
	public CFIntMySqlISOCtryCcyTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFIntMySqlISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
