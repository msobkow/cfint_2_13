...
/*
 *	CFIntMySqlISOCtryLangTable MySQL Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFIntMySqlISOCtryLangTable
	implements ICFIntISOCtryLangTable
{
	...
	public CFIntMySqlISOCtryLangTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFIntMySqlISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
