...
/*
 *	CFIntMySqlISOCtryTable MySQL Jdbc DbIO implementation
 *	for ISOCtry.
 */
public class CFIntMySqlISOCtryTable
	implements ICFIntISOCtryTable
{
	...
	public CFIntMySqlISOCtryTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCtryId )
	{
		final String S_ProcName = "CFIntMySqlISOCtryTable.readDerivedByIdIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByISOCodeIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFIntMySqlISOCtryTable.readDerivedByISOCodeIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntMySqlISOCtryTable.readDerivedByNameIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
