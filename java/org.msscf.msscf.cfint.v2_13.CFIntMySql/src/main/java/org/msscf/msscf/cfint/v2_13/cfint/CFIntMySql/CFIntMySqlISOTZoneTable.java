...
/*
 *	CFIntMySqlISOTZoneTable MySQL Jdbc DbIO implementation
 *	for ISOTZone.
 */
public class CFIntMySqlISOTZoneTable
	implements ICFIntISOTZoneTable
{
	...
	public CFIntMySqlISOTZoneTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOTZoneBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOTZoneId )
	{
		final String S_ProcName = "CFIntMySqlISOTZoneTable.readDerivedByIdIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOTZoneBuff readDerivedByUTZNameIdx( CFSecAuthorization Authorization,
		String TZName )
	{
		final String S_ProcName = "CFIntMySqlISOTZoneTable.readDerivedByUTZNameIdx() ";
		CFSecISOTZoneBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
