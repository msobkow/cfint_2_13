// Description: Java 11 MySQL Jdbc DbIO implementation for MimeType.
...
/*
 *	CFIntMySqlMimeTypeTable MySQL Jdbc DbIO implementation
 *	for MimeType.
 */
public class CFIntMySqlMimeTypeTable
	implements ICFIntMimeTypeTable
{
	...
	public CFIntMySqlMimeTypeTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMimeTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int MimeTypeId )
	{
		final String S_ProcName = "CFIntMySqlMimeTypeTable.readDerivedByIdIdx() ";
		CFIntMimeTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMimeTypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntMySqlMimeTypeTable.readDerivedByUNameIdx() ";
		CFIntMimeTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
