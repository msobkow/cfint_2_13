...
/*
 *	CFIntMySqlSecAppTable MySQL Jdbc DbIO implementation
 *	for SecApp.
 */
public class CFIntMySqlSecAppTable
	implements ICFIntSecAppTable
{
	...
	public CFIntMySqlSecAppTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecAppBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecAppId )
	{
		final String S_ProcName = "CFIntMySqlSecAppTable.readDerivedByIdIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecAppBuff readDerivedByUJEEMountIdx( CFSecAuthorization Authorization,
		...
		String JEEMountName )
	{
		final String S_ProcName = "CFIntMySqlSecAppTable.readDerivedByUJEEMountIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
