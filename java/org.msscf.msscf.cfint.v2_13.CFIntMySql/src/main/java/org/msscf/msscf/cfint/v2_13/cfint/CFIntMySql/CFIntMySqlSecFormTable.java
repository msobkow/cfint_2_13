...
/*
 *	CFIntMySqlSecFormTable MySQL Jdbc DbIO implementation
 *	for SecForm.
 */
public class CFIntMySqlSecFormTable
	implements ICFIntSecFormTable
{
	...
	public CFIntMySqlSecFormTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFIntMySqlSecFormTable.readDerivedByIdIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	{
		final String S_ProcName = "CFIntMySqlSecFormTable.readDerivedByUJEEServletIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
