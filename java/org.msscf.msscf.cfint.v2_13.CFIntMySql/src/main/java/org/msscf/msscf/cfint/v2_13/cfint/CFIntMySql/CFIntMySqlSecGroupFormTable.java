...
/*
 *	CFIntMySqlSecGroupFormTable MySQL Jdbc DbIO implementation
 *	for SecGroupForm.
 */
public class CFIntMySqlSecGroupFormTable
	implements ICFIntSecGroupFormTable
{
	...
	public CFIntMySqlSecGroupFormTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGroupFormId )
	{
		final String S_ProcName = "CFIntMySqlSecGroupFormTable.readDerivedByIdIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupFormBuff readDerivedByUFormIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFIntMySqlSecGroupFormTable.readDerivedByUFormIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
