...
/*
 *	CFIntMySqlSecGroupTable MySQL Jdbc DbIO implementation
 *	for SecGroup.
 */
public class CFIntMySqlSecGroupTable
	implements ICFIntSecGroupTable
{
	...
	public CFIntMySqlSecGroupTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecGroupId )
	{
		final String S_ProcName = "CFIntMySqlSecGroupTable.readDerivedByIdIdx() ";
		CFSecSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntMySqlSecGroupTable.readDerivedByUNameIdx() ";
		CFSecSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
