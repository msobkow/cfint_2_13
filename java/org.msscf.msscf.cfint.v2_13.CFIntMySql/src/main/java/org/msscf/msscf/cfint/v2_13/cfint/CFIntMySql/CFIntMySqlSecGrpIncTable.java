...
/*
 *	CFIntMySqlSecGrpIncTable MySQL Jdbc DbIO implementation
 *	for SecGrpInc.
 */
public class CFIntMySqlSecGrpIncTable
	implements ICFIntSecGrpIncTable
{
	...
	public CFIntMySqlSecGrpIncTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpIncId )
	{
		final String S_ProcName = "CFIntMySqlSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFIntMySqlSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
