...
/*
 *	CFIntMySqlSecGrpMembTable MySQL Jdbc DbIO implementation
 *	for SecGrpMemb.
 */
public class CFIntMySqlSecGrpMembTable
	implements ICFIntSecGrpMembTable
{
	...
	public CFIntMySqlSecGrpMembTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpMembId )
	{
		final String S_ProcName = "CFIntMySqlSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFIntMySqlSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
