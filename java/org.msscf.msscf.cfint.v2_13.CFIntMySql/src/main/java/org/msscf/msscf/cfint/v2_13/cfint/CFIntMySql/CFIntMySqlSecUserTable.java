...
/*
 *	CFIntMySqlSecUserTable MySQL Jdbc DbIO implementation
 *	for SecUser.
 */
public class CFIntMySqlSecUserTable
	implements ICFIntSecUserTable
{
	...
	public CFIntMySqlSecUserTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	throws SQLException
	{
		...
		idxcol++;		buff.setRequiredSecUserId( CFIntMySqlSchema.convertUuidString( resultSet.getString( idxcol ) ) );
		idxcol++;
	...
	public CFSecSecUserBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		UUID SecUserId )
	{
		final String S_ProcName = "CFIntMySqlSecUserTable.readDerivedByIdIdx() ";
		CFSecSecUserBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecUserBuff readDerivedByULoginIdx( CFSecAuthorization Authorization,
		String LoginId )
	{
		final String S_ProcName = "CFIntMySqlSecUserTable.readDerivedByULoginIdx() ";
		CFSecSecUserBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
