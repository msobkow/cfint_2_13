...
/*
 *	CFIntMySqlServiceTypeTable MySQL Jdbc DbIO implementation
 *	for ServiceType.
 */
public class CFIntMySqlServiceTypeTable
	implements ICFIntServiceTypeTable
{
	...
	public CFIntMySqlServiceTypeTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int ServiceTypeId )
	{
		final String S_ProcName = "CFIntMySqlServiceTypeTable.readDerivedByIdIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceTypeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFIntMySqlServiceTypeTable.readDerivedByUDescrIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
