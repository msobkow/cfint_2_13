...
/*
 *	CFIntMySqlSysClusterTable MySQL Jdbc DbIO implementation
 *	for SysCluster.
 */
public class CFIntMySqlSysClusterTable
	implements ICFIntSysClusterTable
{
	...
	public CFIntMySqlSysClusterTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSysClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int SingletonId )
	{
		final String S_ProcName = "CFIntMySqlSysClusterTable.readDerivedByIdIdx() ";
		CFSecSysClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
