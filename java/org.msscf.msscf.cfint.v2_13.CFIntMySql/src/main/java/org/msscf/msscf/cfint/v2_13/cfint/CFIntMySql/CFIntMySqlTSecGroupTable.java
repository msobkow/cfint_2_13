...
/*
 *	CFIntMySqlTSecGroupTable MySQL Jdbc DbIO implementation
 *	for TSecGroup.
 */
public class CFIntMySqlTSecGroupTable
	implements ICFIntTSecGroupTable
{
	...
	public CFIntMySqlTSecGroupTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGroupBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int TSecGroupId )
	{
		final String S_ProcName = "CFIntMySqlTSecGroupTable.readDerivedByIdIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGroupBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntMySqlTSecGroupTable.readDerivedByUNameIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
