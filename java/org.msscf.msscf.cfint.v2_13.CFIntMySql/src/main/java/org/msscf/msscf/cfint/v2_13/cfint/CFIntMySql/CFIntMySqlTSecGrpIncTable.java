...
/*
 *	CFIntMySqlTSecGrpIncTable MySQL Jdbc DbIO implementation
 *	for TSecGrpInc.
 */
public class CFIntMySqlTSecGrpIncTable
	implements ICFIntTSecGrpIncTable
{
	...
	public CFIntMySqlTSecGrpIncTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpIncId )
	{
		final String S_ProcName = "CFIntMySqlTSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFIntMySqlTSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
