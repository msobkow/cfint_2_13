...
/*
 *	CFIntMySqlTSecGrpMembTable MySQL Jdbc DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFIntMySqlTSecGrpMembTable
	implements ICFIntTSecGrpMembTable
{
	...
	public CFIntMySqlTSecGrpMembTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpMembId )
	{
		final String S_ProcName = "CFIntMySqlTSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFIntMySqlTSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
