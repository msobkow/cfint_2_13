...
/*
 *	CFIntMySqlTenantTable MySQL Jdbc DbIO implementation
 *	for Tenant.
 */
public class CFIntMySqlTenantTable
	implements ICFIntTenantTable
{
	...
	public CFIntMySqlTenantTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecTenantPKey PKey )
	{
		...
		try {
			...
			if( stmtSelectNextMajorVersionIdGen == null ) {
				stmtSelectNextMajorVersionIdGen = cnx.prepareStatement( sqlSelectNextIdGen );
			}
			long nextId;
			int argIdx = 1;
			...
			if( ( rsSelect != null ) && rsSelect.next() ) {
				...
				throw new CFLibRuntimeException( getClass(),
					S_ProcName,
					"Expected 1 row to be returned by invoking " + schema.getLowerDbSchemaName() + ".sp_next_majorversionidgen()" );
			}
			return( nextId );
		}
		catch( SQLException e ) {
		...
		CFSecTenantPKey PKey )
	{
		...
		try {
			...
			if( stmtSelectNextMinorVersionIdGen == null ) {
				stmtSelectNextMinorVersionIdGen = cnx.prepareStatement( sqlSelectNextIdGen );
			}
			long nextId;
			int argIdx = 1;
			...
			if( ( rsSelect != null ) && rsSelect.next() ) {
				...
				throw new CFLibRuntimeException( getClass(),
					S_ProcName,
					"Expected 1 row to be returned by invoking " + schema.getLowerDbSchemaName() + ".sp_next_minorversionidgen()" );
			}
			return( nextId );
		}
		catch( SQLException e ) {
		...
		CFSecTenantPKey PKey )
	{
		...
		try {
			...
			if( stmtSelectNextSubProjectIdGen == null ) {
				stmtSelectNextSubProjectIdGen = cnx.prepareStatement( sqlSelectNextIdGen );
			}
			long nextId;
			int argIdx = 1;
			...
			if( ( rsSelect != null ) && rsSelect.next() ) {
				...
				throw new CFLibRuntimeException( getClass(),
					S_ProcName,
					"Expected 1 row to be returned by invoking " + schema.getLowerDbSchemaName() + ".sp_next_subprojectidgen()" );
			}
			return( nextId );
		}
		catch( SQLException e ) {
		...
		CFSecTenantPKey PKey )
	{
		...
		try {
			...
			if( stmtSelectNextTopDomainIdGen == null ) {
				stmtSelectNextTopDomainIdGen = cnx.prepareStatement( sqlSelectNextIdGen );
			}
			long nextId;
			int argIdx = 1;
			...
			if( ( rsSelect != null ) && rsSelect.next() ) {
				...
				throw new CFLibRuntimeException( getClass(),
					S_ProcName,
					"Expected 1 row to be returned by invoking " + schema.getLowerDbSchemaName() + ".sp_next_topdomainidgen()" );
			}
			return( nextId );
		}
		catch( SQLException e ) {
		...
		CFSecTenantPKey PKey )
	{
		...
		try {
			...
			if( stmtSelectNextTopProjectIdGen == null ) {
				stmtSelectNextTopProjectIdGen = cnx.prepareStatement( sqlSelectNextIdGen );
			}
			long nextId;
			int argIdx = 1;
			...
			if( ( rsSelect != null ) && rsSelect.next() ) {
				...
				throw new CFLibRuntimeException( getClass(),
					S_ProcName,
					"Expected 1 row to be returned by invoking " + schema.getLowerDbSchemaName() + ".sp_next_topprojectidgen()" );
			}
			return( nextId );
		}
		catch( SQLException e ) {
	...
	public CFSecTenantBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFIntMySqlTenantTable.readDerivedByIdIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTenantBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String TenantName )
	{
		final String S_ProcName = "CFIntMySqlTenantTable.readDerivedByUNameIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
