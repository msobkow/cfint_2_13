// Description: Java 11 MySQL Jdbc DbIO implementation for Tld.
...
/*
 *	CFIntMySqlTldTable MySQL Jdbc DbIO implementation
 *	for Tld.
 */
public class CFIntMySqlTldTable
	implements ICFIntTldTable
{
	...
	public CFIntMySqlTldTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTldBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntMySqlTldTable.readDerivedByIdIdx() ";
		CFIntTldBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTldBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntMySqlTldTable.readDerivedByNameIdx() ";
		CFIntTldBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
