// Description: Java 11 MySQL Jdbc DbIO implementation for TopDomain.
...
/*
 *	CFIntMySqlTopDomainTable MySQL Jdbc DbIO implementation
 *	for TopDomain.
 */
public class CFIntMySqlTopDomainTable
	implements ICFIntTopDomainTable
{
	...
	public CFIntMySqlTopDomainTable( CFIntMySqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTopDomainBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntMySqlTopDomainTable.readDerivedByIdIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTopDomainBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntMySqlTopDomainTable.readDerivedByNameIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
