...
/*
 *	CFIntPgSqlISOCtryLangTable PostgreSQL Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFIntPgSqlISOCtryLangTable
	implements ICFIntISOCtryLangTable
{
	...
	public CFIntPgSqlISOCtryLangTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFIntPgSqlISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
