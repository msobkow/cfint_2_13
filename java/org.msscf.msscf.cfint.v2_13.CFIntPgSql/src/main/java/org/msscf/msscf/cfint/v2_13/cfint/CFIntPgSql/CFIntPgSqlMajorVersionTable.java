...
/*
 *	CFIntPgSqlMajorVersionTable PostgreSQL Jdbc DbIO implementation
 *	for MajorVersion.
 */
public class CFIntPgSqlMajorVersionTable
	implements ICFIntMajorVersionTable
{
	...
	public CFIntPgSqlMajorVersionTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMajorVersionBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntPgSqlMajorVersionTable.readDerivedByIdIdx() ";
		CFIntMajorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMajorVersionBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlMajorVersionTable.readDerivedByNameIdx() ";
		CFIntMajorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
