...
/*
 *	CFIntPgSqlMimeTypeTable PostgreSQL Jdbc DbIO implementation
 *	for MimeType.
 */
public class CFIntPgSqlMimeTypeTable
	implements ICFIntMimeTypeTable
{
	...
	public CFIntPgSqlMimeTypeTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMimeTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int MimeTypeId )
	{
		final String S_ProcName = "CFIntPgSqlMimeTypeTable.readDerivedByIdIdx() ";
		CFIntMimeTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMimeTypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlMimeTypeTable.readDerivedByUNameIdx() ";
		CFIntMimeTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
