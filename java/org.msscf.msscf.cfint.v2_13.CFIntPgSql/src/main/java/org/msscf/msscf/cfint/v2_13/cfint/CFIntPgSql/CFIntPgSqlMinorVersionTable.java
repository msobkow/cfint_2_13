...
/*
 *	CFIntPgSqlMinorVersionTable PostgreSQL Jdbc DbIO implementation
 *	for MinorVersion.
 */
public class CFIntPgSqlMinorVersionTable
	implements ICFIntMinorVersionTable
{
	...
	public CFIntPgSqlMinorVersionTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMinorVersionBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntPgSqlMinorVersionTable.readDerivedByIdIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMinorVersionBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlMinorVersionTable.readDerivedByNameIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
