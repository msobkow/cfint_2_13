...
/*
 *	CFIntPgSqlSecAppTable PostgreSQL Jdbc DbIO implementation
 *	for SecApp.
 */
public class CFIntPgSqlSecAppTable
	implements ICFIntSecAppTable
{
	...
	public CFIntPgSqlSecAppTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecAppBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecAppId )
	{
		final String S_ProcName = "CFIntPgSqlSecAppTable.readDerivedByIdIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecAppBuff readDerivedByUJEEMountIdx( CFSecAuthorization Authorization,
		...
		String JEEMountName )
	{
		final String S_ProcName = "CFIntPgSqlSecAppTable.readDerivedByUJEEMountIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
