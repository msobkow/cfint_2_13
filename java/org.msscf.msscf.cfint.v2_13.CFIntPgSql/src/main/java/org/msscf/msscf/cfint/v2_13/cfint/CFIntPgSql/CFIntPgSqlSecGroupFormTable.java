...
/*
 *	CFIntPgSqlSecGroupFormTable PostgreSQL Jdbc DbIO implementation
 *	for SecGroupForm.
 */
public class CFIntPgSqlSecGroupFormTable
	implements ICFIntSecGroupFormTable
{
	...
	public CFIntPgSqlSecGroupFormTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGroupFormId )
	{
		final String S_ProcName = "CFIntPgSqlSecGroupFormTable.readDerivedByIdIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupFormBuff readDerivedByUFormIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFIntPgSqlSecGroupFormTable.readDerivedByUFormIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
