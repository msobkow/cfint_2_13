...
/*
 *	CFIntPgSqlSecUserTable PostgreSQL Jdbc DbIO implementation
 *	for SecUser.
 */
public class CFIntPgSqlSecUserTable
	implements ICFIntSecUserTable
{
	...
	public CFIntPgSqlSecUserTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecUserBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		UUID SecUserId )
	{
		final String S_ProcName = "CFIntPgSqlSecUserTable.readDerivedByIdIdx() ";
		CFSecSecUserBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecUserBuff readDerivedByULoginIdx( CFSecAuthorization Authorization,
		String LoginId )
	{
		final String S_ProcName = "CFIntPgSqlSecUserTable.readDerivedByULoginIdx() ";
		CFSecSecUserBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
