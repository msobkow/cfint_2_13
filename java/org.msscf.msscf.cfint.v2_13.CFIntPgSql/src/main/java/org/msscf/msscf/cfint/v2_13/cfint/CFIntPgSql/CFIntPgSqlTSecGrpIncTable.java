...
/*
 *	CFIntPgSqlTSecGrpIncTable PostgreSQL Jdbc DbIO implementation
 *	for TSecGrpInc.
 */
public class CFIntPgSqlTSecGrpIncTable
	implements ICFIntTSecGrpIncTable
{
	...
	public CFIntPgSqlTSecGrpIncTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpIncId )
	{
		final String S_ProcName = "CFIntPgSqlTSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFIntPgSqlTSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
