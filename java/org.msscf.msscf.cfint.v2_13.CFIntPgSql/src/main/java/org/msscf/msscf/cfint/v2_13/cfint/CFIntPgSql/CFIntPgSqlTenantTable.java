...
/*
 *	CFIntPgSqlTenantTable PostgreSQL Jdbc DbIO implementation
 *	for Tenant.
 */
public class CFIntPgSqlTenantTable
	implements ICFIntTenantTable
{
	...
	public CFIntPgSqlTenantTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTenantBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFIntPgSqlTenantTable.readDerivedByIdIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTenantBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String TenantName )
	{
		final String S_ProcName = "CFIntPgSqlTenantTable.readDerivedByUNameIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
