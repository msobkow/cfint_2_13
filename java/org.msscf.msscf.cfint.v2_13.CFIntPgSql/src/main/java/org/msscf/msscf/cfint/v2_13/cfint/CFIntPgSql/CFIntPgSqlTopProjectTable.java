...
/*
 *	CFIntPgSqlTopProjectTable PostgreSQL Jdbc DbIO implementation
 *	for TopProject.
 */
public class CFIntPgSqlTopProjectTable
	implements ICFIntTopProjectTable
{
	...
	public CFIntPgSqlTopProjectTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTopProjectBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntPgSqlTopProjectTable.readDerivedByIdIdx() ";
		CFIntTopProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTopProjectBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlTopProjectTable.readDerivedByNameIdx() ";
		CFIntTopProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
