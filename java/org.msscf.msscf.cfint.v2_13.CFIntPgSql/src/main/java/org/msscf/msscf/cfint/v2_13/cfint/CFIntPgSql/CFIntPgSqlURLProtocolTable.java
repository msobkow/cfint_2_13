...
/*
 *	CFIntPgSqlURLProtocolTable PostgreSQL Jdbc DbIO implementation
 *	for URLProtocol.
 */
public class CFIntPgSqlURLProtocolTable
	implements ICFIntURLProtocolTable
{
	...
	public CFIntPgSqlURLProtocolTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntURLProtocolBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int URLProtocolId )
	{
		final String S_ProcName = "CFIntPgSqlURLProtocolTable.readDerivedByIdIdx() ";
		CFIntURLProtocolBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntURLProtocolBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlURLProtocolTable.readDerivedByUNameIdx() ";
		CFIntURLProtocolBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
