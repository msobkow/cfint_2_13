 ...
 */
@WebServlet("/CFIntSMWarConfirmEMailAddressHtml")
public class CFIntSMWarConfirmEMailAddressHtml extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CFIntSMWarConfirmEMailAddressHtml() {
		super();
	}
