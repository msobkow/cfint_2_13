...
/**
 * Servlet implementation class CFIntSMWarRequestResetPasswordHtml
 */
@WebServlet("/CFIntSMWarRequestResetPasswordHtml")
public class CFIntSMWarRequestResetPasswordHtml extends HttpServlet {
	 ...
	 */
	public CFIntSMWarRequestResetPasswordHtml() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.println( "<HTML>" );
			out.println( "<BODY>" );
			out.println( "<form method=\"post\" formaction=\"CFIntSMWarRequestResetPasswordHtml\">" );
