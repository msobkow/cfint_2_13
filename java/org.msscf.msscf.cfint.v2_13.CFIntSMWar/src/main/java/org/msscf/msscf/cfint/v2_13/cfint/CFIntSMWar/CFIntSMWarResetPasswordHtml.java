...
/**
 * Servlet implementation class CFIntSMWarResetPasswordHtml
 */
@WebServlet("/CFIntSMWarResetPasswordHtml")
public class CFIntSMWarResetPasswordHtml extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CFIntSMWarResetPasswordHtml() {
		super();
	}
