...
// Description: Java 11 XML Message message formatter for CFInt.SecApp
...
/*
 *	CFIntXMsgSecAppMessageFormatter XML message formatter
 *	for CFInt.SecApp.
 */
public class CFIntXMsgSecAppMessageFormatter
{
	public CFIntXMsgSecAppMessageFormatter() {
	}
	...
	public static String formatSecAppBuffAttributes( String separator, CFSecSecAppBuff buff ) {
		String retval = CFIntXMsgSecAppMessageFormatter.formatSecAppPKeyAttributes( separator, buff )
			+	CFLibXmlUtil.formatRequiredInt32( separator,
					"Revision",
