...
// Description: Java 11 XML Message message formatter for CFInt.SecGroupForm
...
/*
 *	CFIntXMsgSecGroupFormMessageFormatter XML message formatter
 *	for CFInt.SecGroupForm.
 */
public class CFIntXMsgSecGroupFormMessageFormatter
{
	public CFIntXMsgSecGroupFormMessageFormatter() {
	}
	...
	public static String formatSecGroupFormBuffAttributes( String separator, CFSecSecGroupFormBuff buff ) {
		String retval = CFIntXMsgSecGroupFormMessageFormatter.formatSecGroupFormPKeyAttributes( separator, buff )
