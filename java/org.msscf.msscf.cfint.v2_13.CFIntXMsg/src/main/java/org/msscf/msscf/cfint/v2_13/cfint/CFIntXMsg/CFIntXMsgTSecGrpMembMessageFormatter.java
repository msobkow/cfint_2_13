...
// Description: Java 11 XML Message message formatter for CFInt.TSecGrpMemb
...
/*
 *	CFIntXMsgTSecGrpMembMessageFormatter XML message formatter
 *	for CFInt.TSecGrpMemb.
 */
public class CFIntXMsgTSecGrpMembMessageFormatter
{
	public CFIntXMsgTSecGrpMembMessageFormatter() {
	}
	...
	public static String formatTSecGrpMembBuffAttributes( String separator, CFSecTSecGrpMembBuff buff ) {
		String retval = CFIntXMsgTSecGrpMembMessageFormatter.formatTSecGrpMembPKeyAttributes( separator, buff )
