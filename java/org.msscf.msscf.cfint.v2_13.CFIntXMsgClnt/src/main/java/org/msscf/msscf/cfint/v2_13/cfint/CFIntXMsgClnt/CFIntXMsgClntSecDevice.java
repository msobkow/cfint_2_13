...
/*
 *	CFIntXMsgClntSecDevice XMsg Client DbIO implementation
 *	for SecDevice.
 */
public class CFIntXMsgClntSecDevice
	implements ICFIntSecDeviceTable
{
	private CFIntXMsgClntSchema schema;

	public CFIntXMsgClntSecDevice( CFIntXMsgClntSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecSecDeviceBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstCreate( "\n\t\t\t", Buff )
			+	"\n"
		...
		if( lastObjectProcessed != null ) {
			ICFIntSecDeviceObj realised = null;
			if( lastObjectProcessed instanceof ICFIntSecDeviceObj ) {
				realised = (ICFIntSecDeviceObj)lastObjectProcessed;
			}
			else {
		...
		CFSecSecDevicePKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstRead( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecSecDevicePKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstLock( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
	...
	public CFSecSecDeviceBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstReadAll( "\n\t\t\t" )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		String argDevName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstRdByIdIdx( "\n\t\t\t",
							argSecUserId,
							argDevName )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		String argDevName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstRdByNameIdx( "\n\t\t\t",
							argSecUserId,
							argDevName )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		UUID argSecUserId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstRdByUserIdx( "\n\t\t\t",
							argSecUserId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		String priorDevName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstPageAll( "\n\t\t\t",
							priorSecUserId,
							priorDevName )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		String priorDevName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstPageByUserIdx( "\n\t\t\t",
						SecUserId,
							priorSecUserId,
							priorDevName )
			+	"\n"
		...
		CFSecSecDeviceBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstUpdate( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecSecDeviceBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstDelete( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		String argDevName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstDelByIdIdx( "\n\t\t\t",
							argSecUserId,
							argDevName )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		String argDevName )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstDelByNameIdx( "\n\t\t\t",
							argSecUserId,
							argDevName )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		UUID argSecUserId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgSecDeviceMessageFormatter.formatSecDeviceRqstDelByUserIdx( "\n\t\t\t",
							argSecUserId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
