...
/*
 *	CFIntXMsgClntTSecGrpInc XMsg Client DbIO implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgClntTSecGrpInc
	implements ICFIntTSecGrpIncTable
{
	private CFIntXMsgClntSchema schema;

	public CFIntXMsgClntTSecGrpInc( CFIntXMsgClntSchema argSchema ) {
		schema = argSchema;
	}
		...
		CFSecTSecGrpIncBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstCreate( "\n\t\t\t", Buff )
			+	"\n"
		...
		if( lastObjectProcessed != null ) {
			ICFIntTSecGrpIncObj realised = null;
			if( lastObjectProcessed instanceof ICFIntTSecGrpIncObj ) {
				realised = (ICFIntTSecGrpIncObj)lastObjectProcessed;
			}
			else {
		...
		CFSecTSecGrpIncPKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstRead( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecTSecGrpIncPKey PKey )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstLock( "\n\t\t\t", PKey )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
	...
	public CFSecTSecGrpIncBuff[] readAllDerived( CFSecAuthorization Authorization ) {
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstReadAll( "\n\t\t\t" )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		long argTSecGrpIncId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstRdByIdIdx( "\n\t\t\t",
							argTenantId,
							argTSecGrpIncId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		long argTenantId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstRdByTenantIdx( "\n\t\t\t",
							argTenantId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		int argTSecGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstRdByGroupIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		int argIncludeGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstRdByIncludeIdx( "\n\t\t\t",
							argTenantId,
							argIncludeGroupId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		int argIncludeGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstRdByUIncludeIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId,
							argIncludeGroupId )
			+	"\n"
		...
		Long priorTSecGrpIncId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstPageAll( "\n\t\t\t",
							priorTenantId,
							priorTSecGrpIncId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		Long priorTSecGrpIncId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstPageByTenantIdx( "\n\t\t\t",
						TenantId,
							priorTenantId,
							priorTSecGrpIncId )
			+	"\n"
		...
		Long priorTSecGrpIncId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstPageByGroupIdx( "\n\t\t\t",
						TenantId,
						TSecGroupId,
							priorTenantId,
							priorTSecGrpIncId )
		...
		Long priorTSecGrpIncId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstPageByIncludeIdx( "\n\t\t\t",
						TenantId,
						IncludeGroupId,
							priorTenantId,
							priorTSecGrpIncId )
		...
		CFSecTSecGrpIncBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstUpdate( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		CFSecTSecGrpIncBuff Buff )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstDelete( "\n\t\t\t", Buff )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
			schema.getCFTipClientHandler().issueAppRequest( rqst );
		...
		long argTSecGrpIncId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstDelByIdIdx( "\n\t\t\t",
							argTenantId,
							argTSecGrpIncId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		long argTenantId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstDelByTenantIdx( "\n\t\t\t",
							argTenantId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		try {
		...
		int argTSecGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstDelByGroupIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		int argIncludeGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstDelByIncludeIdx( "\n\t\t\t",
							argTenantId,
							argIncludeGroupId )
			+	"\n"
			+	CFIntXMsgSchemaMessageFormatter.formatRqstXmlPostamble();
		...
		int argIncludeGroupId )
	{
		...
		String rqst = CFIntXMsgSchemaMessageFormatter.formatRqstXmlPreamble() + "\n"
			+	"\t" + CFIntXMsgTSecGrpIncMessageFormatter.formatTSecGrpIncRqstDelByUIncludeIdx( "\n\t\t\t",
							argTenantId,
							argTSecGroupId,
							argIncludeGroupId )
			+	"\n"
