...
/*
 *	CFIntXMsgRspnHostNodeCreated XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRspnHostNodeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnHostNodeCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntHostNodeObj obj = (ICFIntHostNodeObj)schemaObj.getHostNodeTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntHostNodeObj realised = (ICFIntHostNodeObj)obj.realise();
