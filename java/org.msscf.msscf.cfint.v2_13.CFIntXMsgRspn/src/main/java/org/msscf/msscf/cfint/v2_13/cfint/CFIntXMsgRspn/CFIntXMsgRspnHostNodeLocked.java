...
/*
 *	CFIntXMsgRspnHostNodeLocked XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRspnHostNodeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnHostNodeLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
