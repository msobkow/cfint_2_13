...
/*
 *	CFIntXMsgRspnHostNodeReadList XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRspnHostNodeReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnHostNodeReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
