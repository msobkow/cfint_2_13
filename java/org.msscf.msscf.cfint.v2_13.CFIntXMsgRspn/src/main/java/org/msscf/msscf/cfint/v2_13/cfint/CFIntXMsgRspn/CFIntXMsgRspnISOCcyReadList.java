...
/*
 *	CFIntXMsgRspnISOCcyReadList XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRspnISOCcyReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCcyReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
