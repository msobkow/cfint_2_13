...
/*
 *	CFIntXMsgRspnISOCcyUpdated XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRspnISOCcyUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCcyUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			obj.copyBuffToPKey();
			ICFIntISOCcyObj realised = (ICFIntISOCcyObj)obj.realise();
