...
/*
 *	CFIntXMsgRspnISOCtryCreated XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFIntXMsgRspnISOCtryCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCtryCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntISOCtryObj obj = (ICFIntISOCtryObj)schemaObj.getISOCtryTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntISOCtryObj realised = (ICFIntISOCtryObj)obj.realise();
