...
/*
 *	CFIntXMsgRspnISOCtryLangCreated XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRspnISOCtryLangCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCtryLangCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntISOCtryLangObj obj = (ICFIntISOCtryLangObj)schemaObj.getISOCtryLangTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntISOCtryLangObj realised = (ICFIntISOCtryLangObj)obj.realise();
