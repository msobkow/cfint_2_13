...
/*
 *	CFIntXMsgRspnISOLangReadList XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFIntXMsgRspnISOLangReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOLangReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
