...
/*
 *	CFIntXMsgRspnLicenseCreated XML SAX Element  implementation
 *	for License.
 */
public class CFIntXMsgRspnLicenseCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnLicenseCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
