...
/*
 *	CFIntXMsgRspnLicenseLocked XML SAX Element  implementation
 *	for License.
 */
public class CFIntXMsgRspnLicenseLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnLicenseLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
