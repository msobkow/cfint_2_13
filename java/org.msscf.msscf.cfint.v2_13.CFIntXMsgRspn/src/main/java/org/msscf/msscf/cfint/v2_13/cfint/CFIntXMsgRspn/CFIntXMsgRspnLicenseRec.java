...
/*
 *	CFIntXMsgRspnLicenseRec XML SAX Element  implementation
 *	for License.
 */
public class CFIntXMsgRspnLicenseRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnLicenseRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			List<ICFIntLicenseObj> list =
				(List<ICFIntLicenseObj>)xmsgRspn.getListOfObjects();
