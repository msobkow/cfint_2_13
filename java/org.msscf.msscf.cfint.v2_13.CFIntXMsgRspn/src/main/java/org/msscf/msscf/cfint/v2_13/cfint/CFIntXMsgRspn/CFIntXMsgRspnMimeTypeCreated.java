...
/*
 *	CFIntXMsgRspnMimeTypeCreated XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRspnMimeTypeCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnMimeTypeCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
