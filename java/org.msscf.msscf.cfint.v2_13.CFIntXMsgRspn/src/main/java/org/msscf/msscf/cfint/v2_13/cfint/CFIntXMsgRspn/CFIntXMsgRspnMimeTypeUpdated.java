...
/*
 *	CFIntXMsgRspnMimeTypeUpdated XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRspnMimeTypeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnMimeTypeUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
