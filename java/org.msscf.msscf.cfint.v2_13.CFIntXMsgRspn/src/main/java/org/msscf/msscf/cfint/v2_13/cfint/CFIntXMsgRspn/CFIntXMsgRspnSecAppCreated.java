...
/*
 *	CFIntXMsgRspnSecAppCreated XML SAX Element  implementation
 *	for SecApp.
 */
public class CFIntXMsgRspnSecAppCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecAppCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntSecAppObj obj = (ICFIntSecAppObj)schemaObj.getSecAppTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntSecAppObj realised = (ICFIntSecAppObj)obj.realise();
