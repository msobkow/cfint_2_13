...
/*
 *	CFIntXMsgRspnSecDeviceUpdated XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRspnSecDeviceUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecDeviceUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntSecDeviceObj obj = (ICFIntSecDeviceObj)schemaObj.getSecDeviceTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntSecDeviceObj realised = (ICFIntSecDeviceObj)obj.realise();
