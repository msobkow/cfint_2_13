...
/*
 *	CFIntXMsgRspnSecFormCreated XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRspnSecFormCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecFormCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
