...
/*
 *	CFIntXMsgRspnSecFormLocked XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRspnSecFormLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecFormLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
