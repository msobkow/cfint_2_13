...
/*
 *	CFIntXMsgRspnSecFormUpdated XML SAX Element  implementation
 *	for SecForm.
 */
public class CFIntXMsgRspnSecFormUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecFormUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntSecFormObj obj = (ICFIntSecFormObj)schemaObj.getSecFormTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntSecFormObj realised = (ICFIntSecFormObj)obj.realise();
