...
/*
 *	CFIntXMsgRspnSecGroupCreated XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRspnSecGroupCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGroupCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntSecGroupObj obj = (ICFIntSecGroupObj)schemaObj.getSecGroupTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntSecGroupObj realised = (ICFIntSecGroupObj)obj.realise();
