...
/*
 *	CFIntXMsgRspnSecGroupFormRec XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRspnSecGroupFormRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGroupFormRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
