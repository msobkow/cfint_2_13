...
/*
 *	CFIntXMsgRspnSecGroupLocked XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRspnSecGroupLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGroupLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
