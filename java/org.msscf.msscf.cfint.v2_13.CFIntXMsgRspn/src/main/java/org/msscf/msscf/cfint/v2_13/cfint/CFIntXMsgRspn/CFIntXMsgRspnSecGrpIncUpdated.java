...
/*
 *	CFIntXMsgRspnSecGrpIncUpdated XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFIntXMsgRspnSecGrpIncUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGrpIncUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntSecGrpIncObj obj = (ICFIntSecGrpIncObj)schemaObj.getSecGrpIncTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntSecGrpIncObj realised = (ICFIntSecGrpIncObj)obj.realise();
