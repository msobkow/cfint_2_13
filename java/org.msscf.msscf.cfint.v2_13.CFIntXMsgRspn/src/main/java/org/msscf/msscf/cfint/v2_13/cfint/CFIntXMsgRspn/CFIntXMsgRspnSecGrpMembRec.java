...
/*
 *	CFIntXMsgRspnSecGrpMembRec XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFIntXMsgRspnSecGrpMembRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGrpMembRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
