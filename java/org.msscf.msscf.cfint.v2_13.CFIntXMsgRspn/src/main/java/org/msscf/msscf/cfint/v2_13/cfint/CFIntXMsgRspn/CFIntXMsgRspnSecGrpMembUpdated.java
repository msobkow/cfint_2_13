...
/*
 *	CFIntXMsgRspnSecGrpMembUpdated XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFIntXMsgRspnSecGrpMembUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGrpMembUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntSecGrpMembObj obj = (ICFIntSecGrpMembObj)schemaObj.getSecGrpMembTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntSecGrpMembObj realised = (ICFIntSecGrpMembObj)obj.realise();
