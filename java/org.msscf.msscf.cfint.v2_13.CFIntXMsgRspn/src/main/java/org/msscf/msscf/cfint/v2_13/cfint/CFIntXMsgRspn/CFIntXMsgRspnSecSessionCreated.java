...
/*
 *	CFIntXMsgRspnSecSessionCreated XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRspnSecSessionCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecSessionCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
