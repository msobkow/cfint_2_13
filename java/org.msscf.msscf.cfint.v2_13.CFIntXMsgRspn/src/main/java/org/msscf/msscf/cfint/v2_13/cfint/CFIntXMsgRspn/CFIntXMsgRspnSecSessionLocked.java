...
/*
 *	CFIntXMsgRspnSecSessionLocked XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRspnSecSessionLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecSessionLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
