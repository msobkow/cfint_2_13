...
/*
 *	CFIntXMsgRspnSecSessionRec XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRspnSecSessionRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecSessionRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
