...
/*
 *	CFIntXMsgRspnSecSessionUpdated XML SAX Element  implementation
 *	for SecSession.
 */
public class CFIntXMsgRspnSecSessionUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecSessionUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntSecSessionObj obj = (ICFIntSecSessionObj)schemaObj.getSecSessionTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntSecSessionObj realised = (ICFIntSecSessionObj)obj.realise();
