...
/*
 *	CFIntXMsgRspnSecUserCreated XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRspnSecUserCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecUserCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			obj.copyBuffToPKey();
			ICFIntSecUserObj realised = (ICFIntSecUserObj)obj.realise();
