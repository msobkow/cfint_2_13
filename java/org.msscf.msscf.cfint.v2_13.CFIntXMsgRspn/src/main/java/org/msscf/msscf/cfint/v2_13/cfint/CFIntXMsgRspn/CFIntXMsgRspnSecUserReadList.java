...
/*
 *	CFIntXMsgRspnSecUserReadList XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRspnSecUserReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecUserReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
