...
/*
 *	CFIntXMsgRspnSecUserUpdated XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRspnSecUserUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecUserUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
