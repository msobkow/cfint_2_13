...
/*
 *	CFIntXMsgRspnServiceLocked XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRspnServiceLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnServiceLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
