...
/*
 *	CFIntXMsgRspnSubProjectCreated XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRspnSubProjectCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSubProjectCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
