...
/*
 *	CFIntXMsgRspnSubProjectLocked XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRspnSubProjectLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSubProjectLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
