...
/*
 *	CFIntXMsgRspnSubProjectUpdated XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRspnSubProjectUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSubProjectUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
