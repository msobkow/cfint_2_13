...
/*
 *	CFIntXMsgRspnSysClusterCreated XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFIntXMsgRspnSysClusterCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSysClusterCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			obj.copyBuffToPKey();
			ICFIntSysClusterObj realised = (ICFIntSysClusterObj)obj.realise();
