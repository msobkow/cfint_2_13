...
/*
 *	CFIntXMsgRspnTSecGroupCreated XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRspnTSecGroupCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTSecGroupCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
