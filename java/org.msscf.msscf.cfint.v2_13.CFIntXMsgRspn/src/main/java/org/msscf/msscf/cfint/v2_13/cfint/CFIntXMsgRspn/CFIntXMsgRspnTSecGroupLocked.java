...
/*
 *	CFIntXMsgRspnTSecGroupLocked XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRspnTSecGroupLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTSecGroupLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
