...
/*
 *	CFIntXMsgRspnTSecGrpMembRec XML SAX Element  implementation
 *	for TSecGrpMemb.
 */
public class CFIntXMsgRspnTSecGrpMembRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTSecGrpMembRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
