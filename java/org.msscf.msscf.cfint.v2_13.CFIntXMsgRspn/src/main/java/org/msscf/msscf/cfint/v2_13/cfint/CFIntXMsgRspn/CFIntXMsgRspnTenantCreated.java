...
/*
 *	CFIntXMsgRspnTenantCreated XML SAX Element  implementation
 *	for Tenant.
 */
public class CFIntXMsgRspnTenantCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTenantCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntTenantObj obj = (ICFIntTenantObj)schemaObj.getTenantTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntTenantObj realised = (ICFIntTenantObj)obj.realise();
