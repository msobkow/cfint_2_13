...
/*
 *	CFIntXMsgRspnTenantUpdated XML SAX Element  implementation
 *	for Tenant.
 */
public class CFIntXMsgRspnTenantUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTenantUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
