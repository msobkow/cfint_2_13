...
/*
 *	CFIntXMsgRspnTopDomainCreated XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFIntXMsgRspnTopDomainCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTopDomainCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
