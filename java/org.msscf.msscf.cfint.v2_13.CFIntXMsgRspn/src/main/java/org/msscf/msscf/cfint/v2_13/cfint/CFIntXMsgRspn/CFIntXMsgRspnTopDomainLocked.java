...
/*
 *	CFIntXMsgRspnTopDomainLocked XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFIntXMsgRspnTopDomainLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTopDomainLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
