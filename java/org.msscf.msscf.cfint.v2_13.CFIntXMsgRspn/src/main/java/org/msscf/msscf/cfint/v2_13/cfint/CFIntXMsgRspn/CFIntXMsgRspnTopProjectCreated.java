...
/*
 *	CFIntXMsgRspnTopProjectCreated XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRspnTopProjectCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTopProjectCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
