...
/*
 *	CFIntXMsgRspnTopProjectLocked XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRspnTopProjectLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTopProjectLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
