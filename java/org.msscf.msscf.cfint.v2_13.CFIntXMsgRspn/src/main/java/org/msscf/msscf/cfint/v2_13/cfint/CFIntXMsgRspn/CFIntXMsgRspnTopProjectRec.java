...
/*
 *	CFIntXMsgRspnTopProjectRec XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRspnTopProjectRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTopProjectRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
