...
/*
 *	CFIntXMsgRspnURLProtocolCreated XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRspnURLProtocolCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnURLProtocolCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
