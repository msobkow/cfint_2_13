...
/*
 *	CFIntDb2LUWISOCtryCcyTable DB/2 LUW Jdbc DbIO implementation
 *	for ISOCtryCcy.
 */
public class CFIntDb2LUWISOCtryCcyTable
	implements ICFIntISOCtryCcyTable
{
	...
	public CFIntDb2LUWISOCtryCcyTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryCcyBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOCcyId )
	{
		final String S_ProcName = "CFIntDb2LUWISOCtryCcyTable.readDerivedByIdIdx() ";
		CFSecISOCtryCcyBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
