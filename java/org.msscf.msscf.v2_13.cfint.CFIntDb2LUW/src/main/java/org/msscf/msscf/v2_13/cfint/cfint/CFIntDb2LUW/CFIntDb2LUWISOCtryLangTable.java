...
/*
 *	CFIntDb2LUWISOCtryLangTable DB/2 LUW Jdbc DbIO implementation
 *	for ISOCtryLang.
 */
public class CFIntDb2LUWISOCtryLangTable
	implements ICFIntISOCtryLangTable
{
	...
	public CFIntDb2LUWISOCtryLangTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryLangBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		short ISOLangId )
	{
		final String S_ProcName = "CFIntDb2LUWISOCtryLangTable.readDerivedByIdIdx() ";
		CFSecISOCtryLangBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
