...
/*
 *	CFIntDb2LUWISOCtryTable DB/2 LUW Jdbc DbIO implementation
 *	for ISOCtry.
 */
public class CFIntDb2LUWISOCtryTable
	implements ICFIntISOCtryTable
{
	...
	public CFIntDb2LUWISOCtryTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecISOCtryBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		short ISOCtryId )
	{
		final String S_ProcName = "CFIntDb2LUWISOCtryTable.readDerivedByIdIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByISOCodeIdx( CFSecAuthorization Authorization,
		String ISOCode )
	{
		final String S_ProcName = "CFIntDb2LUWISOCtryTable.readDerivedByISOCodeIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecISOCtryBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWISOCtryTable.readDerivedByNameIdx() ";
		CFSecISOCtryBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
