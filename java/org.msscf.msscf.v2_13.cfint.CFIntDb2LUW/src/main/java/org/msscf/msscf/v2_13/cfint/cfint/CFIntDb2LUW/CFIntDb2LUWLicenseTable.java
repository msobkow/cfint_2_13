// Description: Java 11 DB/2 LUW Jdbc DbIO implementation for License.
...
/*
 *	CFIntDb2LUWLicenseTable DB/2 LUW Jdbc DbIO implementation
 *	for License.
 */
public class CFIntDb2LUWLicenseTable
	implements ICFIntLicenseTable
{
	...
	public CFIntDb2LUWLicenseTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntLicenseBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWLicenseTable.readDerivedByIdIdx() ";
		CFIntLicenseBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntLicenseBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWLicenseTable.readDerivedByUNameIdx() ";
		CFIntLicenseBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
