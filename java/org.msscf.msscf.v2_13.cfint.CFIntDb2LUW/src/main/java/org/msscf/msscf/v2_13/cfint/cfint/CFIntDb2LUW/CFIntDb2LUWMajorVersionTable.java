...
/*
 *	CFIntDb2LUWMajorVersionTable DB/2 LUW Jdbc DbIO implementation
 *	for MajorVersion.
 */
public class CFIntDb2LUWMajorVersionTable
	implements ICFIntMajorVersionTable
{
	...
	public CFIntDb2LUWMajorVersionTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMajorVersionBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWMajorVersionTable.readDerivedByIdIdx() ";
		CFIntMajorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMajorVersionBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWMajorVersionTable.readDerivedByNameIdx() ";
		CFIntMajorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
