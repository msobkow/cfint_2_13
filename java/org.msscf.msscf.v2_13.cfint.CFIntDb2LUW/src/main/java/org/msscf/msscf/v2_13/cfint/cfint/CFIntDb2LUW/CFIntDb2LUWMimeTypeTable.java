...
/*
 *	CFIntDb2LUWMimeTypeTable DB/2 LUW Jdbc DbIO implementation
 *	for MimeType.
 */
public class CFIntDb2LUWMimeTypeTable
	implements ICFIntMimeTypeTable
{
	...
	public CFIntDb2LUWMimeTypeTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMimeTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int MimeTypeId )
	{
		final String S_ProcName = "CFIntDb2LUWMimeTypeTable.readDerivedByIdIdx() ";
		CFIntMimeTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMimeTypeBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWMimeTypeTable.readDerivedByUNameIdx() ";
		CFIntMimeTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
