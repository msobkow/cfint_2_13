...
/*
 *	CFIntDb2LUWMinorVersionTable DB/2 LUW Jdbc DbIO implementation
 *	for MinorVersion.
 */
public class CFIntDb2LUWMinorVersionTable
	implements ICFIntMinorVersionTable
{
	...
	public CFIntDb2LUWMinorVersionTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMinorVersionBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWMinorVersionTable.readDerivedByIdIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMinorVersionBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWMinorVersionTable.readDerivedByNameIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
