...
/*
 *	CFIntDb2LUWSecAppTable DB/2 LUW Jdbc DbIO implementation
 *	for SecApp.
 */
public class CFIntDb2LUWSecAppTable
	implements ICFIntSecAppTable
{
	...
	public CFIntDb2LUWSecAppTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecAppBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecAppId )
	{
		final String S_ProcName = "CFIntDb2LUWSecAppTable.readDerivedByIdIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecAppBuff readDerivedByUJEEMountIdx( CFSecAuthorization Authorization,
		...
		String JEEMountName )
	{
		final String S_ProcName = "CFIntDb2LUWSecAppTable.readDerivedByUJEEMountIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
