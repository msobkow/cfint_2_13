...
/*
 *	CFIntDb2LUWSecDeviceTable DB/2 LUW Jdbc DbIO implementation
 *	for SecDevice.
 */
public class CFIntDb2LUWSecDeviceTable
	implements ICFIntSecDeviceTable
{
	...
	public CFIntDb2LUWSecDeviceTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecDeviceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFIntDb2LUWSecDeviceTable.readDerivedByIdIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecDeviceBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFIntDb2LUWSecDeviceTable.readDerivedByNameIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
