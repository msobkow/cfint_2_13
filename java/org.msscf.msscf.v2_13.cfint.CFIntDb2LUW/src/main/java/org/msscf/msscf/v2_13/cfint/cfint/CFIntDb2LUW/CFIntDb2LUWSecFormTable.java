...
/*
 *	CFIntDb2LUWSecFormTable DB/2 LUW Jdbc DbIO implementation
 *	for SecForm.
 */
public class CFIntDb2LUWSecFormTable
	implements ICFIntSecFormTable
{
	...
	public CFIntDb2LUWSecFormTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFIntDb2LUWSecFormTable.readDerivedByIdIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	{
		final String S_ProcName = "CFIntDb2LUWSecFormTable.readDerivedByUJEEServletIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
