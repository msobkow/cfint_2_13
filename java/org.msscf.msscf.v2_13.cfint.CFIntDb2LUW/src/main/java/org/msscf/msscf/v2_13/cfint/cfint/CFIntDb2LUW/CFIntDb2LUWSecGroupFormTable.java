...
/*
 *	CFIntDb2LUWSecGroupFormTable DB/2 LUW Jdbc DbIO implementation
 *	for SecGroupForm.
 */
public class CFIntDb2LUWSecGroupFormTable
	implements ICFIntSecGroupFormTable
{
	...
	public CFIntDb2LUWSecGroupFormTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGroupFormId )
	{
		final String S_ProcName = "CFIntDb2LUWSecGroupFormTable.readDerivedByIdIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupFormBuff readDerivedByUFormIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFIntDb2LUWSecGroupFormTable.readDerivedByUFormIdx() ";
		CFSecSecGroupFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
