...
/*
 *	CFIntDb2LUWSecGroupTable DB/2 LUW Jdbc DbIO implementation
 *	for SecGroup.
 */
public class CFIntDb2LUWSecGroupTable
	implements ICFIntSecGroupTable
{
	...
	public CFIntDb2LUWSecGroupTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecGroupId )
	{
		final String S_ProcName = "CFIntDb2LUWSecGroupTable.readDerivedByIdIdx() ";
		CFSecSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWSecGroupTable.readDerivedByUNameIdx() ";
		CFSecSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
