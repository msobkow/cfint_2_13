...
/*
 *	CFIntDb2LUWSecGrpIncTable DB/2 LUW Jdbc DbIO implementation
 *	for SecGrpInc.
 */
public class CFIntDb2LUWSecGrpIncTable
	implements ICFIntSecGrpIncTable
{
	...
	public CFIntDb2LUWSecGrpIncTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpIncId )
	{
		final String S_ProcName = "CFIntDb2LUWSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFIntDb2LUWSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
