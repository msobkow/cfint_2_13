...
/*
 *	CFIntDb2LUWServiceTable DB/2 LUW Jdbc DbIO implementation
 *	for Service.
 */
public class CFIntDb2LUWServiceTable
	implements ICFIntServiceTable
{
	...
	public CFIntDb2LUWServiceTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long ServiceId )
	{
		final String S_ProcName = "CFIntDb2LUWServiceTable.readDerivedByIdIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUTypeIdx( CFSecAuthorization Authorization,
		...
		int ServiceTypeId )
	{
		final String S_ProcName = "CFIntDb2LUWServiceTable.readDerivedByUTypeIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUHostPortIdx( CFSecAuthorization Authorization,
		...
		short HostPort )
	{
		final String S_ProcName = "CFIntDb2LUWServiceTable.readDerivedByUHostPortIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
