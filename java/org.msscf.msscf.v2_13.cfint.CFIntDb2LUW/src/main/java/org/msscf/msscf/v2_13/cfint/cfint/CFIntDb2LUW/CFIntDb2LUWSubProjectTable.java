...
/*
 *	CFIntDb2LUWSubProjectTable DB/2 LUW Jdbc DbIO implementation
 *	for SubProject.
 */
public class CFIntDb2LUWSubProjectTable
	implements ICFIntSubProjectTable
{
	...
	public CFIntDb2LUWSubProjectTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntSubProjectBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWSubProjectTable.readDerivedByIdIdx() ";
		CFIntSubProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntSubProjectBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWSubProjectTable.readDerivedByNameIdx() ";
		CFIntSubProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
