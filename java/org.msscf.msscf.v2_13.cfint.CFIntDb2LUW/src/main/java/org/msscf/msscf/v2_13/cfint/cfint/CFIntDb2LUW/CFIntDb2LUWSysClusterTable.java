...
/*
 *	CFIntDb2LUWSysClusterTable DB/2 LUW Jdbc DbIO implementation
 *	for SysCluster.
 */
public class CFIntDb2LUWSysClusterTable
	implements ICFIntSysClusterTable
{
	...
	public CFIntDb2LUWSysClusterTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSysClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int SingletonId )
	{
		final String S_ProcName = "CFIntDb2LUWSysClusterTable.readDerivedByIdIdx() ";
		CFSecSysClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
