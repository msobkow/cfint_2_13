...
/*
 *	CFIntDb2LUWTSecGroupTable DB/2 LUW Jdbc DbIO implementation
 *	for TSecGroup.
 */
public class CFIntDb2LUWTSecGroupTable
	implements ICFIntTSecGroupTable
{
	...
	public CFIntDb2LUWTSecGroupTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGroupBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int TSecGroupId )
	{
		final String S_ProcName = "CFIntDb2LUWTSecGroupTable.readDerivedByIdIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGroupBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWTSecGroupTable.readDerivedByUNameIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
