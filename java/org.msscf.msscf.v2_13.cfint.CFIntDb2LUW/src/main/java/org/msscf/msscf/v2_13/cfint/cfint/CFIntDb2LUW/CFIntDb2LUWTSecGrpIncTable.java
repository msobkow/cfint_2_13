...
/*
 *	CFIntDb2LUWTSecGrpIncTable DB/2 LUW Jdbc DbIO implementation
 *	for TSecGrpInc.
 */
public class CFIntDb2LUWTSecGrpIncTable
	implements ICFIntTSecGrpIncTable
{
	...
	public CFIntDb2LUWTSecGrpIncTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpIncId )
	{
		final String S_ProcName = "CFIntDb2LUWTSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFIntDb2LUWTSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecTSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
