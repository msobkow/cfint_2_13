...
/*
 *	CFIntDb2LUWTSecGrpMembTable DB/2 LUW Jdbc DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFIntDb2LUWTSecGrpMembTable
	implements ICFIntTSecGrpMembTable
{
	...
	public CFIntDb2LUWTSecGrpMembTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpMembId )
	{
		final String S_ProcName = "CFIntDb2LUWTSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFIntDb2LUWTSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
