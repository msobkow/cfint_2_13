...
/*
 *	CFIntDb2LUWTenantTable DB/2 LUW Jdbc DbIO implementation
 *	for Tenant.
 */
public class CFIntDb2LUWTenantTable
	implements ICFIntTenantTable
{
	...
	public CFIntDb2LUWTenantTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTenantBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWTenantTable.readDerivedByIdIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTenantBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String TenantName )
	{
		final String S_ProcName = "CFIntDb2LUWTenantTable.readDerivedByUNameIdx() ";
		CFSecTenantBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
