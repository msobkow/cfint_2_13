...
/*
 *	CFIntDb2LUWTldTable DB/2 LUW Jdbc DbIO implementation
 *	for Tld.
 */
public class CFIntDb2LUWTldTable
	implements ICFIntTldTable
{
	...
	public CFIntDb2LUWTldTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTldBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWTldTable.readDerivedByIdIdx() ";
		CFIntTldBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTldBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWTldTable.readDerivedByNameIdx() ";
		CFIntTldBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
