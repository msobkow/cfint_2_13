...
/*
 *	CFIntDb2LUWTopDomainTable DB/2 LUW Jdbc DbIO implementation
 *	for TopDomain.
 */
public class CFIntDb2LUWTopDomainTable
	implements ICFIntTopDomainTable
{
	...
	public CFIntDb2LUWTopDomainTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTopDomainBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWTopDomainTable.readDerivedByIdIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTopDomainBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWTopDomainTable.readDerivedByNameIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
