...
/*
 *	CFIntDb2LUWTopProjectTable DB/2 LUW Jdbc DbIO implementation
 *	for TopProject.
 */
public class CFIntDb2LUWTopProjectTable
	implements ICFIntTopProjectTable
{
	...
	public CFIntDb2LUWTopProjectTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTopProjectBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntDb2LUWTopProjectTable.readDerivedByIdIdx() ";
		CFIntTopProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTopProjectBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWTopProjectTable.readDerivedByNameIdx() ";
		CFIntTopProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
