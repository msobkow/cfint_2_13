...
/*
 *	CFIntDb2LUWURLProtocolTable DB/2 LUW Jdbc DbIO implementation
 *	for URLProtocol.
 */
public class CFIntDb2LUWURLProtocolTable
	implements ICFIntURLProtocolTable
{
	...
	public CFIntDb2LUWURLProtocolTable( CFIntDb2LUWSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntURLProtocolBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int URLProtocolId )
	{
		final String S_ProcName = "CFIntDb2LUWURLProtocolTable.readDerivedByIdIdx() ";
		CFIntURLProtocolBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntURLProtocolBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		String Name )
	{
		final String S_ProcName = "CFIntDb2LUWURLProtocolTable.readDerivedByUNameIdx() ";
		CFIntURLProtocolBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
