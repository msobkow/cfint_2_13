...
/*
 *	CFIntMSSqlHostNodeTable PostgreSQL Jdbc DbIO implementation
 *	for HostNode.
 */
public class CFIntMSSqlHostNodeTable
	implements ICFIntHostNodeTable
{
	...
	public CFIntMSSqlHostNodeTable( CFIntMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecHostNodeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long HostNodeId )
	{
		final String S_ProcName = "CFIntMSSqlHostNodeTable.readDerivedByIdIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		...
		String Description )
	{
		final String S_ProcName = "CFIntMSSqlHostNodeTable.readDerivedByUDescrIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByHostNameIdx( CFSecAuthorization Authorization,
		...
		String HostName )
	{
		final String S_ProcName = "CFIntMSSqlHostNodeTable.readDerivedByHostNameIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
