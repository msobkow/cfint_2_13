...
import org.msscf.msscf.v2_13.cfint.cfint.CFIntObj.*;
	...
	implements ICFIntSchema
{
	...
	public CFIntMSSqlSchema() {
		...
		tableLicense = new CFIntMSSqlLicenseTable( this );
	...
	public void releasePreparedStatements() {
		...
		if( ( tableLicense != null ) && ( tableLicense instanceof CFIntMSSqlLicenseTable ) ) {
			CFIntMSSqlLicenseTable table = (CFIntMSSqlLicenseTable)tableLicense;
			table.releasePreparedStatements();
		}
