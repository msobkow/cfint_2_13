...
/*
 *	CFIntMSSqlServiceTable PostgreSQL Jdbc DbIO implementation
 *	for Service.
 */
public class CFIntMSSqlServiceTable
	implements ICFIntServiceTable
{
	...
	public CFIntMSSqlServiceTable( CFIntMSSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long ServiceId )
	{
		final String S_ProcName = "CFIntMSSqlServiceTable.readDerivedByIdIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUTypeIdx( CFSecAuthorization Authorization,
		...
		int ServiceTypeId )
	{
		final String S_ProcName = "CFIntMSSqlServiceTable.readDerivedByUTypeIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceBuff readDerivedByUHostPortIdx( CFSecAuthorization Authorization,
		...
		short HostPort )
	{
		final String S_ProcName = "CFIntMSSqlServiceTable.readDerivedByUHostPortIdx() ";
		CFSecServiceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
