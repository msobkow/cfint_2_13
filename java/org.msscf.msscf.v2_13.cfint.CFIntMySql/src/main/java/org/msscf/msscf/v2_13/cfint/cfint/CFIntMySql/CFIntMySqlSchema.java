// Description: Java 11 MySQL Jdbc DbIO implementation for CFInt.
	...
	implements ICFIntSchema
{
	...
	protected PreparedStatement stmtInsertNextURLProtocolIdGen = null;
	protected PreparedStatement stmtUpdateNextURLProtocolIdGen = null;
	...
	public CFIntMySqlSchema() {
		super();
		cnx = null;
		inTransaction = false;
		tableCluster = new CFIntMySqlClusterTable( this );
		tableHostNode = new CFIntMySqlHostNodeTable( this );
		tableISOCcy = new CFIntMySqlISOCcyTable( this );
		tableISOCtry = new CFIntMySqlISOCtryTable( this );
		tableISOCtryCcy = new CFIntMySqlISOCtryCcyTable( this );
		tableISOCtryLang = new CFIntMySqlISOCtryLangTable( this );
		tableISOLang = new CFIntMySqlISOLangTable( this );
		tableISOTZone = new CFIntMySqlISOTZoneTable( this );
		tableLicense = new CFIntMySqlLicenseTable( this );
		tableMajorVersion = new CFIntMySqlMajorVersionTable( this );
		tableMimeType = new CFIntMySqlMimeTypeTable( this );
		tableMinorVersion = new CFIntMySqlMinorVersionTable( this );
		tableSecApp = new CFIntMySqlSecAppTable( this );
		tableSecDevice = new CFIntMySqlSecDeviceTable( this );
		tableSecForm = new CFIntMySqlSecFormTable( this );
		tableSecGroup = new CFIntMySqlSecGroupTable( this );
		tableSecGroupForm = new CFIntMySqlSecGroupFormTable( this );
		tableSecGrpInc = new CFIntMySqlSecGrpIncTable( this );
		tableSecGrpMemb = new CFIntMySqlSecGrpMembTable( this );
		tableSecSession = new CFIntMySqlSecSessionTable( this );
		tableSecUser = new CFIntMySqlSecUserTable( this );
		tableService = new CFIntMySqlServiceTable( this );
		tableServiceType = new CFIntMySqlServiceTypeTable( this );
		tableSubProject = new CFIntMySqlSubProjectTable( this );
		tableSysCluster = new CFIntMySqlSysClusterTable( this );
		tableTSecGroup = new CFIntMySqlTSecGroupTable( this );
		tableTSecGrpInc = new CFIntMySqlTSecGrpIncTable( this );
		tableTSecGrpMemb = new CFIntMySqlTSecGrpMembTable( this );
		tableTenant = new CFIntMySqlTenantTable( this );
		tableTld = new CFIntMySqlTldTable( this );
		tableTopDomain = new CFIntMySqlTopDomainTable( this );
		tableTopProject = new CFIntMySqlTopProjectTable( this );
		tableURLProtocol = new CFIntMySqlURLProtocolTable( this );
	}

	public CFIntMySqlSchema( CFIntConfigurationFile conf ) {
		super( conf );
		cnx = null;
		inTransaction = false;
		tableCluster = new CFIntMySqlClusterTable( this );
	...
	public CFIntMySqlSchema( String argJndiName ) {
		super( argJndiName );
		cnx = null;
		inTransaction = false;
		tableCluster = new CFIntMySqlClusterTable( this );
	...
	public CFIntMySqlSchema( Connection argCnx ) {
		super();
		cnx = argCnx;
		inTransaction = false;
		tableCluster = new CFIntMySqlClusterTable( this );
...
//		}
	...
	public void releasePreparedStatements() {
		...
		if( stmtInsertNextURLProtocolIdGen != null ) {
			try {
				stmtInsertNextURLProtocolIdGen.close();
			}
			catch( SQLException e ) {
			}
			stmtInsertNextURLProtocolIdGen= null;
		}
		if( stmtUpdateNextURLProtocolIdGen != null ) {
			try {
				stmtUpdateNextURLProtocolIdGen.close();
			}
			catch( SQLException e ) {
			}
			stmtUpdateNextURLProtocolIdGen= null;
		}
		...
		if( tableCluster != null ) {
			((CFIntMySqlClusterTable)tableCluster).releasePreparedStatements();
		}
		if( tableHostNode != null ) {
			((CFIntMySqlHostNodeTable)tableHostNode).releasePreparedStatements();
		}
		if( tableISOCcy != null ) {
			((CFIntMySqlISOCcyTable)tableISOCcy).releasePreparedStatements();
		}
		if( tableISOCtry != null ) {
			((CFIntMySqlISOCtryTable)tableISOCtry).releasePreparedStatements();
		}
		if( tableISOCtryCcy != null ) {
			((CFIntMySqlISOCtryCcyTable)tableISOCtryCcy).releasePreparedStatements();
		}
		if( tableISOCtryLang != null ) {
			((CFIntMySqlISOCtryLangTable)tableISOCtryLang).releasePreparedStatements();
		}
		if( tableISOLang != null ) {
			((CFIntMySqlISOLangTable)tableISOLang).releasePreparedStatements();
		}
		if( tableISOTZone != null ) {
			((CFIntMySqlISOTZoneTable)tableISOTZone).releasePreparedStatements();
		}
		if( tableLicense != null ) {
			((CFIntMySqlLicenseTable)tableLicense).releasePreparedStatements();
		}
		if( tableMajorVersion != null ) {
			((CFIntMySqlMajorVersionTable)tableMajorVersion).releasePreparedStatements();
		}
		if( tableMimeType != null ) {
			((CFIntMySqlMimeTypeTable)tableMimeType).releasePreparedStatements();
		}
		if( tableMinorVersion != null ) {
			((CFIntMySqlMinorVersionTable)tableMinorVersion).releasePreparedStatements();
		}
		if( tableSecApp != null ) {
			((CFIntMySqlSecAppTable)tableSecApp).releasePreparedStatements();
		}
		if( tableSecDevice != null ) {
			((CFIntMySqlSecDeviceTable)tableSecDevice).releasePreparedStatements();
		}
		if( tableSecForm != null ) {
			((CFIntMySqlSecFormTable)tableSecForm).releasePreparedStatements();
		}
		if( tableSecGroup != null ) {
			((CFIntMySqlSecGroupTable)tableSecGroup).releasePreparedStatements();
		}
		if( tableSecGroupForm != null ) {
			((CFIntMySqlSecGroupFormTable)tableSecGroupForm).releasePreparedStatements();
		}
		if( tableSecGrpInc != null ) {
			((CFIntMySqlSecGrpIncTable)tableSecGrpInc).releasePreparedStatements();
		}
		if( tableSecGrpMemb != null ) {
			((CFIntMySqlSecGrpMembTable)tableSecGrpMemb).releasePreparedStatements();
		}
		if( tableSecSession != null ) {
			((CFIntMySqlSecSessionTable)tableSecSession).releasePreparedStatements();
		}
		if( tableSecUser != null ) {
			((CFIntMySqlSecUserTable)tableSecUser).releasePreparedStatements();
		}
		if( tableService != null ) {
			((CFIntMySqlServiceTable)tableService).releasePreparedStatements();
		}
		if( tableServiceType != null ) {
			((CFIntMySqlServiceTypeTable)tableServiceType).releasePreparedStatements();
		}
		if( tableSubProject != null ) {
			((CFIntMySqlSubProjectTable)tableSubProject).releasePreparedStatements();
		}
		if( tableSysCluster != null ) {
			((CFIntMySqlSysClusterTable)tableSysCluster).releasePreparedStatements();
		}
		if( tableTSecGroup != null ) {
			((CFIntMySqlTSecGroupTable)tableTSecGroup).releasePreparedStatements();
		}
		if( tableTSecGrpInc != null ) {
			((CFIntMySqlTSecGrpIncTable)tableTSecGrpInc).releasePreparedStatements();
		}
		if( tableTSecGrpMemb != null ) {
			((CFIntMySqlTSecGrpMembTable)tableTSecGrpMemb).releasePreparedStatements();
		}
		if( tableTenant != null ) {
			((CFIntMySqlTenantTable)tableTenant).releasePreparedStatements();
		}
		if( tableTld != null ) {
			((CFIntMySqlTldTable)tableTld).releasePreparedStatements();
		}
		if( tableTopDomain != null ) {
			((CFIntMySqlTopDomainTable)tableTopDomain).releasePreparedStatements();
		}
		if( tableTopProject != null ) {
			((CFIntMySqlTopProjectTable)tableTopProject).releasePreparedStatements();
		}
		if( tableURLProtocol != null ) {
			((CFIntMySqlURLProtocolTable)tableURLProtocol).releasePreparedStatements();
		}
	}
	...
	public int nextURLProtocolIdGen() {
		...
		String sqlSelectNextIdGen =
				"SELECT " + getLowerDbSchemaName() + ".sp_next_urlprotocolidgen() as NextURLProtocolIdGen;";
		if( ! isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
				"Transaction not open" );
		...
		try {
			Connection cnx = getCnx();
			if( stmtSelectNextURLProtocolIdGen == null ) {
				stmtSelectNextURLProtocolIdGen = cnx.prepareStatement( sqlSelectNextIdGen );
			}
			int nextId;
			rsSelect = stmtSelectNextURLProtocolIdGen.executeQuery();
			if( rsSelect.next() ) {
				nextId = rsSelect.getInt( 1 );
				if( rsSelect.wasNull() ) {
					throw new CFLibRuntimeException( getClass(),
				...
				throw new CFLibRuntimeException( getClass(),
					S_ProcName,
					"Expected 1 row to be returned by invoking " + getLowerDbSchemaName() + ".sp_next_urlprotocolidgen()" );
			}
			return( nextId );
		}
		catch( SQLException e ) {
...
//						Syslog.warn("\t\t\tReplacing invalid character '" + c + "' with space");
	...
	public static String getNullableString(ResultSet reader, int colidx) {
		try {
			...
			throw new CFLibDbException( CFIntMySqlSchema.class,
				"getNullableString",
				e );
		}
	}
	...
	public static Calendar convertDateString(String val) {
		if( ( val == null ) || ( val.length() == 0 ) ) {
			...
			throw new CFLibUsageException( CFIntMySqlSchema.class,
				"convertDateString",
