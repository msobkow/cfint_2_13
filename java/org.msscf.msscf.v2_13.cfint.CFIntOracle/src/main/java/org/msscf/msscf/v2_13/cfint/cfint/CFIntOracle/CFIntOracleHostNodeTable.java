...
/*
 *	CFIntOracleHostNodeTable Oracle Jdbc DbIO implementation
 *	for HostNode.
 */
public class CFIntOracleHostNodeTable
	implements ICFIntHostNodeTable
{
	...
	public CFIntOracleHostNodeTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecHostNodeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long HostNodeId )
	{
		final String S_ProcName = "CFIntOracleHostNodeTable.readDerivedByIdIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		...
		String Description )
	{
		final String S_ProcName = "CFIntOracleHostNodeTable.readDerivedByUDescrIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecHostNodeBuff readDerivedByHostNameIdx( CFSecAuthorization Authorization,
		...
		String HostName )
	{
		final String S_ProcName = "CFIntOracleHostNodeTable.readDerivedByHostNameIdx() ";
		CFSecHostNodeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
