// Description: Java 11 Oracle Jdbc DbIO implementation for License.
...
package org.msscf.msscf.v2_13.cfint.cfint.CFIntOracle;
...
/*
 *	CFIntOracleLicenseTable Oracle Jdbc DbIO implementation
 *	for License.
 */
public class CFIntOracleLicenseTable
	implements ICFIntLicenseTable
{
	...
	public CFIntOracleLicenseTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public String getSqlSelectLicenseDistinctClassCode() {
		if( S_sqlSelectLicenseDistinctClassCode == null ) {
			S_sqlSelectLicenseDistinctClassCode =
				...
				+	"FROM " + schema.getLowerDbSchemaName() + ".licn a101 ";
		}
	...
	public CFIntLicenseBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntOracleLicenseTable.readDerivedByIdIdx() ";
		CFIntLicenseBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntLicenseBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntOracleLicenseTable.readDerivedByUNameIdx() ";
		CFIntLicenseBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
