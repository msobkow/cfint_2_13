...
/*
 *	CFIntOracleMinorVersionTable Oracle Jdbc DbIO implementation
 *	for MinorVersion.
 */
public class CFIntOracleMinorVersionTable
	implements ICFIntMinorVersionTable
{
	...
	public CFIntOracleMinorVersionTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntMinorVersionBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntOracleMinorVersionTable.readDerivedByIdIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntMinorVersionBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntOracleMinorVersionTable.readDerivedByNameIdx() ";
		CFIntMinorVersionBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
