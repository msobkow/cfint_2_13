...
/*
 *	CFIntOracleSecAppTable Oracle Jdbc DbIO implementation
 *	for SecApp.
 */
public class CFIntOracleSecAppTable
	implements ICFIntSecAppTable
{
	...
	public CFIntOracleSecAppTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecAppBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecAppId )
	{
		final String S_ProcName = "CFIntOracleSecAppTable.readDerivedByIdIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecAppBuff readDerivedByUJEEMountIdx( CFSecAuthorization Authorization,
		...
		String JEEMountName )
	{
		final String S_ProcName = "CFIntOracleSecAppTable.readDerivedByUJEEMountIdx() ";
		CFSecSecAppBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
