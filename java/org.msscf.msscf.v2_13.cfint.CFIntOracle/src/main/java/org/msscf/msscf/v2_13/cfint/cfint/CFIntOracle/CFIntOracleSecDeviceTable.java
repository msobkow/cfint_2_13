...
/*
 *	CFIntOracleSecDeviceTable Oracle Jdbc DbIO implementation
 *	for SecDevice.
 */
public class CFIntOracleSecDeviceTable
	implements ICFIntSecDeviceTable
{
	...
	public CFIntOracleSecDeviceTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecDeviceBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFIntOracleSecDeviceTable.readDerivedByIdIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecDeviceBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String DevName )
	{
		final String S_ProcName = "CFIntOracleSecDeviceTable.readDerivedByNameIdx() ";
		CFSecSecDeviceBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
