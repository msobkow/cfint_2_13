...
/*
 *	CFIntOracleServiceTypeTable Oracle Jdbc DbIO implementation
 *	for ServiceType.
 */
public class CFIntOracleServiceTypeTable
	implements ICFIntServiceTypeTable
{
	...
	public CFIntOracleServiceTypeTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecServiceTypeBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int ServiceTypeId )
	{
		final String S_ProcName = "CFIntOracleServiceTypeTable.readDerivedByIdIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecServiceTypeBuff readDerivedByUDescrIdx( CFSecAuthorization Authorization,
		String Description )
	{
		final String S_ProcName = "CFIntOracleServiceTypeTable.readDerivedByUDescrIdx() ";
		CFSecServiceTypeBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
