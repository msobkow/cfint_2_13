...
/*
 *	CFIntOracleSubProjectTable Oracle Jdbc DbIO implementation
 *	for SubProject.
 */
public class CFIntOracleSubProjectTable
	implements ICFIntSubProjectTable
{
	...
	public CFIntOracleSubProjectTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntSubProjectBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntOracleSubProjectTable.readDerivedByIdIdx() ";
		CFIntSubProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntSubProjectBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntOracleSubProjectTable.readDerivedByNameIdx() ";
		CFIntSubProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
