...
/*
 *	CFIntOracleTSecGroupTable Oracle Jdbc DbIO implementation
 *	for TSecGroup.
 */
public class CFIntOracleTSecGroupTable
	implements ICFIntTSecGroupTable
{
	...
	public CFIntOracleTSecGroupTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGroupBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int TSecGroupId )
	{
		final String S_ProcName = "CFIntOracleTSecGroupTable.readDerivedByIdIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGroupBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntOracleTSecGroupTable.readDerivedByUNameIdx() ";
		CFSecTSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
