...
/*
 *	CFIntOracleTopDomainTable Oracle Jdbc DbIO implementation
 *	for TopDomain.
 */
public class CFIntOracleTopDomainTable
	implements ICFIntTopDomainTable
{
	...
	public CFIntOracleTopDomainTable( CFIntOracleSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTopDomainBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntOracleTopDomainTable.readDerivedByIdIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTopDomainBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntOracleTopDomainTable.readDerivedByNameIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
