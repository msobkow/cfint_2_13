// Description: Java 11 PostgreSQL Jdbc DbIO implementation for CFInt.
...
package org.msscf.msscf.v2_13.cfint.cfint.CFIntPgSql;
...
import org.msscf.msscf.v2_13.cfint.cfint.CFIntSaxLoader.CFIntSaxLoader;

public class CFIntPgSqlSchema
	extends CFIntSchema
	implements ICFIntSchema
{
	...
	public CFIntPgSqlSchema() {
		super();
		cnx = null;
		inTransaction = false;
		tableCluster = new CFIntPgSqlClusterTable( this );
		tableHostNode = new CFIntPgSqlHostNodeTable( this );
		tableISOCcy = new CFIntPgSqlISOCcyTable( this );
		tableISOCtry = new CFIntPgSqlISOCtryTable( this );
		tableISOCtryCcy = new CFIntPgSqlISOCtryCcyTable( this );
		tableISOCtryLang = new CFIntPgSqlISOCtryLangTable( this );
		tableISOLang = new CFIntPgSqlISOLangTable( this );
		tableISOTZone = new CFIntPgSqlISOTZoneTable( this );
		tableLicense = new CFIntPgSqlLicenseTable( this );
		tableMajorVersion = new CFIntPgSqlMajorVersionTable( this );
		tableMimeType = new CFIntPgSqlMimeTypeTable( this );
		tableMinorVersion = new CFIntPgSqlMinorVersionTable( this );
		tableSecApp = new CFIntPgSqlSecAppTable( this );
		tableSecDevice = new CFIntPgSqlSecDeviceTable( this );
		tableSecForm = new CFIntPgSqlSecFormTable( this );
		tableSecGroup = new CFIntPgSqlSecGroupTable( this );
		tableSecGroupForm = new CFIntPgSqlSecGroupFormTable( this );
		tableSecGrpInc = new CFIntPgSqlSecGrpIncTable( this );
		tableSecGrpMemb = new CFIntPgSqlSecGrpMembTable( this );
		tableSecSession = new CFIntPgSqlSecSessionTable( this );
		tableSecUser = new CFIntPgSqlSecUserTable( this );
		tableService = new CFIntPgSqlServiceTable( this );
		tableServiceType = new CFIntPgSqlServiceTypeTable( this );
		tableSubProject = new CFIntPgSqlSubProjectTable( this );
		tableSysCluster = new CFIntPgSqlSysClusterTable( this );
		tableTSecGroup = new CFIntPgSqlTSecGroupTable( this );
		tableTSecGrpInc = new CFIntPgSqlTSecGrpIncTable( this );
		tableTSecGrpMemb = new CFIntPgSqlTSecGrpMembTable( this );
		tableTenant = new CFIntPgSqlTenantTable( this );
		tableTld = new CFIntPgSqlTldTable( this );
		tableTopDomain = new CFIntPgSqlTopDomainTable( this );
		tableTopProject = new CFIntPgSqlTopProjectTable( this );
		tableURLProtocol = new CFIntPgSqlURLProtocolTable( this );
	}

	public CFIntPgSqlSchema( CFIntConfigurationFile conf ) {
		super( conf );
		cnx = null;
		inTransaction = false;
		tableCluster = new CFIntPgSqlClusterTable( this );
	...
	public CFIntPgSqlSchema( String argJndiName ) {
		super( argJndiName );
		cnx = null;
		inTransaction = false;
		tableCluster = new CFIntPgSqlClusterTable( this );
	...
	public CFIntPgSqlSchema( Connection argCnx ) {
		super();
		cnx = argCnx;
		inTransaction = false;
		tableCluster = new CFIntPgSqlClusterTable( this );
	...
	public void releasePreparedStatements() {
		...
		if( ( tableCluster != null ) && ( tableCluster instanceof CFIntPgSqlClusterTable ) ) {
			CFIntPgSqlClusterTable table = (CFIntPgSqlClusterTable)tableCluster;
			table.releasePreparedStatements();
		}
		if( ( tableHostNode != null ) && ( tableHostNode instanceof CFIntPgSqlHostNodeTable ) ) {
			CFIntPgSqlHostNodeTable table = (CFIntPgSqlHostNodeTable)tableHostNode;
			table.releasePreparedStatements();
		}
		if( ( tableISOCcy != null ) && ( tableISOCcy instanceof CFIntPgSqlISOCcyTable ) ) {
			CFIntPgSqlISOCcyTable table = (CFIntPgSqlISOCcyTable)tableISOCcy;
			table.releasePreparedStatements();
		}
		if( ( tableISOCtry != null ) && ( tableISOCtry instanceof CFIntPgSqlISOCtryTable ) ) {
			CFIntPgSqlISOCtryTable table = (CFIntPgSqlISOCtryTable)tableISOCtry;
			table.releasePreparedStatements();
		}
		if( ( tableISOCtryCcy != null ) && ( tableISOCtryCcy instanceof CFIntPgSqlISOCtryCcyTable ) ) {
			CFIntPgSqlISOCtryCcyTable table = (CFIntPgSqlISOCtryCcyTable)tableISOCtryCcy;
			table.releasePreparedStatements();
		}
		if( ( tableISOCtryLang != null ) && ( tableISOCtryLang instanceof CFIntPgSqlISOCtryLangTable ) ) {
			CFIntPgSqlISOCtryLangTable table = (CFIntPgSqlISOCtryLangTable)tableISOCtryLang;
			table.releasePreparedStatements();
		}
		if( ( tableISOLang != null ) && ( tableISOLang instanceof CFIntPgSqlISOLangTable ) ) {
			CFIntPgSqlISOLangTable table = (CFIntPgSqlISOLangTable)tableISOLang;
			table.releasePreparedStatements();
		}
		if( ( tableISOTZone != null ) && ( tableISOTZone instanceof CFIntPgSqlISOTZoneTable ) ) {
			CFIntPgSqlISOTZoneTable table = (CFIntPgSqlISOTZoneTable)tableISOTZone;
			table.releasePreparedStatements();
		}
		if( ( tableLicense != null ) && ( tableLicense instanceof CFIntPgSqlLicenseTable ) ) {
			CFIntPgSqlLicenseTable table = (CFIntPgSqlLicenseTable)tableLicense;
			table.releasePreparedStatements();
		}
		if( ( tableMajorVersion != null ) && ( tableMajorVersion instanceof CFIntPgSqlMajorVersionTable ) ) {
			CFIntPgSqlMajorVersionTable table = (CFIntPgSqlMajorVersionTable)tableMajorVersion;
			table.releasePreparedStatements();
		}
		if( ( tableMimeType != null ) && ( tableMimeType instanceof CFIntPgSqlMimeTypeTable ) ) {
			CFIntPgSqlMimeTypeTable table = (CFIntPgSqlMimeTypeTable)tableMimeType;
			table.releasePreparedStatements();
		}
		if( ( tableMinorVersion != null ) && ( tableMinorVersion instanceof CFIntPgSqlMinorVersionTable ) ) {
			CFIntPgSqlMinorVersionTable table = (CFIntPgSqlMinorVersionTable)tableMinorVersion;
			table.releasePreparedStatements();
		}
		if( ( tableSecApp != null ) && ( tableSecApp instanceof CFIntPgSqlSecAppTable ) ) {
			CFIntPgSqlSecAppTable table = (CFIntPgSqlSecAppTable)tableSecApp;
			table.releasePreparedStatements();
		}
		if( ( tableSecDevice != null ) && ( tableSecDevice instanceof CFIntPgSqlSecDeviceTable ) ) {
			CFIntPgSqlSecDeviceTable table = (CFIntPgSqlSecDeviceTable)tableSecDevice;
			table.releasePreparedStatements();
		}
		if( ( tableSecForm != null ) && ( tableSecForm instanceof CFIntPgSqlSecFormTable ) ) {
			CFIntPgSqlSecFormTable table = (CFIntPgSqlSecFormTable)tableSecForm;
			table.releasePreparedStatements();
		}
		if( ( tableSecGroup != null ) && ( tableSecGroup instanceof CFIntPgSqlSecGroupTable ) ) {
			CFIntPgSqlSecGroupTable table = (CFIntPgSqlSecGroupTable)tableSecGroup;
			table.releasePreparedStatements();
		}
		if( ( tableSecGroupForm != null ) && ( tableSecGroupForm instanceof CFIntPgSqlSecGroupFormTable ) ) {
			CFIntPgSqlSecGroupFormTable table = (CFIntPgSqlSecGroupFormTable)tableSecGroupForm;
			table.releasePreparedStatements();
		}
		if( ( tableSecGrpInc != null ) && ( tableSecGrpInc instanceof CFIntPgSqlSecGrpIncTable ) ) {
			CFIntPgSqlSecGrpIncTable table = (CFIntPgSqlSecGrpIncTable)tableSecGrpInc;
			table.releasePreparedStatements();
		}
		if( ( tableSecGrpMemb != null ) && ( tableSecGrpMemb instanceof CFIntPgSqlSecGrpMembTable ) ) {
			CFIntPgSqlSecGrpMembTable table = (CFIntPgSqlSecGrpMembTable)tableSecGrpMemb;
			table.releasePreparedStatements();
		}
		if( ( tableSecSession != null ) && ( tableSecSession instanceof CFIntPgSqlSecSessionTable ) ) {
			CFIntPgSqlSecSessionTable table = (CFIntPgSqlSecSessionTable)tableSecSession;
			table.releasePreparedStatements();
		}
		if( ( tableSecUser != null ) && ( tableSecUser instanceof CFIntPgSqlSecUserTable ) ) {
			CFIntPgSqlSecUserTable table = (CFIntPgSqlSecUserTable)tableSecUser;
			table.releasePreparedStatements();
		}
		if( ( tableService != null ) && ( tableService instanceof CFIntPgSqlServiceTable ) ) {
			CFIntPgSqlServiceTable table = (CFIntPgSqlServiceTable)tableService;
			table.releasePreparedStatements();
		}
		if( ( tableServiceType != null ) && ( tableServiceType instanceof CFIntPgSqlServiceTypeTable ) ) {
			CFIntPgSqlServiceTypeTable table = (CFIntPgSqlServiceTypeTable)tableServiceType;
			table.releasePreparedStatements();
		}
		if( ( tableSubProject != null ) && ( tableSubProject instanceof CFIntPgSqlSubProjectTable ) ) {
			CFIntPgSqlSubProjectTable table = (CFIntPgSqlSubProjectTable)tableSubProject;
			table.releasePreparedStatements();
		}
		if( ( tableSysCluster != null ) && ( tableSysCluster instanceof CFIntPgSqlSysClusterTable ) ) {
			CFIntPgSqlSysClusterTable table = (CFIntPgSqlSysClusterTable)tableSysCluster;
			table.releasePreparedStatements();
		}
		if( ( tableTSecGroup != null ) && ( tableTSecGroup instanceof CFIntPgSqlTSecGroupTable ) ) {
			CFIntPgSqlTSecGroupTable table = (CFIntPgSqlTSecGroupTable)tableTSecGroup;
			table.releasePreparedStatements();
		}
		if( ( tableTSecGrpInc != null ) && ( tableTSecGrpInc instanceof CFIntPgSqlTSecGrpIncTable ) ) {
			CFIntPgSqlTSecGrpIncTable table = (CFIntPgSqlTSecGrpIncTable)tableTSecGrpInc;
			table.releasePreparedStatements();
		}
		if( ( tableTSecGrpMemb != null ) && ( tableTSecGrpMemb instanceof CFIntPgSqlTSecGrpMembTable ) ) {
			CFIntPgSqlTSecGrpMembTable table = (CFIntPgSqlTSecGrpMembTable)tableTSecGrpMemb;
			table.releasePreparedStatements();
		}
		if( ( tableTenant != null ) && ( tableTenant instanceof CFIntPgSqlTenantTable ) ) {
			CFIntPgSqlTenantTable table = (CFIntPgSqlTenantTable)tableTenant;
			table.releasePreparedStatements();
		}
		if( ( tableTld != null ) && ( tableTld instanceof CFIntPgSqlTldTable ) ) {
			CFIntPgSqlTldTable table = (CFIntPgSqlTldTable)tableTld;
			table.releasePreparedStatements();
		}
		if( ( tableTopDomain != null ) && ( tableTopDomain instanceof CFIntPgSqlTopDomainTable ) ) {
			CFIntPgSqlTopDomainTable table = (CFIntPgSqlTopDomainTable)tableTopDomain;
			table.releasePreparedStatements();
		}
		if( ( tableTopProject != null ) && ( tableTopProject instanceof CFIntPgSqlTopProjectTable ) ) {
			CFIntPgSqlTopProjectTable table = (CFIntPgSqlTopProjectTable)tableTopProject;
			table.releasePreparedStatements();
		}
		if( ( tableURLProtocol != null ) && ( tableURLProtocol instanceof CFIntPgSqlURLProtocolTable ) ) {
			CFIntPgSqlURLProtocolTable table = (CFIntPgSqlURLProtocolTable)tableURLProtocol;
			table.releasePreparedStatements();
		}
	}
...
//						Syslog.warn("\t\t\tReplacing invalid character '" + c + "' with space");
	...
	public static String getNullableString(ResultSet reader, int colidx) {
		try {
			...
			throw new CFLibDbException( CFIntPgSqlSchema.class,
				"getNullableString",
				e );
		}
	}
	...
	public static Calendar convertDateString(String val) {
		if( ( val == null ) || ( val.length() == 0 ) ) {
			...
			throw new CFLibUsageException( CFIntPgSqlSchema.class,
				"convertDateString",
