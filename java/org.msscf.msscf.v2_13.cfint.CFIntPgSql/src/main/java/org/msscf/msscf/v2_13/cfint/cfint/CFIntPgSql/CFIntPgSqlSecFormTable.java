...
/*
 *	CFIntPgSqlSecFormTable PostgreSQL Jdbc DbIO implementation
 *	for SecForm.
 */
public class CFIntPgSqlSecFormTable
	implements ICFIntSecFormTable
{
	...
	public CFIntPgSqlSecFormTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecFormBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecFormId )
	{
		final String S_ProcName = "CFIntPgSqlSecFormTable.readDerivedByIdIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	{
		final String S_ProcName = "CFIntPgSqlSecFormTable.readDerivedByUJEEServletIdx() ";
		CFSecSecFormBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
