...
/*
 *	CFIntPgSqlSecGroupTable PostgreSQL Jdbc DbIO implementation
 *	for SecGroup.
 */
public class CFIntPgSqlSecGroupTable
	implements ICFIntSecGroupTable
{
	...
	public CFIntPgSqlSecGroupTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGroupBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		int SecGroupId )
	{
		final String S_ProcName = "CFIntPgSqlSecGroupTable.readDerivedByIdIdx() ";
		CFSecSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGroupBuff readDerivedByUNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlSecGroupTable.readDerivedByUNameIdx() ";
		CFSecSecGroupBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
