...
/*
 *	CFIntPgSqlSecGrpIncTable PostgreSQL Jdbc DbIO implementation
 *	for SecGrpInc.
 */
public class CFIntPgSqlSecGrpIncTable
	implements ICFIntSecGrpIncTable
{
	...
	public CFIntPgSqlSecGrpIncTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpIncBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpIncId )
	{
		final String S_ProcName = "CFIntPgSqlSecGrpIncTable.readDerivedByIdIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpIncBuff readDerivedByUIncludeIdx( CFSecAuthorization Authorization,
		...
		int IncludeGroupId )
	{
		final String S_ProcName = "CFIntPgSqlSecGrpIncTable.readDerivedByUIncludeIdx() ";
		CFSecSecGrpIncBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
