...
/*
 *	CFIntPgSqlSecGrpMembTable PostgreSQL Jdbc DbIO implementation
 *	for SecGrpMemb.
 */
public class CFIntPgSqlSecGrpMembTable
	implements ICFIntSecGrpMembTable
{
	...
	public CFIntPgSqlSecGrpMembTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long SecGrpMembId )
	{
		final String S_ProcName = "CFIntPgSqlSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFIntPgSqlSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
