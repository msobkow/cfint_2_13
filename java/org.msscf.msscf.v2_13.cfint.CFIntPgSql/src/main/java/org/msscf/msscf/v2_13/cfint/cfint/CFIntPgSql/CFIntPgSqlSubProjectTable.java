...
/*
 *	CFIntPgSqlSubProjectTable PostgreSQL Jdbc DbIO implementation
 *	for SubProject.
 */
public class CFIntPgSqlSubProjectTable
	implements ICFIntSubProjectTable
{
	...
	public CFIntPgSqlSubProjectTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntSubProjectBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntPgSqlSubProjectTable.readDerivedByIdIdx() ";
		CFIntSubProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntSubProjectBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlSubProjectTable.readDerivedByNameIdx() ";
		CFIntSubProjectBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
