...
/*
 *	CFIntPgSqlSysClusterTable PostgreSQL Jdbc DbIO implementation
 *	for SysCluster.
 */
public class CFIntPgSqlSysClusterTable
	implements ICFIntSysClusterTable
{
	...
	public CFIntPgSqlSysClusterTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecSysClusterBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		int SingletonId )
	{
		final String S_ProcName = "CFIntPgSqlSysClusterTable.readDerivedByIdIdx() ";
		CFSecSysClusterBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
