...
/*
 *	CFIntPgSqlTSecGrpMembTable PostgreSQL Jdbc DbIO implementation
 *	for TSecGrpMemb.
 */
public class CFIntPgSqlTSecGrpMembTable
	implements ICFIntTSecGrpMembTable
{
	...
	public CFIntPgSqlTSecGrpMembTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFSecTSecGrpMembBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long TSecGrpMembId )
	{
		final String S_ProcName = "CFIntPgSqlTSecGrpMembTable.readDerivedByIdIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFSecTSecGrpMembBuff readDerivedByUUserIdx( CFSecAuthorization Authorization,
		...
		UUID SecUserId )
	{
		final String S_ProcName = "CFIntPgSqlTSecGrpMembTable.readDerivedByUUserIdx() ";
		CFSecTSecGrpMembBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
