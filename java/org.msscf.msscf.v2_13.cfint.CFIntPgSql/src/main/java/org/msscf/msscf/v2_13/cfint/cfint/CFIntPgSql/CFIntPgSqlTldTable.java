...
/*
 *	CFIntPgSqlTldTable PostgreSQL Jdbc DbIO implementation
 *	for Tld.
 */
public class CFIntPgSqlTldTable
	implements ICFIntTldTable
{
	...
	public CFIntPgSqlTldTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTldBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntPgSqlTldTable.readDerivedByIdIdx() ";
		CFIntTldBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTldBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlTldTable.readDerivedByNameIdx() ";
		CFIntTldBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
