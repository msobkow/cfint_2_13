...
/*
 *	CFIntPgSqlTopDomainTable PostgreSQL Jdbc DbIO implementation
 *	for TopDomain.
 */
public class CFIntPgSqlTopDomainTable
	implements ICFIntTopDomainTable
{
	...
	public CFIntPgSqlTopDomainTable( CFIntPgSqlSchema argSchema ) {
		schema = argSchema;
	}
	...
	public CFIntTopDomainBuff readDerivedByIdIdx( CFSecAuthorization Authorization,
		...
		long Id )
	{
		final String S_ProcName = "CFIntPgSqlTopDomainTable.readDerivedByIdIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
	...
	public CFIntTopDomainBuff readDerivedByNameIdx( CFSecAuthorization Authorization,
		...
		String Name )
	{
		final String S_ProcName = "CFIntPgSqlTopDomainTable.readDerivedByNameIdx() ";
		CFIntTopDomainBuff buff;
		if( ! schema.isTransactionOpen() ) {
			throw new CFLibUsageException( getClass(),
				S_ProcName,
