...
// Description: Java 11 XML Message message formatter for CFInt.ISOLang
...
/*
 *	CFIntXMsgISOLangMessageFormatter XML message formatter
 *	for CFInt.ISOLang.
 */
public class CFIntXMsgISOLangMessageFormatter
{
	public CFIntXMsgISOLangMessageFormatter() {
	}
	...
	public static String formatISOLangBuffAttributes( String separator, CFSecISOLangBuff buff ) {
		String retval = CFIntXMsgISOLangMessageFormatter.formatISOLangPKeyAttributes( separator, buff )
