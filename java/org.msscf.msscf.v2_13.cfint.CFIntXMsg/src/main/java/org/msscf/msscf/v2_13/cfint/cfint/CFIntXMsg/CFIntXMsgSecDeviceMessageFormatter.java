...
// Description: Java 11 XML Message message formatter for CFInt.SecDevice
...
/*
 *	CFIntXMsgSecDeviceMessageFormatter XML message formatter
 *	for CFInt.SecDevice.
 */
public class CFIntXMsgSecDeviceMessageFormatter
{
	public CFIntXMsgSecDeviceMessageFormatter() {
	}
	...
	public static String formatSecDeviceBuffAttributes( String separator, CFSecSecDeviceBuff buff ) {
		String retval = CFIntXMsgSecDeviceMessageFormatter.formatSecDevicePKeyAttributes( separator, buff )
