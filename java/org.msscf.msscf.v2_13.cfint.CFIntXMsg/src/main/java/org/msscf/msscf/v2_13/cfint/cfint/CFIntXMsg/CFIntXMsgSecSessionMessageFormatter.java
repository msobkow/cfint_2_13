...
// Description: Java 11 XML Message message formatter for CFInt.SecSession
...
/*
 *	CFIntXMsgSecSessionMessageFormatter XML message formatter
 *	for CFInt.SecSession.
 */
public class CFIntXMsgSecSessionMessageFormatter
{
	public CFIntXMsgSecSessionMessageFormatter() {
	}
	...
	public static String formatSecSessionBuffAttributes( String separator, CFSecSecSessionBuff buff ) {
		String retval = CFIntXMsgSecSessionMessageFormatter.formatSecSessionPKeyAttributes( separator, buff )
