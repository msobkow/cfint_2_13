...
// Description: Java 11 XML Message message formatter for CFInt.Tenant
...
/*
 *	CFIntXMsgTenantMessageFormatter XML message formatter
 *	for CFInt.Tenant.
 */
public class CFIntXMsgTenantMessageFormatter
{
	public CFIntXMsgTenantMessageFormatter() {
	}
	...
	public static String formatTenantBuffAttributes( String separator, CFSecTenantBuff buff ) {
		String retval = CFIntXMsgTenantMessageFormatter.formatTenantPKeyAttributes( separator, buff )
