...
/*
 *	CFIntXMsgRqstLicenseCreate XML SAX Element  implementation
 *	for License.
 */
public class CFIntXMsgRqstLicenseCreate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstLicenseCreate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntLicenseBuff dataBuff = (CFIntLicenseBuff)editBuff.getLicenseBuff();
			// Extract Attributes
			...
			ICFIntLicenseObj created = (ICFIntLicenseObj)editBuff.create();
			editBuff = null;
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgLicenseMessageFormatter.formatLicenseRspnCreated( "\n\t\t\t", created.getLicenseBuff() )
				+	"\n"
