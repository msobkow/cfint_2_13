...
/*
 *	CFIntXMsgRqstLicenseLock XML SAX Element  implementation
 *	for License.
 */
public class CFIntXMsgRqstLicenseLock
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstLicenseLock( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			pkey.setRequiredId( natId );
			// Lock the object
			ICFIntLicenseObj locked = ((ICFIntLicenseObj)schemaObj.getLicenseTableObj().lockLicense( pkey ));
			String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
				+	"\t" + CFIntXMsgLicenseMessageFormatter.formatLicenseRspnLocked( "\n\t\t\t", locked.getLicenseBuff() )
				+	"\n"
