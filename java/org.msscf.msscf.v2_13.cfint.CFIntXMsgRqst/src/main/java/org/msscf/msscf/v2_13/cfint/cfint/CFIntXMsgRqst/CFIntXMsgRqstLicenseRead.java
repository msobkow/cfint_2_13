...
/*
 *	CFIntXMsgRqstLicenseRead XML SAX Element  implementation
 *	for License.
 */
public class CFIntXMsgRqstLicenseRead
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstLicenseRead( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			CFIntLicensePKey pkey = ((ICFIntSchema)schemaObj.getBackingStore()).getFactoryLicense().newPKey();
			...
			ICFIntLicenseObj read = ((ICFIntLicenseObj)schemaObj.getLicenseTableObj().readLicense( pkey, true ));
			if( read != null ) {
