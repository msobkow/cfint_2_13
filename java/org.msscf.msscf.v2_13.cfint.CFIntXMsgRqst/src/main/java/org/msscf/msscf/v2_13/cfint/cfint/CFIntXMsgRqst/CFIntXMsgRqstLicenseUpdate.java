...
/*
 *	CFIntXMsgRqstLicenseUpdate XML SAX Element  implementation
 *	for License.
 */
public class CFIntXMsgRqstLicenseUpdate
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRqstLicenseUpdate( CFIntXMsgRqst xmsgRqst ) {
		super( xmsgRqst );
	}
	...
	throws SAXException
	{
		...
		try {
			...
			// Read the instance
			ICFIntLicenseObj origBuff = ((ICFIntLicenseObj)schemaObj.getLicenseTableObj().readLicense( pkey ));
			if( origBuff == null ) {
				throw new CFLibNullArgumentException( getClass(),
					S_ProcName,
					0,
				...
				// Edit the instance
				ICFIntLicenseEditObj editBuff = (ICFIntLicenseEditObj)origBuff.beginEdit();
				CFIntLicenseBuff dataBuff = editBuff.getLicenseBuff();
			...
			dataBuff.setOptionalFullText( natFullText );
				...
				String response = schemaFormatter.formatRspnXmlPreamble() + "\n"
					+	"\t" + CFIntXMsgLicenseMessageFormatter.formatLicenseRspnUpdated( "\n\t\t\t", origBuff.getLicenseBuff() )
					+	"\n"
