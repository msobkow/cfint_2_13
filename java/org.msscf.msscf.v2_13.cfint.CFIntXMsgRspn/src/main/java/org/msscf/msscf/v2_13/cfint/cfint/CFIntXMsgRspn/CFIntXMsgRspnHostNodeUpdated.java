...
/*
 *	CFIntXMsgRspnHostNodeUpdated XML SAX Element  implementation
 *	for HostNode.
 */
public class CFIntXMsgRspnHostNodeUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnHostNodeUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
