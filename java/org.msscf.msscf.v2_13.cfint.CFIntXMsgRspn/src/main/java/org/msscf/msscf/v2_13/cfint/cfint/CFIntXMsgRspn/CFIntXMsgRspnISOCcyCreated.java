...
/*
 *	CFIntXMsgRspnISOCcyCreated XML SAX Element  implementation
 *	for ISOCcy.
 */
public class CFIntXMsgRspnISOCcyCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCcyCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
