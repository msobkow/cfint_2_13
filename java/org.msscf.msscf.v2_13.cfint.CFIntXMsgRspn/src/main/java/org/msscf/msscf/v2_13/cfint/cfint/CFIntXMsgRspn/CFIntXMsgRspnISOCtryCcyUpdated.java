...
/*
 *	CFIntXMsgRspnISOCtryCcyUpdated XML SAX Element  implementation
 *	for ISOCtryCcy.
 */
public class CFIntXMsgRspnISOCtryCcyUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCtryCcyUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntISOCtryCcyObj obj = (ICFIntISOCtryCcyObj)schemaObj.getISOCtryCcyTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntISOCtryCcyObj realised = (ICFIntISOCtryCcyObj)obj.realise();
