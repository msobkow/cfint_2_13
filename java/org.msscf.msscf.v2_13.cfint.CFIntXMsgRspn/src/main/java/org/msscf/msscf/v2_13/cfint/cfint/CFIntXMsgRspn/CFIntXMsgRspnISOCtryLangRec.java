...
/*
 *	CFIntXMsgRspnISOCtryLangRec XML SAX Element  implementation
 *	for ISOCtryLang.
 */
public class CFIntXMsgRspnISOCtryLangRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCtryLangRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
