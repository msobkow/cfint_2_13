...
/*
 *	CFIntXMsgRspnISOCtryLocked XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFIntXMsgRspnISOCtryLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCtryLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
