...
/*
 *	CFIntXMsgRspnISOCtryReadList XML SAX Element  implementation
 *	for ISOCtry.
 */
public class CFIntXMsgRspnISOCtryReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOCtryReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
