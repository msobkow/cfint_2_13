...
/*
 *	CFIntXMsgRspnISOLangUpdated XML SAX Element  implementation
 *	for ISOLang.
 */
public class CFIntXMsgRspnISOLangUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOLangUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			obj.copyBuffToPKey();
			ICFIntISOLangObj realised = (ICFIntISOLangObj)obj.realise();
