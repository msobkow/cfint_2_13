...
/*
 *	CFIntXMsgRspnISOTZoneReadList XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFIntXMsgRspnISOTZoneReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOTZoneReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
