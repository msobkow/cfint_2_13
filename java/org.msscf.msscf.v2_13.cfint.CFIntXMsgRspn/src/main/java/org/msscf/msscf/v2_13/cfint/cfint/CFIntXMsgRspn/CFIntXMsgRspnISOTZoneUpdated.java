...
/*
 *	CFIntXMsgRspnISOTZoneUpdated XML SAX Element  implementation
 *	for ISOTZone.
 */
public class CFIntXMsgRspnISOTZoneUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnISOTZoneUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
