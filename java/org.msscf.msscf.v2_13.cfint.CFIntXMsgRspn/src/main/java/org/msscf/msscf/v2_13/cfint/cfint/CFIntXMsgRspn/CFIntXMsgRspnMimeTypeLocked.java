...
/*
 *	CFIntXMsgRspnMimeTypeLocked XML SAX Element  implementation
 *	for MimeType.
 */
public class CFIntXMsgRspnMimeTypeLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnMimeTypeLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
