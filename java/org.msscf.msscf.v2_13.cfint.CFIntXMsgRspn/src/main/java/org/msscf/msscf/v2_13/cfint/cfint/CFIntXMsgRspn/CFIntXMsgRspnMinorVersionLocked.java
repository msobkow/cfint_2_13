...
/*
 *	CFIntXMsgRspnMinorVersionLocked XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRspnMinorVersionLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnMinorVersionLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
