...
/*
 *	CFIntXMsgRspnMinorVersionRec XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRspnMinorVersionRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnMinorVersionRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
