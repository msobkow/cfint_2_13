...
/*
 *	CFIntXMsgRspnMinorVersionUpdated XML SAX Element  implementation
 *	for MinorVersion.
 */
public class CFIntXMsgRspnMinorVersionUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnMinorVersionUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
