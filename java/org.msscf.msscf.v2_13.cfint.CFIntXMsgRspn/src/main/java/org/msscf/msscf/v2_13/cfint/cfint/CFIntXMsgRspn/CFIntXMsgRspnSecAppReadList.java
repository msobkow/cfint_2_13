...
/*
 *	CFIntXMsgRspnSecAppReadList XML SAX Element  implementation
 *	for SecApp.
 */
public class CFIntXMsgRspnSecAppReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecAppReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
