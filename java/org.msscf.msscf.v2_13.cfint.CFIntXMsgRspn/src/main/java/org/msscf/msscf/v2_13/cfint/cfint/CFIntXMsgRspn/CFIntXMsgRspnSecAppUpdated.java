...
/*
 *	CFIntXMsgRspnSecAppUpdated XML SAX Element  implementation
 *	for SecApp.
 */
public class CFIntXMsgRspnSecAppUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecAppUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
