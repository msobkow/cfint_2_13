...
/*
 *	CFIntXMsgRspnSecDeviceCreated XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRspnSecDeviceCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecDeviceCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
