...
/*
 *	CFIntXMsgRspnSecDeviceLocked XML SAX Element  implementation
 *	for SecDevice.
 */
public class CFIntXMsgRspnSecDeviceLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecDeviceLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
