...
/*
 *	CFIntXMsgRspnSecGroupFormCreated XML SAX Element  implementation
 *	for SecGroupForm.
 */
public class CFIntXMsgRspnSecGroupFormCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGroupFormCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
