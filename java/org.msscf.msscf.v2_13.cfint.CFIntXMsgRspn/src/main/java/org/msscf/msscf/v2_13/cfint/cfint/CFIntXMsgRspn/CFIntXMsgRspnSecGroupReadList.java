...
/*
 *	CFIntXMsgRspnSecGroupReadList XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRspnSecGroupReadList
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGroupReadList( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
