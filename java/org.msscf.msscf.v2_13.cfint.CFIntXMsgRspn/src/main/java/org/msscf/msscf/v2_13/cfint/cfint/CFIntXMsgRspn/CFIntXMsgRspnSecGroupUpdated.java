...
/*
 *	CFIntXMsgRspnSecGroupUpdated XML SAX Element  implementation
 *	for SecGroup.
 */
public class CFIntXMsgRspnSecGroupUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGroupUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
