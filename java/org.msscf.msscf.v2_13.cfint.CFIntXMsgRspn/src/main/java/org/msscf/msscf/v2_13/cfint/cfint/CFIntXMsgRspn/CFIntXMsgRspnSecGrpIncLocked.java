...
/*
 *	CFIntXMsgRspnSecGrpIncLocked XML SAX Element  implementation
 *	for SecGrpInc.
 */
public class CFIntXMsgRspnSecGrpIncLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGrpIncLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
