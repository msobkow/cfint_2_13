...
/*
 *	CFIntXMsgRspnSecGrpMembLocked XML SAX Element  implementation
 *	for SecGrpMemb.
 */
public class CFIntXMsgRspnSecGrpMembLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecGrpMembLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
