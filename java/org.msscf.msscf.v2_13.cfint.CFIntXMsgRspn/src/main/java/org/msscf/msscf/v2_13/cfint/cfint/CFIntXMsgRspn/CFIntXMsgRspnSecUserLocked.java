...
/*
 *	CFIntXMsgRspnSecUserLocked XML SAX Element  implementation
 *	for SecUser.
 */
public class CFIntXMsgRspnSecUserLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSecUserLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
