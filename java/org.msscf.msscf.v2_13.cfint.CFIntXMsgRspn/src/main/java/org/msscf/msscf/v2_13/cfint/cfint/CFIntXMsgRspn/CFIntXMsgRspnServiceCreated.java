...
/*
 *	CFIntXMsgRspnServiceCreated XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRspnServiceCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnServiceCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntServiceObj obj = (ICFIntServiceObj)schemaObj.getServiceTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntServiceObj realised = (ICFIntServiceObj)obj.realise();
