...
/*
 *	CFIntXMsgRspnServiceUpdated XML SAX Element  implementation
 *	for Service.
 */
public class CFIntXMsgRspnServiceUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnServiceUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
