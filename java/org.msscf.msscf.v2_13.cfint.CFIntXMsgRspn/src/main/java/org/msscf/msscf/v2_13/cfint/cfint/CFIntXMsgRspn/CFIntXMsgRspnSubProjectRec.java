...
/*
 *	CFIntXMsgRspnSubProjectRec XML SAX Element  implementation
 *	for SubProject.
 */
public class CFIntXMsgRspnSubProjectRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSubProjectRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
