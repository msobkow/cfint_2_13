...
/*
 *	CFIntXMsgRspnSysClusterLocked XML SAX Element  implementation
 *	for SysCluster.
 */
public class CFIntXMsgRspnSysClusterLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnSysClusterLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
