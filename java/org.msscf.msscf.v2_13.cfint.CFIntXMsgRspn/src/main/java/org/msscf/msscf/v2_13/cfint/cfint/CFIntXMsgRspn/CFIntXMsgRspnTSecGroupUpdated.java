...
/*
 *	CFIntXMsgRspnTSecGroupUpdated XML SAX Element  implementation
 *	for TSecGroup.
 */
public class CFIntXMsgRspnTSecGroupUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTSecGroupUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntTSecGroupObj obj = (ICFIntTSecGroupObj)schemaObj.getTSecGroupTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntTSecGroupObj realised = (ICFIntTSecGroupObj)obj.realise();
