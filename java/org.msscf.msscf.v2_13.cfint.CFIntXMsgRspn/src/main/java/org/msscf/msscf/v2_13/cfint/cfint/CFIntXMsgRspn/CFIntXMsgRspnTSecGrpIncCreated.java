...
/*
 *	CFIntXMsgRspnTSecGrpIncCreated XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgRspnTSecGrpIncCreated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTSecGrpIncCreated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
