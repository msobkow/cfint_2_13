...
/*
 *	CFIntXMsgRspnTSecGrpIncUpdated XML SAX Element  implementation
 *	for TSecGrpInc.
 */
public class CFIntXMsgRspnTSecGrpIncUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTSecGrpIncUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
	...
	throws SAXException
	{
		try {
			...
			ICFIntTSecGrpIncObj obj = (ICFIntTSecGrpIncObj)schemaObj.getTSecGrpIncTableObj().newInstance();
			...
			obj.copyBuffToPKey();
			ICFIntTSecGrpIncObj realised = (ICFIntTSecGrpIncObj)obj.realise();
