...
/*
 *	CFIntXMsgRspnTopDomainUpdated XML SAX Element  implementation
 *	for TopDomain.
 */
public class CFIntXMsgRspnTopDomainUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTopDomainUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
