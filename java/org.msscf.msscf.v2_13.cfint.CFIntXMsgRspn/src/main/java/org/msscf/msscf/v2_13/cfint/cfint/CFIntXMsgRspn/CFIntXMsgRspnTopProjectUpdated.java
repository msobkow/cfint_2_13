...
/*
 *	CFIntXMsgRspnTopProjectUpdated XML SAX Element  implementation
 *	for TopProject.
 */
public class CFIntXMsgRspnTopProjectUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnTopProjectUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
