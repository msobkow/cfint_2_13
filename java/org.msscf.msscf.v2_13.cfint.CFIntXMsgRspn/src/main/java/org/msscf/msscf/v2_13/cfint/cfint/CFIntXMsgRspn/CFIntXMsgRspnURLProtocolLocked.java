...
/*
 *	CFIntXMsgRspnURLProtocolLocked XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRspnURLProtocolLocked
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnURLProtocolLocked( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
