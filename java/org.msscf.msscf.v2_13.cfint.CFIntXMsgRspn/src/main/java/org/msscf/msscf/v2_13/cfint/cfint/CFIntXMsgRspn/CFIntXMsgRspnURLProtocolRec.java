...
/*
 *	CFIntXMsgRspnURLProtocolRec XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRspnURLProtocolRec
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnURLProtocolRec( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
