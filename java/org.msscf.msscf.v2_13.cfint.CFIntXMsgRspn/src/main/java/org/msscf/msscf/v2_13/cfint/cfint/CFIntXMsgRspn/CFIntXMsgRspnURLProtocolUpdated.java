...
/*
 *	CFIntXMsgRspnURLProtocolUpdated XML SAX Element  implementation
 *	for URLProtocol.
 */
public class CFIntXMsgRspnURLProtocolUpdated
	extends CFLibXmlCoreElementHandler
{
	public CFIntXMsgRspnURLProtocolUpdated( CFIntXMsgRspn xmsgRspn ) {
		super( xmsgRspn );
	}
