...
package org.msscf.msscf.v2_13.cfint.cfint.CFIntXMsgSrvWar;
...
import org.msscf.msscf.v2_13.cfint.cfint.CFIntXMsgRqst.CFIntXMsgRqst;

/**
 * Servlet implementation class CFIntXMsgSrvWarRequestXml
 */
@WebServlet("/CFIntXMsgSrvWarRequestXml")
public class CFIntXMsgSrvWarRequestXml extends HttpServlet {
	 ...
	 */
	public CFIntXMsgSrvWarRequestXml() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		CFTipServerInfo serverInfo = CFIntXMsgSrvWarApplicationListener.getServerInfo();
		...
		if( envelopeHandler == null ) {
			...
			CFIntXMsgRqst requestHandler = new CFIntXMsgRqst();
		...
		try {
			...
			out.println( "<HTML>" );
			out.println( "<BODY>" );
			out.println( "<form method=\"post\" formaction=\"CFIntXMsgSrvWarRequestXml\">" );
			...
			out.println( "</table>" );
			out.println( "<p style=\"text-align:center\"><button type=\"submit\" name=\"Ok\"\">Submit Request</button>&nbsp;&nbsp;&nbsp;&nbsp;<button type=\"button\" name=\"Cancel\"\" onclick=\"window.location.href='CFIntXMsgSrvWarRequestXml'\">Cancel;</button>" );
			out.println( "</form>" );
			out.println( "</BODY>" );
			out.println( "</HTML>" );
		}
